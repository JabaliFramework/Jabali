        ...
        <div class="pot-row-padding pot-theme">
                <div class="mdl-card__supporting-text">
                    <form id="admin-post-form" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <p>Bio:</p><textarea class="mdl-textfield__input" style="color: #008b8b" cols="140" rows="100" name="comment" id="comment" value="" ></textarea><script>CKEDITOR.replace( 'comment' );</script>
