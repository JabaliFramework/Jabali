...
<div class="navbar navbar-inverse" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><img src="mpesa-white.png" width="150px"></a>
        </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
			<li class="active"><a href="/" target="blank">Shop</a></li>
			<li class="active"><a href="/" target="blank">About</a></li>
			<li class="active"><a href="/" target="blank">Contact</a></li>
			<li class="active"><a href="https://github.com/BandaEcommerce/POT-CART" target="blank">GitHub</a></li>
          </ul>
        </div><!-- /.nav-collapse -->
      </div><!-- /.container -->
    </div><!-- /.navbar -->
