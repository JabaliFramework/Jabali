(function(window) {
    ...
    epepite.DatePicker.TEMPLATES.default =
        ...
        + '<i class="icon material-icons"><</i></button><p class="%YEAR_CLASS%">2016</p>'
        ...
        + '<i class="icon material-icons">></i></button></div>'
        ...
        + '<button type="button" name="mdl-calendar__month--prev" class="%MONTH_PREV_CLASS% %IS_VISIBLE% mdl-calendar__button"><i class="icon material-icons"><</i></button>'
