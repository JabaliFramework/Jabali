<div class="mdl-layout__drawer">
        ...
        <a style="height:56px;" class="mdl-navigation__link" href="./">
                        <i class="material-icons" role="presentation">dashboard</i>
                        Dashboard Home
                    </a>
                    <a class="mdl-navigation__link mdl-navigation__link--current" href="?home">
            ...
            <a class="mdl-navigation__link" href="?quotes">
                <i class="material-icons" role="presentation">note_add</i>
                Quotes
            </a>
            ...
            <a class="mdl-navigation__link dropdown" href="?home=otas&action=view">
