    ...
    <main class="mdl-layout__content">
       ...
       <div class="mdl-grid mdl-cell mdl-cell--3-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone mdl-cell--top">
                ...
                <div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--6-col-tablet mdl-cell--2-col-phone">
                    <div class="mdl-card mdl-shadow--2dp cotoneaster"><img src="../media/uploads/travellers.png" alt="Samples" style="width:100%;">
                        <div class="mdl-card__title mdl-card--expand" >
                            <h2 class="mdl-card__title-text">Samples</h2>
                        </div>
                        <div class="mdl-card__supporting-text">
                            <div>
                            <p>And then there’s money. For a really long time, you will not have it. And even when you do get it, there’s a queue of things awaiting its arrival. And even with a relatively stable cash flow, there will ...
                            </div>
                            <a href="https://en.wikipedia.org/wiki/Cotoneaster" target="_blank">admin</a>
                        </div>
                    </div>
                </div>
                                <!-- ToDo_widget-->
