 ...
 * Print class
 */
if ( ! class_exists( 'Otas_Print_Print' ) ) {

	class Otas_Print_Print {
		...
		public function __construct() {	
			...
			self::$template_registrations = apply_filters( 'wcdn_template_registration', array(
				apply_filters( 'wcdn_template_registration_invoice', array(
					'type' => 'invoice',
					'labels' => array(
						'name' => __( 'Invoice', 'otas-print' ),
						'name_plural' => __( 'Invoices', 'otas-print' ),
						'print' => __( 'Print Invoice', 'otas-print' ),
						'print_plural' => __( 'Print Invoices', 'otas-print' ),
						'message' => __( 'Invoice created.', 'otas-print' ),
						'message_plural' => __( 'Invoices created.', 'otas-print' ),
						'setting' => __( 'Show "Print Invoice" button', 'otas-print' )
					)
				) ),
				apply_filters( 'wcdn_template_registration_delivery_note', array(
					'type' => 'delivery-note',
					'labels' => array(
						'name' => __( 'Delivery Note', 'otas-print' ),
						'name_plural' => __( 'Delivery Notes', 'otas-print' ),
						'print' => __( 'Print Delivery Note', 'otas-print' ),
						'print_plural' => __( 'Print Delivery Notes', 'otas-print' ),
						'message' => __( 'Delivery Note created.', 'otas-print' ),
						'message_plural' => __( 'Delivery Notes created.', 'otas-print' ),
						'setting' => __( 'Show "Print Delivery Note" button', 'otas-print' )
					)
				) ),
				apply_filters( 'wcdn_template_registration_receipt', array(
					'type' => 'receipt',
					'labels' => array(
						'name' => __( 'Receipt', 'otas-print' ),
						'name_plural' => __( 'Receipts', 'otas-print' ),
						'print' => __( 'Print Receipt', 'otas-print' ),
						'print_plural' => __( 'Print Receipts', 'otas-print' ),
						'message' => __( 'Receipt created.', 'otas-print' ),
						'message_plural' => __( 'Receipts created.', 'otas-print' ),
						'setting' => __( 'Show "Print Receipt" button', 'otas-print' )
					)
				) )
			) );
			...
			array_unshift( self::$template_registrations, array(
				'type' => 'order',
				'labels' => array(
					'name' => __( 'Order', 'otas-print' ),
					'name_plural' => __( 'Orders', 'otas-print' ),
					'print' => __( 'Print Order', 'otas-print' ),
					'print_plural' => __( 'Print Orders', 'otas-print' ),
					'message' => null,
					'message_plural' => null,
					'setting' => null
				)
			...
			array_unshift( self::$template_styles, array(
				'name' => __( 'Default', 'otas-print' ),
				'type' => 'default',
				'path' => Otas_Print::$plugin_path . 'templates/print-order/',
				'url' => Otas_Print::$plugin_url . 'templates/print-order/'
			) );
