        ...
        <div class="bhoechie-tab-container">
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
              <div class="list-group">
                <a href="#" id="tt1" class="list-group-item active text-center">
                  <i class="fa fa-facebook"></i><br/>
                </a><div class="mdl-tooltip" data-mdl-for="tt1">General Settings</div>

                <a href="#" id="tt2" class="list-group-item text-center">
                  <i class="fa fa-facebook"></i><br/>
                </a><div class="mdl-tooltip" data-mdl-for="tt2">Menu Settings</div>

                <a href="#" id="tt3" class="list-group-item text-center">
                  <i class="fa fa-facebook"></i><br/>
                </a><div class="mdl-tooltip" data-mdl-for="tt3">User Settings</div>

                <a href="#" id="tt4" class="list-group-item text-center">
                  <i class="fa fa-facebook"></i></h4><br/>
                </a><div class="mdl-tooltip" data-mdl-for="tt4">M-PESA Settings</div>

                <a href="#" id="tt5" class="list-group-item text-center">
                  <i class="fa fa-facebook"></i></h4><br/>
                </a><div class="mdl-tooltip" data-mdl-for="tt5">Extensions</div>

                <a href="#" id="tt6" class="list-group-item text-center">
                  <i class="fa fa-facebook"></i></h4><br/>
                </a><div class="mdl-tooltip" data-mdl-for="tt6">Sites</div>

                <a href="#" id="tt7" class="list-group-item text-center">
                  <i class="fa fa-facebook"></i></h4><br/>
                </a><div class="mdl-tooltip" data-mdl-for="tt7">Flush</div>
              </div>
            </div>
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
                ...
                <div class="bhoechie-tab-content">
                    <?php include 'settings-menus.php'; ?>
                </div>
                <!-- hotel search -->
                <div class="bhoechie-tab-content">
                    <?php include 'settings-general.php'; ?>
