...
include 'admin/config/db.php';
	...
	<form  name="constants" class="constants-form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
		...
		<input type="submit" class="pot-btn" name="submit" placeholder="" value="Register">
	</form>
	</div>
	</div>
	...
	<br><br>If you will be accepting payments via M-PESA, please <br><br><a href="admin/" class="pot-btn">LOG IN</a><?php  
	}
	?>
	</center>
	</body>
