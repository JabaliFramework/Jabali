<?php
	...
	function drawer_materialize_settings_link($links) { 
		$settings_link = '<a href="themes.php?page=admin/materialize.php">Settings</a>'; 
	...
	function drawer_materialize_admin_menu() {
		add_submenu_page('themes.php', 'Materialize Settings', 'Materialize', 'administrator', __FILE__, 'drawer_materialize_page');
	}
