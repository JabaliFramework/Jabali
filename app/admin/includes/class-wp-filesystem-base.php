...
/**
 * Base Jabali Filesystem class for which Filesystem implementations extend
 *
 * @since 2.5.0
 */
class WP_Filesystem_Base {
	...
	public function abspath() {
		...
		// Perhaps the FTP folder is rooted at the Jabali install, Check for reslib folder in root, Could have some false positives, but rare.
	...
	public function search_for_folder( $folder, $base = '.', $loop = false ) {
		...
		foreach ( $folder_parts as $index => $key ) {
			...
			/*
			 * Working from /home/ to /user/ to /jabali/ see if that file exists within
			 * the current folder, If it's found, change into it and follow through looking
			 * for it. If it cant find Jabali down that route, it'll continue onto the next
