...
function wp_install_defaults( $user_id ) {
	...
	if ( is_multisite() ) {
		...
		$first_post = __( 'Welcome to Jabali. This is your first post. Edit or delete it, then start writing!' );
	}
	...
	// Default comment
	$first_comment_author = __( 'A Jabali Commenter' );
	$first_comment_email = 'wapuu@jabali.example';
	$first_comment_url = 'https://jabali.github.io/';
 ...
 * @since 4.2.0
 *
 * @global WP_Rewrite $wp_rewrite Jabali rewrite component.
 *
...
function wp_install_maybe_enable_pretty_permalinks() {
	...
	foreach ( (array) $permalink_structures as $permalink_structure ) {
		...
		// Test against a real Jabali Post
...
function wp_new_blog_notification($blog_title, $blog_url, $user_id, $password) {
	...
	$message = sprintf( __( "Your new Jabali site has been successfully set up at:
...
--The Jabali Team
https://jabali.github.io/
"), $blog_url, $name, $password, $login_url );

	@wp_mail($email, __('New Jabali Site'), $message);
}
endif;

if ( !function_exists('wp_upgrade') ) :
/**
 * Runs Jabali Upgrade functions.
 *
...
/**
 * Execute changes made in Jabali 1.0.
 *
 * @ignore
 * @since 1.0.0
 *
...
/**
 * Execute changes made in Jabali 1.0.1.
 *
 * @ignore
 * @since 1.0.1
 *
...
/**
 * Execute changes made in Jabali 1.2.
 *
 * @ignore
 * @since 1.2.0
 *
...
/**
 * Execute changes made in Jabali 1.5.
 *
 * @ignore
 * @since 1.5.0
 *
...
/**
 * Execute changes made in Jabali 2.0.
 *
 * @ignore
 * @since 2.0.0
 *
...
/**
 * Execute changes made in Jabali 2.1.
 *
 * @ignore
 * @since 2.1.0
 *
...
/**
 * Execute changes made in Jabali 2.3.
 *
 * @ignore
 * @since 2.3.0
 *
...
/**
 * Execute changes made in Jabali 2.5.0.
 *
 * @ignore
 * @since 2.5.0
 *
...
/**
 * Execute changes made in Jabali 2.5.2.
 *
 * @ignore
 * @since 2.5.2
 *
...
/**
 * Execute changes made in Jabali 2.6.
 *
 * @ignore
 * @since 2.6.0
 *
...
/**
 * Execute changes made in Jabali 2.7.
 *
 * @ignore
 * @since 2.7.0
 *
...
/**
 * Execute changes made in Jabali 2.8.
 *
 * @ignore
 * @since 2.8.0
 *
...
/**
 * Execute changes made in Jabali 2.9.
 *
 * @ignore
 * @since 2.9.0
 *
...
/**
 * Execute changes made in Jabali 3.0.
 *
 * @ignore
 * @since 3.0.0
 *
...
/**
 * Execute changes made in Jabali 3.3.
 *
 * @ignore
 * @since 3.3.0
 *
...
/**
 * Execute changes made in Jabali 3.4.
 *
 * @ignore
 * @since 3.4.0
 *
...
/**
 * Execute changes made in Jabali 3.5.
 *
 * @ignore
 * @since 3.5.0
 *
...
/**
 * Execute changes made in Jabali 3.7.
 *
 * @ignore
 * @since 3.7.0
 *
...
/**
 * Execute changes made in Jabali 3.7.2.
 *
 * @ignore
 * @since 3.7.2
 * @since 3.8.0
...
/**
 * Execute changes made in Jabali 3.8.0.
 *
 * @ignore
 * @since 3.8.0
 *
...
/**
 * Execute changes made in Jabali 4.0.0.
 *
 * @ignore
 * @since 4.0.0
 *
...
/**
 * Execute changes made in Jabali 4.2.0.
 *
 * @ignore
 * @since 4.2.0
 *
...
/**
 * Executes changes made in Jabali 4.3.0.
 *
 * @ignore
 * @since 4.3.0
 *
...
/**
 * Executes comments changes made in Jabali 4.3.0.
 *
 * @ignore
 * @since 4.3.0
 *
...
/**
 * Executes changes made in Jabali 4.3.1.
 *
 * @ignore
 * @since 4.3.1
 */
...
/**
 * Executes changes made in Jabali 4.4.0.
 *
 * @ignore
 * @since 4.4.0
 *
...
/**
 * Executes changes made in Jabali 4.5.0.
 *
 * @ignore
 * @since 4.5.0
 *
...
/**
 * Executes changes made in Jabali 4.6.0.
 *
 * @ignore
 * @since 4.6.0
 *
	...
	foreach ($files as $oldfile => $newfile) {
		...
		if ($oldfile == 'index.php') {
			...
			if (strpos($index, 'WP_USE_THEMES') !== false) {
				if (! @copy(MAIN_DIR . '/themes/' . WP_DEFAULT_THEME . '/index.php', "$site_dir/$newfile"))
					return false;
...
function make_site_theme_from_default($theme_name, $template) {
	$site_dir = MAIN_DIR . "/themes/$template";
	$default_dir = MAIN_DIR . '/themes/' . WP_DEFAULT_THEME;
 ...
 * for the safe upgrading of global Jabali database tables. It is necessary
 ...
 * Jabali is on the main site of the main network, to avoid running queries
