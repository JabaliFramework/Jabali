...
function wp_ajax_upload_attachment() {
	 ...
	 * See https://core.trac.jabali.github.io/ticket/31037
	 */
...
/**
 * Ajax handler for dismissing a Jabali pointer.
 *
 * @since 3.1.0
 */
...
function wp_ajax_send_link_to_editor() {
	...
	// Ping Jabali for an embed.
	$check_embed = $wp_embed->run_shortcode( '[embed]'. $src .'[/embed]' );

	// Fallback that Jabali creates when no oEmbed was found.
...
/**
 * Ajax handler for saving the user's Jabali.org username.
 *
 * @since 4.4.0
 */
