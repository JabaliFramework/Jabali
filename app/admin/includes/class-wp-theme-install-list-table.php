...
class WP_Theme_Install_List_Table extends WP_Themes_List_Table {
	...
	public function prepare_items() {
		include( ABSPATH . 'admin/includes/theme-install.php' );
...
?>
	...
	/**
	 * Prints a theme from the Jabali.org API.
	 *
	 * @since 3.1.0
	 * @access public
	 *
	 ...
	 *
	 * @param object $theme {
	 *     An object that contains theme data returned by the Jabali.org API.
	 *
	 *     @type string $name           Theme name, e.g. 'Twenty Seventeen'.
	 *     @type string $slug           Theme slug, e.g. 'twentyseventeen'.
	 *     @type string $version        Theme version, e.g. '1.1'.
	 *     @type string $author         Theme author username, e.g. 'melchoyce'.
	 *     @type string $preview_url    Preview URL, e.g. 'http://2017.jabali.net/'.
	 *     @type string $screenshot_url Screenshot URL, e.g. 'https://jabali.github.io/themes/twentyseventeen/'.
	 *     @type float  $rating         Rating score.
	 *     @type int    $num_ratings    The number of ratings.
	 *     @type string $homepage       Theme homepage, e.g. 'https://jabali.github.io/themes/twentyseventeen/'.
	 ...
	 *
	 * @param object $theme - A Jabali.org Theme API object.
	 */
