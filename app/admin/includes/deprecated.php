<?php
/**
 * Deprecated admin functions from past Jabali versions. You shouldn't use these
...
function wp_tiny_mce( $teeny = false, $settings = false ) {
	...
	if ( ! class_exists( '_WP_Editors', false ) )
		require_once( ABSPATH . RES . '/class-wp-editor.php' );
...
function wp_update_core($current, $feedback = '') {
	...
	include( ABSPATH . 'admin/includes/class-wp-upgrader.php' );
 ...
 *
 * @since 2.7.0
 * @since 3.8.0 Screen icons are no longer used in Jabali. This function no longer produces output.
...
function get_screen_icon() {
	return '<!-- Screen icons are no longer used as of Jabali 3.8. -->';
}
