...
class WP_Importer {
	...
	/**
	 * Returns array with imported permalinks from Jabali database
	 *
	...
	/**
	 * Return count of imported permalinks from Jabali database
	 *
	 * @global wpdb $wpdb Jabali database abstraction object.
	 *
	 * @param string $importer_name
	...
	/**
	 * Set array with imported comments from Jabali database
	 *
	 * @global wpdb $wpdb Jabali database abstraction object.
	 *
	 * @param string $bid
