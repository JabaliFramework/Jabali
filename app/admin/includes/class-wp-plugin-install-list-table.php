...
class WP_Plugin_Install_List_Table extends WP_List_Table {
	...
	public function prepare_items() {
		include( ABSPATH . 'admin/includes/plugin-install.php' );
	...
	public function views() {
		...
		/** This filter is documented in admin/inclues/class-wp-list-table.php */
			...
			<div class="plugin-card-bottom">
				...
				<div class="column-compatibility">
					...
					if ( ! empty( $plugin['tested'] ) && version_compare( substr( $wp_version, 0, strlen( $plugin['tested'] ) ), $plugin['tested'], '>' ) ) {
						echo '<span class="compatibility-untested">' . __( 'Untested with your version of Jabali' ) . '</span>';
					} elseif ( ! empty( $plugin['requires'] ) && version_compare( substr( $wp_version, 0, strlen( $plugin['requires'] ) ), $plugin['requires'], '<' ) ) {
						echo '<span class="compatibility-incompatible">' . __( '<strong>Incompatible</strong> with your version of Jabali' ) . '</span>';
					} else {
						echo '<span class="compatibility-compatible">' . __( '<strong>Compatible</strong> with your version of Jabali' ) . '</span>';
					}
					?>
				</div>
			</div>
