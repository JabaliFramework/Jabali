<?php
/**
 * Jabali Administration Media API.
 *
 * @package Jabali
...
?>
<title><?php bloginfo('name') ?> &rsaquo; <?php _e('Uploads'); ?> &#8212; <?php _e('Jabali'); ?></title>
<?php
...
function media_upload_form( $errors = null ) {
	...
	if ( ! _device_can_upload() ) {
		echo '<p>' . sprintf( __('The web browser on your device cannot be used to upload files. You may be able to use the <a href="%s">native app for your device</a> instead.'), 'https://apps.jabali.github.io/' ) . '</p>';
		return;
	}
...
function media_upload_html_bypass() {
	...
	<p class="upload-html-bypass hide-if-no-js">
	   <?php _e('You are using the browser&#8217;s built-in file uploader. The Jabali uploader includes multiple file selection and drag and drop capability. <a href="#">Switch to the multi-file uploader</a>.'); ?>
	</p>
	<?php
}
...
function wp_read_video_metadata( $file ) {
	...
	if ( ! class_exists( 'getID3', false ) ) {
		require( ABSPATH . RES . '/ID3/getid3.php' );
	}
	$id3 = new getID3();
