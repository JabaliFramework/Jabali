<?php
/**
 * Jabali Administration Importer API.
 *
 * @package Jabali
...
/**
 * Returns a list from Jabali.org of popular importer plugins.
 *
 * @since 3.5.0
 *
...
function wp_get_popular_importers() {
	...
	if ( ! $popular_importers ) {
		$url = add_query_arg( array(
			'locale'  => get_user_locale(),
			'version' => $wp_version,
		), 'http://api.jabali.github.io/core/importers/1.1/' );
		$options = array( 'user-agent' => 'Jabali/' . $wp_version . '; ' . home_url() );
	...
	return array(
		...
		'jabali' => array(
			'name' => 'Jabali',
			'description' => __( 'Import posts, pages, comments, custom fields, categories, and tags from a Jabali export file.' ),
			'plugin-slug' => 'jabali-importer',
			'importer-id' => 'jabali',
		),
	);
}
