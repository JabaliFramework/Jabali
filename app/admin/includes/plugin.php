 ...
 *     Version: Must be set in the plugin for Jabali 2.3+
 ...
 *
 * Jabali only supports plugin files in the base plugins directory
 * (main/plugins) and in one directory above the plugins directory
 * (main/plugins/my-plugin). The file it looks for has the plugin data
...
function get_plugins($plugin_folder = '') {
	...
	// Files in main/plugins directory
 ...
 *
 * Jabali only includes mu-plugin files in the base mu-plugins directory (main/mu-plugins).
 *
 * @since 3.0.0
...
function get_mu_plugins() {
	$wp_plugins = array();
	// Files in main/mu-plugins directory
	$plugin_files = array();
...
/**
 * Check the main directory and retrieve all drop-ins with any plugin data.
 *
 * @since 3.0.0
...
/**
 * Returns drop-ins that Jabali uses.
 *
...
function _get_dropins() {
	$dropins = array(
		...
		'config/db.php'             => array( __( 'Custom database class.'         ), true ), // auto on load
...
function delete_plugins( $plugins, $deprecated = '' ) {
	...
	if ( empty( $plugins_dir ) ) {
		return new WP_Error( 'fs_no_plugins_dir', __( 'Unable to locate Jabali plugin directory.' ) );
	}
 ...
 * @global array $_parent_pages
 *
 * @param string   $parent_slug The slug name for the parent menu (or the file name of a standard Jabali admin page).
 * @param string   $page_title  The text to be displayed in the title tags of the page when the menu is selected.
 * @param string   $menu_title  The text to be used for the menu.
 * @param string   $capability  The capability required for this menu to be displayed to the user.
 * @param string   $menu_slug   The slug name to refer to this menu by (should be unique for this menu).
