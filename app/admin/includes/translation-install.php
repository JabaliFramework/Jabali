<?php
/**
 * Jabali Translation Install Administration API
 *
 * @package Jabali
...
/**
 * Retrieve translations from Jabali Translation API.
 *
 * @since 4.0.0
 *
...
function translations_api( $type, $args = null ) {
	...
	/**
	 * Allows a plugin to override the Jabali.org Translation Install API entirely.
	 *
	 * @since 4.0.0
	 *
	...
	if ( false === $res ) {
		$url = $http_url = 'http://api.jabali.github.io/translations/' . $type . '/1.0/';
...
/**
 * Get available translations from the Jabali.org API.
 *
 * @since 4.0.0
 *
...
/**
 * Check if Jabali has access to the filesystem without asking for
 * credentials.
 *
 * @since 4.0.0
 *
...
function wp_can_install_language_pack() {
	...
	$check = $upgrader->fs_connect( array( MAIN_DIR, WP_LANG_DIR ) );
