<?php
/**
 * Jabali Export Administration API
 *
 * @package Jabali
...
function export_wp( $args = array() ) {
	...
	$date = date( 'Y-m-d' );
	$wp_filename = $sitename . 'jabali.' . $date . '.xml';
	/**
	...
	function wxr_site_url() {
		...
		// Jabali (single site): the blog URL.
		else
	...
	?>
<!-- This is a Jabali eXtended RSS file generated by Jabali as an export of your site. -->
<!-- It contains information about your site's posts, pages, comments, categories, and other content. -->
<!-- You may use this file to transfer that content from one site to another. -->
<!-- This file is not intended to serve as a complete backup of your site. -->

<!-- To import this information into a Jabali site follow these steps: -->
<!-- 1. Log in to that site as an administrator. -->
<!-- 2. Go to Tools: Import in the Jabali admin panel. -->
<!-- 3. Install the "Jabali" importer from the list. -->
<!-- 4. Activate & Run Importer. -->
<!-- 5. Upload this file using the form provided on that page. -->
<!-- 6. You will first be asked to map the authors in this export file to users -->
<!--    on the site. For each author, you may choose to map to an -->
<!--    existing user on the site or to create a new user. -->
<!-- 7. Jabali will then import each of the posts, pages, comments, categories, etc. -->
<!--    contained in this file into your site. -->

<?php the_generator( 'export' ); ?>
<rss version="2.0"
	xmlns:excerpt="http://jabali.github.io/export/<?php echo WXR_VERSION; ?>/excerpt/"
	xmlns:content="http://purl.org/rss/1.0/modules/content/"
	xmlns:wfw="http://wellformedweb.org/CommentAPI/"
	xmlns:dc="http://purl.org/dc/elements/1.1/"
	xmlns:wp="http://jabali.github.io/export/<?php echo WXR_VERSION; ?>/"
>
...
<?php if ( 'all' == $args['content'] ) wxr_nav_menu_terms(); ?>
	...
	<?php
	/** This action is documented in reslib/feed-rss2.php */
	do_action( 'rss2_head' );
	?>
...
?>
	<item>
		<title><?php
			/** This filter is documented in reslib/feed.php */
