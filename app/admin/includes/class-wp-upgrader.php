...
class WP_Upgrader {
	...
	public function generic_strings() {
		...
		$this->strings['fs_no_root_dir'] = __('Unable to locate Jabali root directory.');
		$this->strings['fs_no_content_dir'] = __('Unable to locate Jabali content directory (wp-content).');
		$this->strings['fs_no_plugins_dir'] = __('Unable to locate Jabali plugin directory.');
		$this->strings['fs_no_themes_dir'] = __('Unable to locate Jabali theme directory.');
	...
	public function install_package( $args = array() ) {
		 ...
		 * destination directory (WP_PLUGIN_DIR / main/themes) intending
		 * to copy the directory into the directory, whilst they pass the source
		 * as the actual files to copy.
		 */
		$protected_directories = array( ABSPATH, MAIN_DIR, WP_PLUGIN_DIR, MAIN_DIR . '/themes' );
	...
	/**
 	 * Creates a lock using Jabali options.
 	 *
 	 * @since 4.5.0
 	 * @access public
 	 * @static
