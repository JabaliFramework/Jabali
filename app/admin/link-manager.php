...
'title'		=> __('Overview'),
'content'	=>
	'<p>' . sprintf(__('You can add links here to be displayed on your site, usually using <a href="%s">Widgets</a>. By default, links to several sites in the Jabali community are included as examples.'), 'widgets.php') . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://codex.jabali.github.io/Links_Screen">Documentation on Managing Links</a>') . '</p>' .
