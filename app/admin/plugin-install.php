...
'title'		=> __('Overview'),
'content'	=>
	'<p>' . sprintf( __('Plugins hook into Jabali to extend its functionality with custom features. Plugins are developed independently from the core Jabali application by thousands of developers all over the world. All plugins in the official <a href="%s">Jabali Plugin Directory</a> are compatible with the license Jabali uses.' ), __( 'https://jabali.github.io/plugins/' ) ) . '</p>' .
...
'content'	=>
	'<p>' . __('If you know what you&#8217;re looking for, Search is your best bet. The Search screen has options to search the Jabali Plugin Directory for a particular Term, Author, or Tag. You can also search the directory by selecting popular tags. Tags in larger type mean more plugins have been labeled with that tag.') . '</p>' .
	...
	'<p>' . __( 'You can also browse a user&#8217;s favorite plugins, by using the Favorites link above the plugins list and entering their Jabali.org username.' ) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://codex.jabali.github.io/Plugins_Add_New_Screen">Documentation on Installing Plugins</a>') . '</p>' .
...
/**
 * Jabali Administration Template Header.
 */
...
/**
 * Jabali Administration Template Footer.
 */
