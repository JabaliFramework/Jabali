...
if ( ! is_multisite() && ( get_option('upload_url_path') || ( get_option('upload_path') != 'main/uploads' && get_option('upload_path') ) ) ) {
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://codex.jabali.github.io/Settings_Media_Screen">Documentation on Media Settings</a>') . '</p>' .
...
<table class="form-table">
<?php
// If upload_url_path is not the default (empty), and upload_path is not the default ('main/uploads' or empty)
if ( get_option('upload_url_path') || ( get_option('upload_path') != 'main/uploads' && get_option('upload_path') ) ) :
?>
<tr>
<th scope="row"><label for="upload_path"><?php _e('Store uploads in this folder'); ?></label></th>
<td><input name="upload_path" type="text" id="upload_path" value="<?php echo esc_attr(get_option('upload_path')); ?>" class="regular-text code" />
<p class="description"><?php
	/* translators: %s: main/uploads */
	printf( __( 'Default is %s' ), '<code>main/uploads</code>' );
?></p>
</td>
</tr>
