 ...
 * base prefix, Jabali core can no longer account for the possible collision.
 */
...
if ( $iis7_permalinks ) {
	...
	if ( ( ! file_exists( $home_path . '.htaccess' ) && is_writable( $home_path ) ) || is_writable( $home_path . '.htaccess' ) ) {
		...
		$writable = false;
		$existing_rules  = array_filter( extract_from_markers( $home_path . '.htaccess', 'Jabali' ) );
...
<?php require( ABSPATH . 'admin/admin-footer.php' ); ?>
