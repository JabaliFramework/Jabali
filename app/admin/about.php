...
?>
	<div class="wrap about-wrap">
		...
		<div class="feature-section one-col">
			...
			<p class="lead-description"><?php _e( 'Jabali 4.7 adds new features to the customizer to help take you through the initial setup of a theme, with non-destructive live previews of all your changes in one uninterrupted workflow.' ); ?></p>
		</div>
		...
		<div class="feature-section two-col">
			...
			<div class="col">
				...
				<p><?php _e( 'Sometimes you just need a few visual tweaks to make your site perfect. Jabali 4.7 allows you to add custom CSS and instantly see how your changes affect your site. The live preview allows you to work quickly without page refreshes slowing you down.' ); ?></p>
			</div>
		</div>
		...
		<div class="feature-section no-heading two-col">
			<div class="col">
				...
				<p><?php _e( 'Managing your document collection is easier with Jabali 4.7. Uploading PDFs will generate thumbnail images so you can more easily distinguish between all your documents.' ); ?></p>
			</div>
			<div class="col">
		...
		<div class="rest-api feature-section one-col">
			...
			<p class="lead-description"><?php _e( 'Jabali 4.7 comes with REST API endpoints for posts, comments, terms, users, meta, and settings.' ); ?></p>
			...
			<p><?php
				printf(
					/* translators: %s: https://developer.jabali.github.io/rest-api/  */
					__( 'Content endpoints provide machine-readable external access to your Jabali site with a clear, standards-driven interface, paving the way for new and innovative methods of interacting with sites through plugins, themes, apps, and beyond. Ready to get started with development? <a href="%s">Check out the REST API reference.</a>' ),
					'https://developer.jabali.github.io/rest-api/reference/'
				);
			?></p>
		</div>
		...
		<div class="changelog">
			...
			<div class="under-the-hood three-col">
				<div class="col">
					<h3><a href="https://make.jabali.github.io/core/2016/11/03/post-type-templates-in-4-7/"><?php _e( 'Post Type Templates' ); ?></a></h3>
					<p><?php _e( 'By opening up the page template functionality to all post types, theme developers have even more flexibility with the Jabali template hierarchy.' ); ?></p>
				</div>
				<div class="col">
					<h3><?php _e( 'More Theme API Goodies' ); ?></h3>
					<p><?php
						printf(
							/* translators: %s: https://make.jabali.github.io/core/2016/09/09/new-functions-hooks-and-behaviour-for-theme-developers-in-jabali-4-7/  */
							__( 'Jabali 4.7 includes <a href="%s">new functions, hooks, and behavior</a> for theme developers.' ),
							'https://make.jabali.github.io/core/2016/09/09/new-functions-hooks-and-behaviour-for-theme-developers-in-jabali-4-7/'
						);
					?></p>
				</div>
				<div class="col">
					<h3><a href="https://make.jabali.github.io/core/2016/10/04/custom-bulk-actions/"><?php _e( 'Custom Bulk Actions' ); ?></a></h3>
			...
			<div class="under-the-hood three-col">
				<div class="col">
					<h3><a href="https://make.jabali.github.io/core/2016/09/08/wp_hook-next-generation-actions-and-filters/"><code>WP_Hook</code></a></h3>
					<p><?php
						printf(
							/* translators: %s: https://make.jabali.github.io/core/2016/09/08/wp_hook-next-generation-actions-and-filters/  */
							__( 'The code that lies beneath actions and filters has been overhauled and modernized, fixing bugs along the way.' ),
							'https://make.jabali.github.io/core/2016/09/08/wp_hook-next-generation-actions-and-filters/'
						);
					?></p>
				</div>
				<div class="col">
					...
					<p><?php
						printf(
							/* translators: 1: register_setting(), 2: https://make.jabali.github.io/core/2016/10/26/registering-your-settings-in-jabali-4-7/ */
							__( '%1$s <a href="%2$s">has been enhanced</a> to include type, description, and REST API visibility.' ),
							'<code>register_setting()</code>',
							'https://make.jabali.github.io/core/2016/10/26/registering-your-settings-in-jabali-4-7/'
						);
					?></p>
				</div>
				<div class="col">
					<h3><a href="https://make.jabali.github.io/core/2016/10/12/customize-changesets-technical-design-decisions/"><?php _e( 'Customize Changesets' ); ?></a></h3>
...
/* translators: %s: Jabali version number */
__( '<strong>Version %s</strong> addressed one security issue.' );
/* translators: %s: Jabali version number */
__( '<strong>Version %s</strong> addressed some security issues.' );

/* translators: 1: Jabali version number, 2: plural number of bugs. */
_n_noop( '<strong>Version %1$s</strong> addressed %2$s bug.',
         '<strong>Version %1$s</strong> addressed %2$s bugs.' );

/* translators: 1: Jabali version number, 2: plural number of bugs. Singular security issue. */
_n_noop( '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.',
         '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.' );

/* translators: 1: Jabali version number, 2: plural number of bugs. More than one security issue. */
