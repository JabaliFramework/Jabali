/**
 * Functions for ajaxified updates, deletions and installs inside the Jabali admin.
 *
 * @version 4.2.0
 *
 * @package Jabali
...
(function( $, wp, settings ) {
	...
	/**
	 * Handles Ajax requests to Jabali.
	 *
	 * @since 4.6.0
	 *
	 ...
	 *
	 * @param {object}                args         Arguments.
	 * @param {string}                args.slug    Plugin identifier in the Jabali.org Plugin repository.
