...
(function( exports, $ ){
	 ...
	 *
	 * A setting is Jabali data (theme mod, option, menu, etc.) that the user can
	...
	api.Previewer = api.Messenger.extend({
		...
		initialize: function( params, options ) {
			...
			previewer.add( 'previewUrl', params.previewUrl ).setter( function( to ) {
				...
				// Abort if URL is for admin or (static) files in reslib or wp-content.
	...
	$( function() {
		...
		api.previewer = new api.Previewer({
			 ...
			 *
			 * @since 3.4.0
			 * @since 17.01.0 Added options param.
			 * @access public
			 *
			 * @param {object}  [options] Options.
			 ...
			 *
			 * @since 3.4.0
			 * @since 17.01.0 Added args param and return value.
			 *
