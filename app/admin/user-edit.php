...
$profile_help = '<p>' . __('Your profile contains information about you (your &#8220;account&#8221;) as well as some personal options related to using Jabali.') . '</p>' .
	'<p>' . __('You can change your password, turn on keyboard shortcuts, change the color scheme of your Jabali administration screens, and turn off the WYSIWYG (Visual) editor, among other things. You can hide the Toolbar (formerly called the Admin Bar) from the front end of your site, however it cannot be disabled on the admin screens.') . '</p>' .
	'<p>' . __( 'You can select the language you wish to use while using the Jabali administration screen without affecting the language site visitors see.' ) . '</p>' .
...
get_current_screen()->set_help_sidebar(
    ...
    '<p>' . __('<a href="https://codex.jabali.github.io/Users_Your_Profile_Screen">Documentation on User Profiles</a>') . '</p>' .
...
<td><label for="comment_shortcuts"><input type="checkbox" name="comment_shortcuts" id="comment_shortcuts" value="true" <?php if ( ! empty( $profileuser->comment_shortcuts ) ) checked( 'true', $profileuser->comment_shortcuts ); ?> /> <?php _e('Enable keyboard shortcuts for comment moderation.'); ?></label> <?php _e('<a href="https://codex.jabali.github.io/Keyboard_Shortcuts" target="_blank">More information</a>'); ?></td>
</tr>
<?php endif; ?>
...
<tr class="user-profile-picture">
	...
	<td>
		...
		<p class="description"><?php
			 ...
			 *
			 * @since 4.4.0
			 * @since 17.01.0 Added the `$profileuser` parameter.
			 *
