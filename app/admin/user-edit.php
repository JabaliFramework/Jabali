...
get_current_screen()->set_help_sidebar(
    ...
    '<p>' . __('<a href="https://jabali.github.io/Docs/Users_Your_Profile_Screen">Documentation on User Profiles</a>') . '</p>' .
...
<td><label for="comment_shortcuts"><input type="checkbox" name="comment_shortcuts" id="comment_shortcuts" value="true" <?php if ( ! empty( $profileuser->comment_shortcuts ) ) checked( 'true', $profileuser->comment_shortcuts ); ?> /> <?php _e('Enable keyboard shortcuts for comment moderation.'); ?></label> <?php _e('<a href="https://jabali.github.io/Docs/Keyboard_Shortcuts" target="_blank">More information</a>'); ?></td>
</tr>
<?php endif; ?>
