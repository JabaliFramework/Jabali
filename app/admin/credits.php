...
if ( ! $credits ) {
	...
	/* translators: 1: https://jabali.github.io/about/, 2: https://make.jabali.github.io/ */
	printf( __( 'Jabali is created by a <a href="%1$s">worldwide team</a> of passionate individuals. <a href="%2$s">Get involved in Jabali</a>.' ),
		'https://jabali.github.io/about/',
		__( 'https://make.jabali.github.io/' )
	);
	echo '</p>';
	echo '</div>';
...
echo '<p class="about-description">' . __( 'Jabali is created by a worldwide team of passionate individuals.' ) . "</p>\n";
...
?>
<p class="clear"><?php
	/* translators: %s: https://make.jabali.github.io/ */
	printf( __( 'Want to see your name in lights on this page? <a href="%s">Get involved in Jabali</a>.' ),
		__( 'https://make.jabali.github.io/' )
	);
?></p>
...
__( 'Project Leaders' );
__( 'Core Contributors to Jabali %s' );
