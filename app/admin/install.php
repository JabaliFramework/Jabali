...
<body class="wp-core-ui">
	<p id="logo"><a href="https://jabali.github.io/">Jabali</a></p>
	<h1>Error: PHP is not running</h1>
	<p>Jabali requires that your web server is running PHP. Your server does not have PHP installed, or PHP is turned off.</p>
</body>
</html>
<?php
}
...
<head>
	...
	<title><?php _e( 'Jabali &rsaquo; Installation' ); ?></title>
	<?php
...
<form id="setup" method="post" action="install.php?step=2" novalidate="novalidate">
	...
	<p class="step"><?php submit_button( __( 'Install Jabali' ), 'large', 'Submit', false, array( 'id' => 'submit' ) ); ?></p>
...
if ( is_blog_installed() ) {
	...
	die(
		...
		'<p>' . __( 'You appear to have already installed Jabali. To reinstall please clear your old database tables first.' ) . '</p>' .
...
$mysql_compat   = version_compare( $mysql_version, $required_mysql_version, '>=' ) || file_exists( MAIN_DIR . 'config/db.php' );
...
if ( defined( 'DO_NOT_UPGRADE_GLOBAL_TABLES' ) ) {
	...
	die(
		...
		'<p>' . sprintf(
			...
			__( 'The constant %s cannot be defined when installing Jabali.' ),
...
<p><?php _e( 'Jabali has been installed. Thank you, and enjoy!' ); ?></p>
