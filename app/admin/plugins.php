...
if ( $action ) {
	...
	switch ( $action ) {
		...
		case 'delete-selected':
			...
			include(ABSPATH . 'admin/update.php');
...
'title'		=> __('Overview'),
'content'	=>
	'<p>' . __('Plugins extend and expand the functionality of Jabali. Once a plugin is installed, you may activate it or deactivate it here.') . '</p>' .
	'<p>' . __( 'The search for installed plugins will search for terms in their name, description, or author.' ) . ' <span id="live-search-desc" class="hide-if-no-js">' . __( 'The search results will be updated as you type.' ) . '</span></p>' .
	'<p>' . sprintf(
		/* translators: %s: Jabali Plugin Directory URL */
		__( 'If you would like to see more plugins to choose from, click on the &#8220;Add New&#8221; button and you will be able to browse or search for additional plugins from the <a href="%s">Jabali Plugin Directory</a>. Plugins in the Jabali Plugin Directory are designed and developed by third parties, and are compatible with the license Jabali uses. Oh, and they&#8217;re free!' ),
		__( 'https://jabali.github.io/plugins/' )
	) . '</p>'
) );
get_current_screen()->add_help_tab( array(
...
'content'	=>
	'<p>' . __('Most of the time, plugins play nicely with the core of Jabali and with other plugins. Sometimes, though, a plugin&#8217;s code will get in the way of another plugin, causing compatibility issues. If your site starts doing strange things, this may be the problem. Try deactivating all your plugins and re-activating them in various combinations until you isolate which one(s) caused the issue.') . '</p>' .
	'<p>' . sprintf(
		/* translators: WP_PLUGIN_DIR constant value */
		__( 'If something goes wrong with a plugin and you can&#8217;t use Jabali, delete or rename that file in the %s directory and it will be automatically deactivated.' ),
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __('<a href="https://codex.jabali.github.io/Managing_Plugins#Plugin_Management">Documentation on Managing Plugins</a>') . '</p>' .
