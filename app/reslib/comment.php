...
function check_comment($author, $email, $url, $comment, $user_ip, $user_agent, $comment_type) {
	...
	/** This filter is documented in reslib/comment-template.php */
	...
	if ( $max_links = get_option( 'comment_max_links' ) ) {
		 ...
		 *
		 * @since 3.0.0
		 * @since 17.01.0 Added the `$comment` parameter.
		 *
...
/**
 * Retrieve all of the Jabali supported comment statuses.
 *
 ...
 *
 * @since 1.5.0
 * @since 17.01.0 Replaced caching the modified date in a local static variable
 ...
 *
 * @since 2.9.0
 * @link https://codex.jabali.github.io/Function_Reference/add_comment_meta
 *
 ...
 *
 * @since 2.9.0
 * @link https://codex.jabali.github.io/Function_Reference/delete_comment_meta
 *
 * @param int $comment_id comment ID
 * @param string $meta_key Metadata name.
 ...
 *
 * @since 2.9.0
 * @link https://codex.jabali.github.io/Function_Reference/get_comment_meta
 *
 * @param int $comment_id Comment ID.
 ...
 *
 * @since 2.9.0
 * @link https://codex.jabali.github.io/Function_Reference/update_comment_meta
 *
 * @param int $comment_id Comment ID.
 ...
 *
 * @since 2.0.0
 * @since 17.01.0 The `$avoid_die` parameter was added, allowing the function to
...
function wp_allow_comment( $commentdata, $avoid_die = false ) {
	 ...
	 *
	 * @since 2.3.0
	 * @since 17.01.0 The `$avoid_die` parameter was added.
	 *
 ...
 *
 * @since 2.3.0
 * @since 17.01.0 Converted to be an add_filter() wrapper.
 */
...
function get_page_of_comment( $comment_ID, $args = array() ) {
	 ...
	 *
	 * @since 4.4.0
	 * @since 17.01.0 Introduced the `$comment_ID` parameter.
	 *
...
function wp_delete_comment($comment_id, $force_delete = false) {
	...
	/** This action is documented in reslib/comment.php */
...
function wp_filter_comment($commentdata) {
	if ( isset( $commentdata['user_ID'] ) ) {
		...
		/** This filter is documented in reslib/comment.php */
		$commentdata['user_id'] = apply_filters( 'pre_user_id', $commentdata['user_id'] );
	}
 ...
 * and whether comment is approved by Jabali. Also has {@see 'preprocess_comment'}
 * filter for processing the comment data before the function handles it.
 *
 * We use `REMOTE_ADDR` here directly. If you are behind a proxy, you should ensure
 * that it is properly set, such as in db.php, for your environment.
 *
 * See {@link https://core.trac.jabali.github.io/ticket/9235}
 *
 * @since 1.5.0
...
function wp_update_comment_count_now($post_id) {
	...
	/** This action is documented in reslib/post.php */
 ...
 *
 * @since 1.5.0
 * @since 17.01.0 $post_id can be a WP_Post object.
 *
 * @global wpdb $wpdb Jabali database abstraction object.
 *
...
function do_trackbacks( $post_id ) {
	...
	if ( empty($post->post_excerpt) ) {
		/** This filter is documented in reslib/post-template.php */
...
function pingback( $content, $post_id ) {
	...
	include_once( ABSPATH . RES . '/class-wp-http-ixr-client.php' );
	...
	foreach ( (array) $post_links as $pagelinkedto ) {
		...
		if ( $pingback_server_url ) {
			 ...
			 * @since 2.9.0
			 *
			 * @param string $concat_useragent    The user agent concatenated with ' -- Jabali/'
			 *                                    and the Jabali version.
			 * @param string $useragent           The useragent.
			 * @param string $pingback_server_url The server URL being linked to.
			 * @param string $pagelinkedto        URL of page linked to.
			 * @param string $pagelinkedfrom      URL of page linked from.
			 */
			$client->useragent = apply_filters( 'pingback_useragent', $client->useragent . ' -- Jabali/' . get_bloginfo( 'version' ), $client->useragent, $pingback_server_url, $pagelinkedto, $pagelinkedfrom );
...
function weblog_ping($server = '', $path = '') {
	...
	$client->timeout = 3;
	$client->useragent .= ' -- Jabali/' . get_bloginfo( 'version' );
