<?php
/**
 * Jabali Post Template Functions.
 *
...
/**
 * Display the ID of the current item in the Jabali Loop.
 *
 * @since 0.71
 */
function the_ID() {
...
/**
 * Retrieve the ID of the current item in the Jabali Loop.
 *
 * @since 2.1.0
 *
 * @return int|false The ID of the current item in the Jabali Loop. False if $post is not set.
 */
function get_the_ID() {
	$post = get_post();
 ...
 *
 * @since 1.5.0
 * @since 17.01.0 Added the `item_spacing` argument.
 *
 * @see get_pages()
 *
 * @global WP_Query $wp_query
...
function get_the_password_form( $post = 0 ) {
	...
	$output = '<form action="' . esc_url( site_url( 'login.php?action=postpass', 'login_post' ) ) . '" class="post-password-form" method="post">
 ...
 * @since 17.01.0 Now works with any post type, not just pages.
 *
