 ...
 *
 * @todo The Jabali convention is to use underscores instead of camelCase for function and method
...
class WP_Http_Cookie {
	...
	/**
	 * Retrieve cookie header for usage in the rest of the Jabali HTTP API.
	 *
	 * @access public
	 * @since 2.8.0
	 *
