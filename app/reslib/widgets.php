 ...
 * themes
 *
 * Includes both internal Jabali routines and theme-use routines.
 *
 ...
 * of default arguments for the new sidebar. Jabali will automatically
...
function dynamic_sidebar( $index = 1 ) {
	...
	if ( empty( $wp_registered_sidebars[ $index ] ) || empty( $sidebars_widgets[ $index ] ) || ! is_array( $sidebars_widgets[ $index ] ) ) {
		/** This action is documented in reslib/widget.php */
		do_action( 'dynamic_sidebar_before', $index, false );
		/** This action is documented in reslib/widget.php */
		do_action( 'dynamic_sidebar_after',  $index, false );
		/** This filter is documented in reslib/widget.php */
...
/**
 * Registers all of the default Jabali widgets on startup.
 *
 * Calls {@see 'widgets_init'} action after all of the Jabali widgets have been registered.
 *
 * @since 2.2.0
 */
function wp_widgets_init() {
	...
	/**
	 * Fires after all default Jabali widgets have been registered.
	 *
	 * @since 2.2.0
	 */
