<?php
/**
 * Deprecated functions from Jabali MU and the multisite feature. You shouldn't
 ...
 * Dashboard blog functionality was removed in Jabali 3.1, replaced by the user admin.
 *
 * @since MU
