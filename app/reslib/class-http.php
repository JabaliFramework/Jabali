...
if ( ! class_exists( 'Requests' ) ) {
	require( ABSPATH . RES . '/class-requests.php' );

	Requests::register_autoloader();
	Requests::set_certificate_path( ABSPATH . RES . '/certificates/ca-bundle.crt' );
}
...
class WP_Http {
	 ...
	 *                                             Default Jabali/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ).
	 ...
	 *                                             Default ABSPATH . RES . '/certificates/ca-bundle.crt'.
	...
	public function request( $url, $args = array() ) {
		$defaults = array(
			 ...
			 * @since 2.7.0
			 *
			 * @param string $user_agent Jabali user agent string.
			 */
			'user-agent' => apply_filters( 'http_headers_useragent', 'Jabali/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ) ),
			/**
			...
			'decompress' => true,
			'sslverify' => true,
			'sslcertificates' => ABSPATH . RES . '/certificates/ca-bundle.crt',
			'stream' => false,
			'filename' => null,
	...
	private function _dispatch_request( $url, $args ) {
		...
		/** This action is documented in reslib/class-http.php */
	 ...
	 * prevent plugins from working and core functionality, if you don't include api.jabali.github.io.
	 *
	 * You block external URL requests by defining WP_HTTP_BLOCK_EXTERNAL as true in your db.php
	 * file and this will only allow localhost and your site to make requests. The constant
	 * WP_ACCESSIBLE_HOSTS will allow additional hosts to go through for requests. The format of the
	 * WP_ACCESSIBLE_HOSTS constant is a comma separated list of hostnames to allow, wildcard domains
	 * are supported, eg *.jabali.github.io will allow for all subdomains of jabali.github.io to be contacted.
	 *
	 * @since 2.8.0
	 * @link https://core.trac.jabali.github.io/ticket/8927 Allow preventing external requests.
	 * @link https://core.trac.jabali.github.io/ticket/14636 Allow wildcard domains in WP_ACCESSIBLE_HOSTS
	 *
