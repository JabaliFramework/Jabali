 ...
 *
 * Note: When using features provided by ArrayAccess, be aware that Jabali deliberately
...
class WP_REST_Request implements ArrayAccess {
	 ...
	 *
	 * @since 4.4.0
	 * @since 17.01.0 Returns error instance if value cannot be decoded.
	 * @access protected
	...
	protected function parse_json_params() {
		 ...
		 * might not be defined: https://core.trac.jabali.github.io/ticket/27799
		 */
