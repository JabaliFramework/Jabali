...
class CustomPress_Core_Admin extends CustomPress_Content_Types {
	...
	*/
	function enqueue_scripts() {
		wp_enqueue_style( 'ct-admin-styles', '/reslib/custompress/ui-admin/css/styles.css');
		wp_enqueue_script( 'ct-admin-scripts', '/reslib/custompress/ui-admin/js/ct-scripts.js', array( 'jquery' ) );
	...
	*/
	function enqueue_settings_scripts() {
		wp_enqueue_script( 'settings-admin-scripts', '/reslib/custompress/ui-admin/js/settings-scripts.js', array( 'jquery' ) );
		wp_enqueue_script('jquery-combobox');
		wp_enqueue_style('jquery-combobox');
		wp_enqueue_script('jquery-validate');
		wp_enqueue_script('jquery-ui-datepicker');
	...
	*/
	function enqueue_custom_field_scripts() {
		wp_enqueue_style( 'ct-admin-custom-field-styles', '/reslib/custompress/ui-admin/css/custom-fields-styles.css' );
		wp_enqueue_script('jquery-combobox');
		wp_enqueue_style('jquery-combobox');
		wp_enqueue_script('jquery-validate');
		wp_enqueue_script('jquery-ui-datepicker');
