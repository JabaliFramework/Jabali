	...
	*/
	...
	function on_enqueue_scripts(){
		...
		if(!empty($lang))
		{
			...
			wp_register_script('jquery-ui-datepicker-lang', '/reslib/custompress/"datepicker/js/i18n/jquery.ui.datepicker-$lang.js', array('jquery','jquery-ui-datepicker'), '1.8.18');
		}

		// Dynamic CSS switching for date picker
		wp_register_script('dynamic-css', '/reslib/custompress/datepicker/js/cp-dynamic-css.js', array(), 'CP-'.CPT_VERSION);
		//wp_enqueue_script('dynamic-css');

		wp_register_script('jquery-validate', '/reslib/custompress/ui-admin/js/jquery.validate.min.js', array('jquery'), '1.8.18');

		wp_register_script('jquery-combobox', '/reslib/custompress/datepicker/js/jquery.combobox/jquery.combobox.js', array('jquery'), '1.8.18');

		wp_register_style('jquery-combobox', '/reslib/custompress/datepicker/js/jquery.combobox/style.css', array(), '0.5');

		$theme = $this->get_options('datepicker_theme');
		$theme = (empty($theme) ) ? 'flick' : $theme;
		wp_register_style('jquery-ui-datepicker', '/reslib/custompress/datepicker/css/{$theme}/datepicker.css', array(), '0.5');
	}
