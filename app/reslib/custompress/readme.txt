...
Tags: post types, taxonomies, custom fields, wpmu, jabali multisite
...
Jabali and Jabali Multisite Manual if you are new to Jabali.

===To install:===

1. Download the plugin file
2. Unzip the file into a folder on your hard drive
3. Upload `custompress` folder to the `/main/plugins/` directory.

==To Activate:==

1. Login to your admin panel for Jabali or Multisite and activate the plugin: 

2. On regular Jabali installs - visit Plugins and Activate the plugin.
3. For Jabali Multisite installs - visit Network Admin -> Plugins and Network Activate the plugin.
 
...
The easiest way to do this is to simply log into your site via FTP and go to main/plugins/custompress/loader.php  Simply open this file in your preferred code or text editor and delete line 10 - which simply has  Network: true
...
Taxonomies are used to arrange, classify and group things. By default, Taxonomies in Jabali are tags and categories that Jabali uses for the post.  With custom posts you can create your own taxonomies.  
...
9.  Your Taxonomy will now be created and you should see the new menu items for your Taxonomy in your admin interface.
	...
	* Simply copy the embed code and place it inside your Jabali loop to display the new taxonomy with your theme
...
8.  Your Custom field will now be created and you should see the custom fields on your custom post admin interface.
	...
	* Simply copy the embed code into your templates and place it inside your Jabali loop to display the new custom field with your theme
...
We'll be using the Theme Editor included in Jabali for sake of ease in this guide, however, using a proper code-editing program is always recommended.
...
9.  Place your Taxonomies and custom field embed code inside your Jabali loop in your newly created custom template
