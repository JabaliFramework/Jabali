...
<h3><?php esc_html_e('Add Taxonomy', $this->text_domain); ?></h3>
<form action="#" method="post" class="ct-taxonomy">
	<div class="ct-wrap-left">
		<div class="ct-table-wrap">
			...
			<table class="form-table <?php do_action('ct_invalid_field_taxonomy'); ?>" >
				<tr>
					<th>
						<label><?php esc_html_e('Taxonomy', $this->text_domain) ?>
		...
		<div class="ct-table-wrap">
			...
			<table class="form-table">
				<tr>
					...
					<td>
						<p><span class="description"><?php esc_html_e('Name of the query var to use for this taxonomy. False to prevent queries. Defaults to the taxonomy name.', $this->text_domain); ?></span></p>
						<label>
	...
	<p class="submit">
		...
		<input type="submit" class="button-primary" name="submit" value="<?php esc_html_e('Add Taxonomy Type', $this->text_domain); ?>" />
	</p>
	<br /><br /><br /><br />
</form>