<?php
/**
 * Deprecated pluggable functions from past Jabali versions. You shouldn't use these
 ...
 * used anywhere in Jabali. Also, plugins shouldn't use it either.
 *
 * @since 2.0.3
 * @deprecated 2.5.0
 *
...
/**
 * Jabali AtomPub API implementation.
 *
 * Originally stored in wp-app.php, and later reslib/class-wp-atom-server.php.
 * It is kept here in case a plugin directly referred to the class.
 *
 * @since 2.2.0
 * @deprecated 3.5.0
 *
 * @link https://jabali.github.io/plugins/atom-publishing-protocol/
 */
