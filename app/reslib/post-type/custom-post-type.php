...
Plugin URI: http://hijiriworld.com/web/plugins/custom-post-types/
Description: Generate Custom Post Types and Custom Taxonomies, from the admin interface which is easy to understand. it's a must have for any user working with Jabali.
Author: hijiri
...
define( 'CPTG_URL', dirname(__FILE__). '/' );
...
function echo_boolean_options( $obj )
{
	if ( $obj == 0 ) {
...
function echo_boolean_null_false_options( $obj )
{
	if ( $obj == 0 ) {
		echo '<option value="0" selected="selected">false</option>';
