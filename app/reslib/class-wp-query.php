...
class WP_Query {
	 ...
	 *
	 * The query flags are what page info Jabali was able to figure out.
	 *
	 * @since 2.0.0
	 * @access private
	 */
	...
	public function get_posts() {
		 ...
		 *
		 * Return a non-null value to bypass Jabali's default post queries.
		 *
		...
		if ( !empty($this->posts) && $this->is_comment_feed && $this->is_singular ) {
			/** This filter is documented in reslib/query.php */
	...
	/**
	 * Sets up the Jabali query by parsing query string.
	 *
	 * @since 1.5.0
	 * @access public
	 *
	 ...
	 * Constructor.
	 *
	 * Sets up the Jabali query, if parameter is not empty.
	 *
	 * @since 1.5.0
	 * @access public
	 *
