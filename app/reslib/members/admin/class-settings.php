...
final class Members_Settings_Page {
	...
	public function add_help_tabs() {
		...
		$tut_link  = sprintf( '<li><a href="http://justintadlock.com/archives/2009/08/30/users-roles-and-capabilities-in-jabali">%s</a></li>', esc_html__( 'Users, Roles, and Capabilities', 'members' ) );
	...
	public function help_tab_roles_caps() { ?>
		...
		<p>
			<?php esc_html_e( 'The role manager allows you to manage roles on your site by giving you the ability to create, edit, and delete any role. Note that changes to roles do not change settings for the Members plugin. You are literally changing data in your Jabali database. This plugin feature merely provides an interface for you to make these changes.', 'members' ); ?>
		</p>
