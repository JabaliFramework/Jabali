...
function members_register_role_groups() {
	...
	// Register the Jabali group.
	members_register_role_group( 'jabali',
		array(
			'label'       => esc_html__( 'Jabali', 'members' ),
			'label_count' => _n_noop( 'Jabali %s', 'Jabali %s', 'members' ),
			'roles'       => members_get_jabali_role_slugs(),
		)
	);
