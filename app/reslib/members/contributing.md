...
In general, the project follows all Jabali [coding standards](https://make.jabali.github.io/core/handbook/best-practices/coding-standards).  There are instances where it doesn't, opting for personal choices of my own, but in terms of contributing, following the Jabali standards is best practice.
