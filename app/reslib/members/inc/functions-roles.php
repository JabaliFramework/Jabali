<?php
/**
 * Role-related functions that extend the built-in Jabali Roles API.
 *
 * @package    Members
 * @subpackage Includes
...
/**
 * Returns an array of core Jabali role names.
 *
 * @since  1.0.0
 * @access public
 * @return array
 */
function members_get_jabali_role_names() {
	$names = array();

	foreach ( members_role_factory()->jabali as $role )
 ...
 * @return array
 */
function members_get_jabali_role_slugs() {
	return array_keys( members_role_factory()->jabali );
}
...
/**
 * Sanitizes a role name.  This is a wrapper for the `sanitize_key()` Jabali function.  Only
...
/**
 * Jabali provides no method of translating custom roles other than filtering the
...
/**
 * Conditional tag to check whether a role is a core Jabali URL.
 *
 * @since  1.0.0
 * @access public
 * @param  string  $role
 * @return bool
 */
function members_is_jabali_role( $role ) {
