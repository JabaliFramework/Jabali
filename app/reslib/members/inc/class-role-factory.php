<?php
/**
 * Jabali' `WP_Roles` and the global `$wp_roles` array don't really cut it.  So, this is a
...
final class Members_Role_Factory {
	...
	public function add_role( $role ) {
		...
		if ( members_role_exists( $role ) ) {
			...
			// Is WP role?
			if ( members_is_jabali_role( $role ) )
				$this->jabali[ $role ] = $this->roles[ $role ];
		}
	}
