 ...
 * a problem with folks accidentally deleting the default Jabali capabilities, the
 ...
 * remove a useful Jabali capability from all roles.  When this happens, the capability is no
 * longer stored in any of the roles, so it basically doesn't exist.  This function will house
 * all of the default Jabali capabilities in case this scenario comes into play.
 *
...
/**
 * Old Jabali levels system.  This is mostly useful for filtering out the levels when shown
...
/**
 * Get rid of levels since these are mostly useless in newer versions of Jabali.  Devs should
