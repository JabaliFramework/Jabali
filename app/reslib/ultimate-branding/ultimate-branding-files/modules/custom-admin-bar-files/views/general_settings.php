        ...
        <div class="postbox">
            ...
            <div class="inside">
                <table class="form-table">
                    ...
                    <tr>
                        <th scope="row">
                            <?php  _e('Hide Jabali Menu Items', 'ub') ?>
                        </th>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">
                                <?php _e("Styles defined here only apply to the admin bar, no other part of Jabali will be affected. Leave empty if no change to the default style is being made. Please don't use more than one selector for each set of rules", "ub"); ?>
