...
/*
  ...
  Plugin URI: http://premium.wpmudev.org/project/remove-jabali-dashboard-widgets
  Description: Removes the jabali dashboard widgets
...
function ub_rwpwidgets_manage_output() {
    ...
    <div class="postbox">
        <h3 class="hndle" style='cursor:auto;'><span><?php _e('Remove Jabali Dashboard Widgets ', 'ub'); ?></span></h3>
        <div class="inside">
