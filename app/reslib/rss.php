 ...
 */
_deprecated_file( basename( __FILE__ ), '3.0.0', RES . '/class-simplepie.php' );
...
define('RSS', 'RSS');
define('ATOM', 'Atom');
define('MAGPIE_USER_AGENT', 'Jabali/' . $GLOBALS['wp_version']);
...
class RSSCache {
	...
	function __construct( $base = '', $age = '' ) {
		$this->BASE_CACHE = MAIN_DIR . '/cache';
		if ( $base ) {
