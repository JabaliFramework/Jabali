...
function get_locale() {
	...
	if ( isset( $locale ) ) {
		/**
		 * Filters Jabali install's locale ID.
		 *
		 * @since 1.5.0
		 *
	...
	/** This filter is documented in reslib/l10n.php */
	return apply_filters( 'locale', $locale );
}
 ...
 *
 * Loads the .mo file in WP_LANG_DIR constant path from Jabali root.
 ...
 * the translation file from `main/languages`, removing the need
 ...
 *
 * @since 3.0.0
 * @since 17.01.0 The results are now filterable with the {@see 'get_available_languages'} filter.
 *
 ...
 *
 * Looks in the main/languages directory for translations of
 * plugins or themes.
 *
 * @since 3.7.0
 *
 ...
 * @since 17.01.0 Introduced the `show_option_site_default` argument.
 *
