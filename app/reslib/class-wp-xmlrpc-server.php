<?php
/**
 * XML-RPC protocol support for Jabali
 *
 * @package Jabali
...
/**
 * Jabali XMLRPC server implementation.
 *
 * Implements compatibility for Blogger API, MetaWeblog API, MovableType, and
 * pingback. Additional Jabali API for managing comments, pages, posts,
 * options, etc.
 *
 * As of Jabali 3.5.0, XML-RPC is enabled by default. It can be disabled
...
class wp_xmlrpc_server extends IXR_Server {
	...
	/**
	 * Convert a Jabali date string to an IXR_Date object.
	 *
	 * @access protected
	 *
	...
	/**
	 * Convert a Jabali GMT date string to an IXR_Date object.
	 *
	 * @access protected
	 *
	 * @param string $date_gmt Jabali GMT date string.
	...
	public function wp_newPost( $args ) {
		...
		/** This action is documented in reslib/class-wp-xmlrpc-server.php */
	...
	public function mw_newPost($args) {
		...
		// Let Jabali generate the post_name (slug) unless
	...
	public function mw_editPost( $args ) {
		...
		// Let Jabali manage slug if none was provided.
	 ...
	 *
	 * @link http://mycvs.org/archives/2004/06/30/file-upload-to-jabali-in-ecto/
	 *
	 * @since 1.5.0
	 *
	 * @global wpdb $wpdb Jabali database abstraction object.
	...
	public function pingback_ping( $args ) {
		...
		/** This filter is documented in reslib/class-http.php */
		$user_agent = apply_filters( 'http_headers_useragent', 'Jabali/' . get_bloginfo( 'version' ) . '; ' . get_bloginfo( 'url' ) );
