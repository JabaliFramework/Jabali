 ...
 *
 * These functions are meant to live inside of the Jabali loop.
 *
 * @package Jabali
 * @subpackage Template
 */
...
function get_trackback_url() {
	if ( '' != get_option('permalink_structure') )
		...
		$tb_url = get_option('siteurl') . '/trackback.php?p=' . get_the_ID();
 ...
 *
 * Uses the Jabali database object to query for the comments. The comments
 ...
 * default theme. If either does not exist, then the Jabali process will be
...
function comments_template( $file = '/comments.php', $separate_comments = false ) {
	...
	elseif ( file_exists( TEMPLATEPATH . $file ) )
		...
		require( ABSPATH . RES . '/theme-compat/comments.php');
}
 ...
 *           comment. See https://core.trac.jabali.github.io/changeset/36512.
 *
 * @since 2.7.0
 *
