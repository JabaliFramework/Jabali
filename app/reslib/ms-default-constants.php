 ...
 * reslib/ms-files.php (main/blogs.php in MU).
 *
 * @since 3.0.0
 *
...
function ms_upload_constants() {
	...
	if ( !defined( 'UPLOADBLOGSDIR' ) )
		define( 'UPLOADBLOGSDIR', 'main/blogs.dir' );

	// Note, the main site in a post-MU network uses main/uploads.
	...
	if ( ! defined( 'UPLOADS' ) ) {
		...
		if ( 'main/blogs.dir' == UPLOADBLOGSDIR && ! defined( 'BLOGUPLOADDIR' ) )
			define( 'BLOGUPLOADDIR', MAIN_DIR . "/blogs.dir/{$wpdb->blogid}/files/" );
	}
}
