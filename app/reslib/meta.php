 ...
 * Core Metadata API
 *
 * Functions for retrieving and manipulating metadata of various Jabali object types. Metadata
...
function metadata_exists( $meta_type, $object_id, $meta_key ) {
	...
	/** This filter is documented in reslib/meta.php */
...
function update_metadata_by_mid( $meta_type, $meta_id, $meta_value, $meta_key = false ) {
	...
	if ( $meta = get_metadata_by_mid( $meta_type, $meta_id ) ) {
		...
		/** This action is documented in reslib/meta.php */
		do_action( "update_{$meta_type}_meta", $meta_id, $object_id, $meta_key, $_meta_value );
 ...
 *
 * @since 3.3.0
 * @since 4.6.0 {@link https://core.trac.jabali.github.io/ticket/35658 Modified
