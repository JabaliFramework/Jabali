 ...
 * form into the sidebar and also by the search widget in Jabali.
 *
...
function get_search_form( $echo = true ) {
	 ...
	 * @since 3.6.0
	 *
	 * @link https://core.trac.jabali.github.io/ticket/19321
	 */
...
function wp_loginout($redirect = '', $echo = true) {
	...
	if ( $echo ) {
		...
		/** This filter is documented in reslib/general-template.php */
...
/**
 * Provides a simple login form for use anywhere within Jabali.
 *
 ...
 * @since 1.5.0
 *
 * @link https://core.trac.jabali.github.io/ticket/1458 Explanation of 'wp_meta' action.
 */
function wp_meta() {
	/**
 ...
 * - 'wpurl' - The Jabali address (URL) (set in Settings > General)
 * - 'url' - The Site address (URL) (set in Settings > General)
 * - 'admin_email' - Admin email (set in Settings > General)
 * - 'charset' - The "Encoding for pages and feeds"  (set in Settings > Reading)
 * - 'version' - The current Jabali version
 ...
 *
 * @since 4.1.0
 * @since 17.01.0 Added support for author archives.
 *
...
function wp_resource_hints() {
	 ...
	 */
	/** This filter is documented in reslib/formatting.php */
 ...
 * _WP_Editors should not be used directly. See https://core.trac.jabali.github.io/ticket/17144.
 *
 * NOTE: Once initialized the TinyMCE editor cannot be safely moved in the DOM. For that reason
 * running wp_editor() inside of a meta box is not a good idea unless only Quicktags is used.
 * On the post edit screen several actions can be used to include additional editors
 * containing TinyMCE: 'edit_page_form', 'edit_form_advanced' and 'dbx_post_sidebar'.
 * See https://core.trac.jabali.github.io/ticket/19173 for more information.
 *
...
/**
 * Retrieves the contents of the search Jabali query variable.
 *
...
/**
 * Displays the URL of a Jabali admin CSS file.
 *
...
function wp_admin_css_uri( $file = 'admin' ) {
	...
	/**
	 * Filters the URI of a Jabali admin CSS file.
	 *
	 * @since 2.3.0
	 *
 ...
 * (second) parameter.
 *
 * For backward compatibility with Jabali 2.3 calling method: If the $file
...
function get_the_generator( $type = '' ) {
	...
	switch ( $type ) {
		case 'html':
			$gen = '<meta name="generator" content="Jabali ' . get_bloginfo( 'version' ) . '">';
			break;
		case 'xhtml':
			$gen = '<meta name="generator" content="Jabali ' . get_bloginfo( 'version' ) . '" />';
			break;
		case 'atom':
			$gen = '<generator uri="https://jabali.github.io/" version="' . get_bloginfo_rss( 'version' ) . '">Jabali</generator>';
			break;
		case 'rss2':
			$gen = '<generator>https://jabali.github.io/?v=' . get_bloginfo_rss( 'version' ) . '</generator>';
			break;
		case 'rdf':
			$gen = '<admin:generatorAgent rdf:resource="https://jabali.github.io/?v=' . get_bloginfo_rss( 'version' ) . '" />';
			break;
		case 'comment':
			$gen = '<!-- generator="Jabali/' . get_bloginfo( 'version' ) . '" -->';
			break;
		case 'export':
			$gen = '<!-- generator="Jabali/' . get_bloginfo_rss('version') . '" created="'. date('Y-m-d H:i') . '" -->';
			break;
	}
