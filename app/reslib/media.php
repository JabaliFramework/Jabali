 ...
 * parameters are: what Jabali will use for the class, the Attachment ID,
...
function _wp_get_attachment_relative_path( $file ) {
	...
	if ( false !== strpos( $dirname, 'main/uploads' ) ) {
		// Get the directory name relative to the upload directory (back compat for pre-2.7 uploads)
		$dirname = substr( $dirname, strpos( $dirname, 'main/uploads' ) + 18 );
...
function wp_calculate_image_srcset( $size_array, $image_src, $image_meta, $attachment_id = 0 ) {
	...
	/*
	 * Jabali flattens animated GIFs into one frame when generating intermediate sizes.
	...
	/*
	 * Images that have been edited in Jabali after being uploaded will
...
function gallery_shortcode( $attr ) {
	...
	if ( apply_filters( 'use_default_gallery_style', ! $html5 ) ) {
		...
		<style type='text/css'>
			...
			/* see gallery_shortcode() in reslib/media.php */
		</style>\n\t\t";
	}
 ...
 * a collection of Jabali audio or video files in a post.
 *
 * @since 3.9.0
 *
 * @global int $content_width
 ...
 *
 * @since 2.5.0
 * @since 17.01.0 Introduced the `$output` parameter.
 *
...
function _wp_image_editor_choose( $args = array() ) {
	require_once ABSPATH . RES . '/class-wp-image-editor.php';
	require_once ABSPATH . RES . '/class-wp-image-editor-gd.php';
	require_once ABSPATH . RES . '/class-wp-image-editor-imagick.php';
	/**
...
function wp_prepare_attachment_for_js( $attachment ) {
	...
	if ( $meta && ( 'image' === $type || ! empty( $meta['sizes'] ) ) ) {
		...
		foreach ( $possible_sizes as $size => $label ) {
			...
			/** This filter is documented in reslib/media.php */
...
function wp_enqueue_media( $args = array() ) {
	...
	require_once ABSPATH . RES . '/media-template.php';
