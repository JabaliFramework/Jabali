...
final class WP_Theme implements ArrayAccess {
	...
	private static $default_themes = array(
		'classic'         => 'Jabali Classic',
		'default'         => 'Jabali Default',
	...
	/**
	 * Absolute path to the theme root, usually main/themes
	 *
	 * @access private
	 * @var string
	 */
	...
	/**
	 * URL to the theme root, usually an absolute URL to main/themes
	 *
	 * @access private
	 * var string
	 */
	...
	public function __construct( $theme_dir, $theme_root, $_child = null ) {
		...
		if ( is_array( $cache ) ) {
			...
			// Properly identify default themes that are inside a directory within main/themes.
		...
		if ( ! is_array( $cache ) && $this->template != $this->stylesheet && ! file_exists( $this->theme_root . '/' . $this->template . '/index.php' ) ) {
			...
			// main/themes/directory-of-themes/*
	 ...
	 * get_template() takes into account where Jabali actually located the theme and
	 ...
	 *
	 * This is typically the absolute path to main/themes.
	 *
	 * @since 3.4.0
	 * @access public
	 *
	 ...
	 *
	 * This is typically the absolute URL to main/themes. This forms the basis
	...
	/**
	 * Determines the latest Jabali default theme that is installed.
	 *
	...
	public static function get_allowed_on_site( $blog_id = null ) {
		...
		/** This filter is documented in reslib/class-wp-theme.php */
		return (array) apply_filters( 'site_allowed_themes', $allowed_themes[ $blog_id ], $blog_id );
	}
