...
/**
 * Authenticate the user using the Jabali auth cookie.
 *
 * @since 2.8.0
 *
 * @global string $auth_secure_cookie
 ...
 * it will prepend the Jabali table prefix to the option name.
 *
 ...
 *
 * @since 3.0.0
 * @since 17.01.0 Converted to use get_sites().
 *
 * @global wpdb $wpdb Jabali database abstraction object.
 *
 * @param int  $user_id User ID
 ...
 *
 * @since 3.0.0
 * @link https://codex.jabali.github.io/Function_Reference/add_user_meta
 *
 * @param int    $user_id    User ID.
 ...
 *
 * @since 3.0.0
 * @link https://codex.jabali.github.io/Function_Reference/delete_user_meta
 *
 * @param int    $user_id    User ID
 * @param string $meta_key   Metadata name.
 ...
 *
 * @since 3.0.0
 * @link https://codex.jabali.github.io/Function_Reference/get_user_meta
 *
 * @param int    $user_id User ID.
 ...
 *
 * @since 3.0.0
 * @link https://codex.jabali.github.io/Function_Reference/update_user_meta
 *
 * @param int    $user_id    User ID.
 ...
 * @since 17.01.0 Added the `$role`, `$role__in`, and `$role__not_in` parameters.
 *
 ...
 * @since 17.01.0 The user's locale can be passed to `$userdata`.
 *
 * @global wpdb $wpdb Jabali database abstraction object.
 *
