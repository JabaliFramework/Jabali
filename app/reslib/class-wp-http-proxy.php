 ...
 *
 * There are caveats to proxy support. It requires that defines be made in the db.php file to
 ...
 * through the proxy. The list should be presented in a comma separated list, wildcards using * are supported, eg. *.jabali.github.io</li>
 * </ol>
 *
 ...
 *     define('WP_PROXY_BYPASS_HOSTS', 'localhost, www.example.com, *.jabali.github.io');
 *
 * @link https://core.trac.jabali.github.io/ticket/4011 Proxy support ticket in Jabali.
 * @link https://core.trac.jabali.github.io/ticket/14636 Allow wildcard domains in WP_PROXY_BYPASS_HOSTS
 *
 * @since 2.8.0
 */
class WP_HTTP_Proxy {
