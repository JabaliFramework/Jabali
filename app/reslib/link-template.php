<?php
/**
 * Jabali Link Template Functions
 *
 * @package Jabali
 * @subpackage Template
 */
 ...
 *
 * This can be used in the Jabali Loop or outside of it.
 *
 * @since 2.0.0
 *
 * @global WP_Rewrite $wp_rewrite
...
function get_search_comments_feed_link($search_query = '', $feed = '') {
	...
	/** This filter is documented in reslib/link-template.php */
 ...
 *
 * Can be used within the Jabali loop or outside of it. Can be used with
 ...
 *
 * Can be used within the Jabali loop or outside of it, with any post type.
 *
 * @since 2.9.0
 *
 * @param int    $id           Optional. Post ID. Default is the ID of the global `$post`.
 ...
 * @since 4.1.0
 *
 * @global WP_Query $wp_query Jabali Query object.
 *
 * @param array $args {
...
function get_shortcut_link() {
	...
	include_once( ABSPATH . 'admin/includes/class-wp-press-this.php' );
...
/**
 * Retrieves the URL for the current site where Jabali application files
...
/**
 * Retrieves the URL for a given site where Jabali application files
 * (e.g. blog-header.php or the admin/ folder) are accessible.
 *
 * Returns the 'site_url' option with the appropriate protocol, 'https' if
