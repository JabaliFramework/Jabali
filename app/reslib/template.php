 ...
 *
 * @since 1.5.0
 * @since 17.01.0 The decoded form of `category-{slug}.php` was added to the top of the
 ...
 *
 * @since 2.3.0
 * @since 17.01.0 The decoded form of `tag-{slug}.php` was added to the top of the
 ...
 *
 * @since 2.5.0
 * @since 17.01.0 The decoded form of `taxonomy-{taxonomy_slug}-{term_slug}.php` was added to the top of the
 ...
 *
 * @since 1.5.0
 * @since 17.01.0 The decoded form of `page-{page_name}.php` was added to the top of the
 ...
 * @since 17.01.0 The decoded form of `single-{post_type}-{post_name}.php` was added to the top of the
 *              template hierarchy when the post name contains multibyte characters.
 * @since 17.01.0 {Post Type Template}.php was added to the top of the template hierarchy.
 *
 * @see get_query_template()
 *
 ...
 *
 * Searches in the STYLESHEETPATH before TEMPLATEPATH and reslib/theme-compat
...
function locate_template($template_names, $load = false, $require_once = true ) {
	...
	foreach ( (array) $template_names as $template_name ) {
		...
		if ( file_exists(STYLESHEETPATH . '/' . $template_name)) {
			...
			break;
		} elseif ( file_exists( ABSPATH . RES . '/theme-compat/' . $template_name ) ) {
			$located = ABSPATH . RES . '/theme-compat/' . $template_name;
			break;
		}
	}
...
/**
 * Require the template file with Jabali environment.
 *
 * The globals are set up for the template file to ensure that the Jabali
