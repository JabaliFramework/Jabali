...
if (!class_exists('SZGoogleAdminCalendar'))
{
	class SZGoogleAdminCalendar extends SZGoogleAdmin
	{
		...
		function callback_calendar_o_mode()
		{
			...
			$this->moduleCommonFormDescription(__('with this option, you can choose the type of view of the calendar that will be inserted into your jabali site. You can choose between agenda, monthly and weekly. This value is used when it is not otherwise specified by the shortcode or widget.','sz-google'));
		}
		...
		function callback_calendar_o_weekstart()
		{
			...
			$this->moduleCommonFormDescription(__('this value represents the starting day of the week used by default in the calendar view that will be inserted into the page jabali. Choose from sunday, monday and saturday.','sz-google'));
		}
		...
		function callback_calendar_o_timezone()
		{
			...
			$this->moduleCommonFormDescription(__('this field specifies the time zone to be used by default by the calendar that will be inserted into the page jabali. If you do not specify any value, google will automatically calculate the time zone based on its configuration.','sz-google'));
		}
