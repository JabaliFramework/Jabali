...
if (!class_exists('SZGoogleAdmin'))
{
	class SZGoogleAdmin
	{
		 ...
		 * to be applied to the various function calls jabali
		 */

		protected $titlefix        = 'Google for Jabali - ';
		...
		function __construct()
		{
			...
			// Definition actions for creating the jabali admin menu 
		...
		function moduleCommonForm($title,$group,$sections,$formsavebutton,$HTML)
		{
			...
			// links, such as the community of Italian jabali for ever :)
			...
			echo '<div class="inside">';
			echo '<ul>';
			echo '<li><a target="_blank" href="http://jabali.github.io/support/view/plugin-reviews/sz-google">'.ucfirst(__('rate the plugin','sz-google')).'</a></li>';
			...
			echo '<div class="inside">';
			echo '<ul>';
			echo '<li><a target="_blank" href="http://jabali.github.io/support/plugin/sz-google">'.ucfirst(__('support for bugs and reports','sz-google')).'</a></li>';
			...
			echo '<li><a target="_blank" href="https://otherplus.com/tech/jabali-google/">'.ucfirst(__('news:','sz-google'))."&nbsp;".ucfirst(__('official website','sz-google')).'</a></li>';
			echo '<li><a target="_blank" href="https://plus.google.com/communities/109254048492234113886">'.ucfirst(__('news:','sz-google'))."&nbsp;".ucfirst(__('community Jabali','sz-google')).'</a></li>';
