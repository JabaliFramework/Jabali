...
if (!class_exists('SZGoogleAdminDrive'))
{
	class SZGoogleAdminDrive extends SZGoogleAdmin
	{
		...
		function callback_drive_sitename() 
		{
			...
			$this->moduleCommonFormDescription(__('some functions google drive require the information of the name of the site where the operation took place, you can use this field to customize the name, otherwise it will use the default value in jabali. See general setting in jabali admin panel.','sz-google'));
		}
