...
if (!class_exists('SZGoogleAdminGroups'))
{
	class SZGoogleAdminGroups extends SZGoogleAdmin
	{
		...
		function callback_groups_language() 
		{
			...
			$this->moduleCommonFormDescription(__('specify the language associated with your website, if you do not specify any value will be called the get_bloginfo(\'language\') and set the same language related to the theme of jabali. Supported languages ​​http://translate.google.com/about/.','sz-google'));
		}
