...
if (!class_exists('SZGoogleAdminRecaptcha'))
{
	class SZGoogleAdminRecaptcha extends SZGoogleAdmin
	{
		...
		{ 
			...
			$this->moduleCommonFormDescription(__('enable this option to manage the files of an emergency. With this option enabled you can disable the authenticator will be sending in FTP a file in the root directory of jabali. The file name is specified in the next field.','sz-google'));
		}
		...
		{ 
			...
			$this->moduleCommonFormDescription(__('indicates the name of the file to be used for the emergency function. If the file specified in this field is found on the root of the jabali function authenticator is temporarily suspended. Default name is <b>google-recaptcha-disable.php<b/>.','sz-google'));
		}
		...
		{ 
			...
			$this->moduleCommonFormDescription(__('the standard login jabali is too small to hold the widget reCAPTCHA google, if you activate this option the plugin will increase the size of the standard login to create a better visual result. Minimum size is 350 pixel.','sz-google'));
		}
