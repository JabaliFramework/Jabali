...
if (!class_exists('SZGoogleAdminPlus'))
{
	class SZGoogleAdminPlus extends SZGoogleAdmin
	{
		...
		function __construct()
		{
			...
			// containing the default fields of jabali on profile
		 ...
		 * in the general form of configuration and saved on a database of jabali (options)		
		 */
		...
		function callback_plus_language()
		{
			...
			$this->moduleCommonFormDescription(__('specify the language code associated with your website, if you do not specify any value will be called the get_bloginfo(\'language\') and set the same language related to the theme of jabali.','sz-google'));
		}
		...
		function callback_plus_post_shortcode()
		{
			...
			$this->moduleCommonFormDescription(__('enabling this option will allow you to use the shortcode [sz-gplus-post] that will allow you to insert a box for embedded post to google plus in any part of your post or page standard jabali.','sz-google'));
		}
		...
		function callback_plus_system_javascript()
		{
			...
			$this->moduleCommonFormDescription(__('if you use some plugin that performs functions similar to sz-google for jabali is possible that we might create a conflict retrieving files javascript google, enabling this option will be disabled loadings code javascript from our plugin.','sz-google'));
		}
		...
		function callback_plus_widget_button_sharing()
		{
			...
			$this->moduleCommonFormDescription(__('this option allows the activation of widget for sharing a link on social network google+. Using this function you can insert the button in an article or a page jabali. If you want to customize the position in the theme use the function PHP.','sz-google'));
		}
		...
		function callback_plus_widget_button_follow()
		{
			...
			$this->moduleCommonFormDescription(__('this option allows the activation of widget for follow on social network google+. Using this function you can insert the button in an article or a page jabali. If you want to customize the position in the theme use the function PHP.','sz-google'));
		}
		...
		function callback_plus_button_sharing()
		{
			...
			$this->moduleCommonFormDescription(__('this option allows the activation of shortcode for sharing a link on social network google+. Using this function you can insert the button in an article or a page jabali. If you want to customize the position in the theme use the function PHP.','sz-google'));
		}

		function callback_plus_button_follow()
		{
			$this->moduleCommonFormCheckboxYesNo('sz_google_options_plus','plus_button_enable_follow');
			$this->moduleCommonFormDescription(__('this option allows the activation of shortcode for follow on social network google+. Using this function you can insert the button in an article or a page jabali. If you want to customize the position in the theme use the function PHP.','sz-google'));
		}
		...
		function callback_plus_comments_gp()
		{
			...
			$this->moduleCommonFormDescription(__('if you enable this feature will be added to the new commenting system made ​​available on the social network google+. The widget will be placed in the standard location for comments to jabali. For customizations use the function PHP.','sz-google'));
		}
		...
		function callback_plus_comments_ac()
		{
			...
			$this->moduleCommonFormDescription(__('enabling this option, the comment system is generated immediately after the post content or web page, otherwise it is inserted at the point that the standard function is called of the comments of jabali in the file of the active theme.','sz-google'));
		}

		function callback_plus_comments_aw()
		{
			$this->moduleCommonFormCheckboxYesNo('sz_google_options_plus','plus_comments_aw_enable');
			$this->moduleCommonFormDescription(__('enabling this option, the comment system is generated immediately after standard comments, otherwise it is inserted at the point that the standard function is called of the comments of jabali in the file of the active theme.','sz-google'));
		}
		...
		function callback_plus_comments_sh()
		{
			...
			$this->moduleCommonFormDescription(__('enabling this option will allow you to use the shortcode [sz-gplus-comments] that will allow you to insert a box for comments to google plus in any part of your post or page standard jabali. For greater customization uses function PHP.','sz-google'));
		}
		...
		function callback_plus_comments_fixed_size()
		{
			...
			$this->moduleCommonFormDescription(__('if you do not specify a value for this option, the size of the container of the comments will be performed in responsive mode, otherwise it is applied to a fixed size specified in this field. Use this option on jabali themes with fixed size.','sz-google'));
		}
		...
		function callback_plus_comments_css_class_1()
		{
			...
			$this->moduleCommonFormDescription(__('the widget comments has two wraps, each of these we can define the CSS style class that allow us to adapt the graphics of the comments to that of jabali theme installed. Leave blank to not add any classes to the container of the comments.','sz-google'));
		}
		...
		function callback_plus_usercontact_page()
		{
			...
			$this->moduleCommonFormDescription(__('in the standard user profile jabali is already a field that identifies the URL of your Google+ profile. By enabling this option you can add additional information that relates to Google+ and use it in your badges author present in your current theme.','sz-google'));
		}
