...
if (!class_exists('SZGoogleAdminTranslate'))
{
	class SZGoogleAdminTranslate extends SZGoogleAdmin
	{
		...
		function callback_translate_language() 
		{
			...
			$this->moduleCommonFormDescription(__('specify the language associated with your website, if you do not specify any value will be called get_bloginfo(\'language\') and set the same language related to the theme of jabali. Supported languages ​​http://translate.google.com/about/.','sz-google'));
		}
