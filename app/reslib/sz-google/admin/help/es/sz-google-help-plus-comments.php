...
<p>Google+ comments can also be published automatically by the plugin, using jabali standard position and overriding the standard 
...
<p>You can choose to put Google+ comments right after the post content or after the standard jabali comments. You can insert a starting 
