...
shortcode, in this way you can create multiple buttons into the same page pointing to different links.</p>

<p>Para insertar este componente debe utilizar el código corto <b>[sz-gplus-share]</b>, si desea utilizarlo en una barra lateral,
...
exigentes hay otra posibilidad, tiene que utilizar una función llamada PHP <b>szgoogle_gplus_get_button_share(\$options)</b>.</p>
