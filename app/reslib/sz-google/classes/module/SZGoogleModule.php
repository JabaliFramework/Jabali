	...
	class SZGoogleModule
	{
		...
		function getOptionsSet($nameset)
		{
			...
			foreach($optionsList as $key => $item) 
			{
				...
				// jabali otherwise add the field original file array
		...
		/**
		 * Function to add javascript code in the footer of jabali
		...
		function setJavascriptPlusOne()
		{
			...
			if ($object = self::getObject('SZGoogleModulePlus')) 
			{
				...
				// framework, if you see "99" I take the language code of jabali
