...
echo <<<ENDOFJS
				...
				jQuery('#sz_google_authenticator_generate').bind('click', function() {
					...
					jQuery.post(ajaxurl,data,function(response) {
						...
						var qrcode="otpauth://totp/Jabali:"+escape(jQuery('#sz_google_authenticator_description').val())+"?secret="+jQuery('#sz_google_authenticator_secret').val()+"&issuer=Jabali";
...
ENDOFJS;
		 ...
		 * in jabali database for the user record modified
		 */
		 ...
		 * using 16 characters and the native function of jabali
		 */
