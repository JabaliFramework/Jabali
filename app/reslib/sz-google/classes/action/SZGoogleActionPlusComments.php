...
if (!class_exists('SZGoogleActionPlusComments'))
{
	class SZGoogleActionPlusComments extends SZGoogleAction
	{
		 ...
		 * dagli hook presenti in add_action e add_filter di jabali.
		 */
		function addAction() 
		{ 
			...
			if ($options['plus_comments_ac_enable'] == '1') 
			{
				...
				// Se i commenti di jabali standard non sono attivati e quindi non
				...
				// definito nel tema di jabali, sempre che questo seguo lo standard
		 ...
		 * in fondo al post standard di jabali, sono ammesse diverse
		...
		function addPlusCommentsSystemTemplate($include) 
		{
			...
			// Controllo se devo mantenere i commenti standard di jabali		 
