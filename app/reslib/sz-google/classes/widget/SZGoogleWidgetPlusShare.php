...
if (!class_exists('SZGoogleWidgetPlusShare'))
{
	class SZGoogleWidgetPlusShare extends SZGoogleWidget
	{
		/**
		...
		{
			parent::__construct('SZ-GOOGLE-PLUS-SHARING',__('SZ-Google - G+ Share','sz-google'),array(
				'classname'   => 'sz-widget-google sz-widget-google-plus sz-widget-google-plus-share', 
				'description' => ucfirst(__('google+ share.','sz-google'))
			));
		}
