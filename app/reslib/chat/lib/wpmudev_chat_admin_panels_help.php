...
function wpmudev_chat_get_help_item( $key, $type = 'full', $form_section = "page" ) {
	...
	$wpmudev_chat_help_items['log_display_role_level'] = array(
		'full' => __( "Select the lowest level user roles allowed to see the chat log archives. Setting to 'public' will display logs to all users.<br /><br />Compares Jabali User Role Levels (level_10, level_7, level_0, etc.)", $wpmudev_chat->translation_domain ),
	);
...
//	);
	...
	*/
	...
	$wpmudev_chat_help_items['tinymce_roles'] = array(
		'full' => __( 'Controls which Jabali user roles will see the Chat WYSIWYG toolbar button.', $wpmudev_chat->translation_domain ),
	);
	...
	$wpmudev_chat_help_items['blocked_admin_urls'] = array(
		'full' => __( 'Allows blocking Chat from loading on certain Jabali Admin pages.', $wpmudev_chat->translation_domain ),
	);
	...
	$wpmudev_chat_help_items['chat_wp_admin']     = array(
		'full' => __( 'This will disable all Chat functions including Jabali toolbar menu', $wpmudev_chat->translation_domain ),
	);
