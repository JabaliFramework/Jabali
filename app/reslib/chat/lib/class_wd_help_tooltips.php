...
.wpmudev-left_pointer {
	...
	height: 30px;
	margin-top: 8px;
	background: url(<?php echo site_url("/reslib/images/arrow-pointer-blue.png");?>) 0 -15px no-repeat;
}
.wpmudev-right_pointer {
	...
	height: 30px;
	margin-top: 8px;
	background: url(<?php echo site_url("/reslib/images/arrow-pointer-blue.png");?>) -16px -15px no-repeat;
}
</style>
		<?php
	}
