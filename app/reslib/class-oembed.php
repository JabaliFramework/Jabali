...
class WP_oEmbed {
	...
	public function __construct() {
		...
		$providers = array(
			...
			'#https?://jabali\.tv/.*#i'                             => array( 'https://jabali.tv/oembed/',                              true  ),
			...
			'#https?://videopress\.com/v/.*#'                          => array( 'https://public-api.jabali.com/oembed/1.0/?for=' . $host, true  ),
		 ...
		 *
		 * Since Jabali 4.4, oEmbed discovery is enabled for all users and allows embedding of sanitized
	...
	private function _fetch_with_format( $provider_url_with_args, $format ) {
		...
		/** This filter is documented in reslib/class-oembed.php */
