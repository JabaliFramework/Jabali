 ...
 *
 * Standardizes the HTTP requests for Jabali. Handles cookies, gzip encoding and decoding, chunk
 ...
 *
 * @since 4.4.0
 * @since 17.01.0 The $component parameter was added for parity with PHP's parse_url().
 *
