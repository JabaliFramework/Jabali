...
function _wp_admin_bar_init() {
	...
	require_once( ABSPATH . RES . '/class-wp-admin-bar.php' );
...
function wp_admin_bar_wp_menu( $wp_admin_bar ) {
	...
	$wp_logo_menu_args = array(
		'id'    => 'wp-logo',
		'title' => '<span class="ab-icon"></span><span class="screen-reader-text">' . __( 'About Jabali' ) . '</span>',
		'href'  => $about_url,
	);
	...
	if ( $about_url ) {
		// Add "About Jabali" link
		$wp_admin_bar->add_menu( array(
			'parent' => 'wp-logo',
			'id'     => 'about',
			'title'  => __('About Jabali'),
			'href'   => $about_url,
		) );
	}
	...
	$wp_admin_bar->add_menu( array(
		...
		'id'        => 'wporg',
		'title'     => __('Jabali.org'),
		'href'      => __('https://jabali.github.io/'),
	) );
	...
	$wp_admin_bar->add_menu( array(
		...
		'href'      => __('https://jabali.github.io/support/'),
	) );
	...
	$wp_admin_bar->add_menu( array(
		...
		'id'        => 'feedback',
		'title'     => __('Feedback'),
		'href'      => __('https://jabali.github.io/support/forum/requests-and-feedback'),
	) );
}
