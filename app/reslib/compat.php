<?php
/**
 * Jabali implementation for PHP functions either missing from older PHP versions or not included by default.
 *
 * @package PHP
 * @access private
 */
...
if ( !function_exists('json_encode') ) {
	function json_encode( $string ) {
		...
		if ( ! ( $wp_json instanceof Services_JSON ) ) {
			require_once( ABSPATH . RES . '/class-json.php' );
...
if ( ! function_exists( 'json_last_error_msg' ) ) :
	...
	function json_last_error_msg() {
		// See https://core.trac.jabali.github.io/ticket/27799.
...
if ( ! function_exists( 'random_int' ) ) {
	require ABSPATH . RES . '/random_compat/random.php';
}
...
if ( ! function_exists( 'array_replace_recursive' ) ) :
	 ...
	 *
	 * The array_replace_recursive() function is a PHP 5.3 function. Jabali
	 ...
	 *
	 * Subject to removal once Jabali makes PHP 5.3.0 the minimum requirement.
	 *
	 * @since 4.5.3
	 *
