...
/**
 * Jabali Image Editor Class for Image Manipulation through Imagick PHP Module
 *
 * @since 3.5.0
 * @package Jabali
 * @subpackage Image_Editor
...
class WP_Image_Editor_Imagick extends WP_Image_Editor {
	 ...
	 *
	 * This is a Jabali specific implementation of Imagick::thumbnailImage(),
	...
	protected function _save( $image, $filename = null, $mime_type = null ) {
		...
		/** This filter is documented in reslib/class-wp-image-editor-gd.php */
		return array(
			'path'      => $filename,
