 ...
 *
 * The Jabali Rewrite class writes the rewrite module rules to the .htaccess
 * file. It also handles parsing the request to get the correct setup for the
 * Jabali Query class.
 *
 * The Rewrite along with WP class function as a front controller for Jabali.
...
class WP_Rewrite {
	...
	/**
	 * Rules that don't redirect to Jabali' index.php.
	 *
	...
	/**
	 * Whether to write every mod_rewrite rule for Jabali into the .htaccess file.
	 *
	 ...
	 * set to true. Prior to Jabali 3.3 this flag indicated that every page
	...
	<system.webServer>
		...
		$rules .= '
			<rule name="Jabali: ' . esc_attr( home_url() ) . '" patternSyntax="Wildcard">
				<match url="*" />
					<conditions>
