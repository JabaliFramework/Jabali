<?php
/**
 * Deprecated functions from past Jabali versions. You shouldn't use these
...
function start_wp() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new Jabali Loop') );
 ...
 * support. This is not the fault of Jabali (where functionality is
...
function rich_edit_exists() {
	...
	if ( ! isset( $wp_rich_edit_exists ) )
		$wp_rich_edit_exists = file_exists( ABSPATH . RES . '/js/tinymce/tinymce.js' );
 ...
 *
 * Determines if the URL can be accessed over SSL by using the Jabali HTTP API to access
...
function wp_richedit_pre($text) {
	...
	/** This filter is documented in reslib/deprecated.php */
