...
function get_post_embed_html( $width, $height, $post = null ) {
	...
	$output .= "<!--//--><![CDATA[//><!--\n";
	if ( SCRIPT_DEBUG ) {
		$output .= file_get_contents( ABSPATH . RES . '/js/wp-embed.js' );
	} else {
		/*
...
function print_embed_styles() {
	...
	<?php
		if ( SCRIPT_DEBUG ) {
			readfile( ABSPATH . RES . "/css/wp-embed-template.css" );
		} else {
			/*
			 * If you're looking at a src version of this file, you'll see an "include"
			 * statement below. This is used by the `grunt build` process to directly
...
function print_embed_scripts() {
	...
	<?php
		if ( SCRIPT_DEBUG ) {
			readfile( ABSPATH . RES . "/js/wp-embed-template.js" );
		} else {
			/*
			 * If you're looking at a src version of this file, you'll see an "include"
			 * statement below. This is used by the `grunt build` process to directly
		...
		<div class="wp-embed-share-dialog-content">
			<div class="wp-embed-share-dialog-text">
				<ul class="wp-embed-share-tabs" role="tablist">
					<li class="wp-embed-share-tab-button wp-embed-share-tab-button-jabali" role="presentation">
						<button type="button" role="tab" aria-controls="wp-embed-share-tab-jabali" aria-selected="true" tabindex="0"><?php esc_html_e( 'Jabali Embed' ); ?></button>
					</li>
				...
				<div id="wp-embed-share-tab-jabali" class="wp-embed-share-tab" role="tabpanel" aria-hidden="false">
					<input type="text" value="<?php the_permalink(); ?>" class="wp-embed-share-input" aria-describedby="wp-embed-share-description-jabali" tabindex="0" readonly/>

					<p class="wp-embed-share-description" id="wp-embed-share-description-jabali">
						<?php _e( 'Copy and paste this URL into your Jabali site to embed' ); ?>
					</p>
				</div>
...
function wp_filter_pre_oembed_result( $result, $url, $args ) {
	...
	/** This filter is documented in reslib/class-wp-oembed-controller.php */
