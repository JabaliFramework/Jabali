 ...
 * @since 2.8.0
 *
 * @global WP_Rewrite $wp_rewrite The Jabali rewrite class.
 */
 ...
 * @since 4.5.0
 *
 * @global WP    $wp            Current Jabali environment instance.
 ...
 * @param string     $filter   Optional, default is raw or no Jabali defined filter will applied.
 ...
 * @since 17.01.0 Refactored to use WP_Term_Query, and to support any WP_Term_Query arguments.
 *
 * @global wpdb $wpdb Jabali database abstraction object.
 *
...
function wp_insert_term( $term, $taxonomy, $args = array() ) {
	...
	if ( empty($slug) ) {
		...
		/** This action is documented in reslib/taxonomy.php */
 ...
 * @since 2.3.0
 *
 * @global wpdb $wpdb The Jabali database abstraction object.
 *
...
function wp_set_object_terms( $object_id, $terms, $taxonomy, $append = false ) {
	...
	foreach ( (array) $terms as $term) {
		 ...
		 *
		 * @since 2.9.0
		 * @since 17.01.0 Added the `$taxonomy` parameter.
		 *
...
function wp_update_term( $term_id, $taxonomy, $args = array() ) {
	...
	/** This filter is documented in reslib/taxonomy.php */
	$term_id = apply_filters( 'term_id_filter', $term_id, $tt_id );
 ...
 *
 * @since 2.3.0
 * @since 17.01.0 Returns a WP_Error object if get_term() returns an error for
