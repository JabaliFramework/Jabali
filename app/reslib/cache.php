 ...
 * Closes the cache.
 *
 * This function has ceased to do anything since Jabali 2.5. The
 * functionality was removed along with the rest of the persistent cache.
 *
 * This does not mean that plugins can't implement this function when they need
 * to make sure that the cache is cleaned up after Jabali no longer needs it.
 *
 * @since 2.0.0
 *
 ...
 *
 * The Jabali Object Cache is used to save on trips to the database. The
 * Object Cache stores all of the cache data to memory and makes the cache
 * contents available by using a key, which is used to name and later retrieve
 * the cache contents.
 *
 * The Object Cache can be replaced by other caching mechanisms by placing files
 * in the main folder which is looked at in wp-settings. If that file
...
class WP_Object_Cache {
	 ...
	 * naming guidelines outside of core Jabali usage.
	 *
