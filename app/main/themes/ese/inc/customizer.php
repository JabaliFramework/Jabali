...
function ese_customize_register( $wp_customize ) {
	...
	class Ese_Custom_Radio_Image_Control extends WP_Customize_Control {
		/**
...
function ese_customize_preview_js() {
	wp_enqueue_script( 'ese_customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
 ...
 * @copyright Copyright (c) 2015, Jabali Theme Review Team
 ...
 * 
 * @see wp_strip_all_tags() https://developer.jabali.github.io/reference/functions/wp_strip_all_tags/
 *
 ...
 * 
 * @see absint() https://developer.jabali.github.io/reference/functions/absint/
 * @see get_post_status() https://developer.jabali.github.io/reference/functions/get_post_status/
 *
 ...
 * 
 * @see sanitize_hex_color() https://developer.jabali.github.io/reference/functions/sanitize_hex_color/
 * @link sanitize_hex_color_no_hash() https://developer.jabali.github.io/reference/functions/sanitize_hex_color_no_hash/
 *
 ...
 * 'sanitize_callback'. It is wrapped in a callback here merely for example purposes.
 * 
 * @see wp_filter_post_kses() https://developer.jabali.github.io/reference/functions/wp_filter_post_kses/
 *
 ...
 * 
 * @see wp_check_filetype() https://developer.jabali.github.io/reference/functions/wp_check_filetype/
 *
 ...
 * 'sanitize_callback'. It is wrapped in a callback here merely for example purposes.
 * 
 * @see wp_filter_nohtml_kses() https://developer.jabali.github.io/reference/functions/wp_filter_nohtml_kses/
 *
 ...
 * 
 * @see sanitize_key()               https://developer.jabali.github.io/reference/functions/sanitize_key/
 * @see $wp_customize->get_control() https://developer.jabali.github.io/reference/classes/wp_customize_manager/get_control/
 *
 ...
 * It is wrapped in a callback here merely for example purposes.
 * 
 * @see esc_url_raw() https://developer.jabali.github.io/reference/functions/esc_url_raw/
 *
