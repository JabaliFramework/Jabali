...
if ( version_compare( $GLOBALS['wp_version'], '4.1', '<' ) ) :
	 ...
	 */
	function ese_wp_title( $title, $sep ) {
		if ( is_feed() ) {
			return $title;
		}
	...
	add_filter( 'wp_title', 'ese_wp_title', 10, 2 );

	/**
	 * Title shim for sites older than Jabali 4.1.
	 *
	 * @link https://make.jabali.github.io/core/2014/10/29/title-tags-in-4-1/
	 * @todo Remove this function when Jabali 4.3 is released.
	 */
	...
	add_action( 'wp_head', 'ese_render_title' );
endif;
