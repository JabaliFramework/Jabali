...
function wpcf7_captcha_form_tag_handler( $tag ) {
	...
	if ( 'captchac' == $tag->type && ! class_exists( 'ReallySimpleCaptcha' ) ) {
		return '<em>' . __( 'To use CAPTCHA, you need <a href="http://jabali.github.io/extend/plugins/really-simple-captcha/">Really Simple CAPTCHA</a> plugin installed.', 'contact-form-7' ) . '</em>';
	}
...
<fieldset>
<legend><?php echo sprintf( esc_html( __( "To use CAPTCHA, you first need to install and activate %s plugin.", 'contact-form-7' ) ), wpcf7_link( 'http://jabali.github.io/extend/plugins/really-simple-captcha/', 'Really Simple CAPTCHA' ) ); ?></legend>
</fieldset>
</div>
<?php
