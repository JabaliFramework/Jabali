...
function wpcf7_admin_menu() {
	...
	add_menu_page( __( 'Contact Form 7', 'contact-form-7' ),
		...
		'wpcf7_admin_management_page', 'dashicons-email-alt',
		$_wp_last_object_menu );
...
<p><?php echo sprintf( __( '<strong>Contact Form 7 %1$s requires Jabali %2$s or higher.</strong> Please <a href="%3$s">update Jabali</a> first.', 'contact-form-7' ), WPCF7_VERSION, WPCF7_REQUIRED_WP_VERSION, admin_url( 'update-core.php' ) ); ?></p>
</div>
<?php
}
