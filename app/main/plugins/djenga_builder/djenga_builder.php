...
Plugin URI: http://mtaandao.co.ke/plugins/djenga
Description: Drag and drop page builder for Jabali.
Version: 17.01.0
Author: Mtaandao
...
class Vc_Manager {
	...
	private function __construct() {
		...
		require_once $this->path( 'CORE_DIR', 'class-vc-sort.php' ); // used by dj-map
		require_once $this->path( 'CORE_DIR', 'class-dj-map.php' );
