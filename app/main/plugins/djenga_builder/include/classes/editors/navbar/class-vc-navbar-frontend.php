...
class Vc_Navbar_Frontend extends Vc_Navbar {
	 ...
	 * @var string
	 */
	protected $brand_url = 'http://mtaandao.co.ke/plugins/djenga/?utm_campaign=VCplugin&utm_source=vc_user&utm_medium=frontend_editor';
	...
	public function getControlSaveUpdate() {
		...
		<li class="vc_show-mobile vc_pull-right">
			<button data-url="<?php esc_attr_e( get_edit_post_link( $post->ID ) . '&dj_vc_js_status=true' ) ?>"
	...
	public function getControlViewPost() {
		return '<li class="vc_pull-right">'
		       ...
		       . ' title="' . esc_attr__( 'Exit Djenga Builder edit mode', 'js_composer' ) . '"><i class="vc-composer-icon vc-c-icon-close"></i></a>'
		       . '</li>';
	}
}
