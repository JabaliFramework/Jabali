...
class Vc_Navbar implements Vc_Render {
	 ...
	 * @var string
	 */
	protected $brand_url = 'http://mtaandao.co.ke/plugins/djenga/?utm_campaign=VCplugin&utm_source=vc_user&utm_medium=backend_editor';
	/**
	 * @var string
	 */
	...
	public function getLogo() {
		$output = '<a id="vc_logo" class="vc_navbar-brand" title="' . __( 'Djenga Builder', 'js_composer' )
		          . '" href="' . esc_attr( $this->brand_url ) . '" target="_blank">'
		          . __( 'Djenga Builder', 'js_composer' ) . '</a>';
	...
	public function getControlFrontend() {
		...
		return '<li class="vc_pull-right">'
		       . '<a href="' . vc_frontend_editor()->getInlineUrl() . '" class="vc_btn vc_btn-primary vc_btn-sm vc_navbar-btn" id="dj-edit-inline">' . __( 'Frontend', 'js_composer' ) . '</a>'
		       . '</li>';
	}
	...
	public function getControlSaveBackend() {
		return '<li class="vc_pull-right vc_save-backend">'
		       ...
		       . '<a class="vc_btn vc_btn-sm vc_navbar-btn vc_btn-primary vc_control-save" id="dj-save-post">' . __( 'Update', 'js_composer' ) . '</a>'
		       . '</li>';
	}
}
