			...
			if ( vc_user_access()->part( 'templates' )->checkStateAny( true, null )->get() ) {
				...
				<div class="vc_column vc_col-sm-12" data-vc-hide-on-search="true">
					...
					<div class="vc_input-group">
						<input name="padding" data-js-element="vc-templates-input" class="vc_form-control dj-textinput vc_panel-templates-name" type="text" value="" placeholder="' . esc_attr( 'Template name', 'js_composer' ) . '" data-vc-disable-empty="#vc_ui-save-template-btn">
...
HTML;
	...
	public function addScriptsToTemplatePreview() {
		// wp_enqueue_script( 'vc-template-preview-script', vc_asset_url( 'js/editors/vc_ui-panel-templates-preview-be.js' ), array( 'vc-backend-min-js' ), DJ_VC_VERSION, true );
	}
