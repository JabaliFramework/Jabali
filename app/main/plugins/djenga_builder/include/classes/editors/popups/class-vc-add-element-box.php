...
class Vc_Add_Element_Box implements Vc_Render {
	...
	public function shortcodes() {
		return DJMap::getSortedUserShortCodes();
	}
	 ...
	 * @see DJMap::getSortedUserShortCodes
	 * @return mixed|void
	 */
	public function getControls() {
		$output = '<ul class="dj-content-layouts">';
		/** @var array $element */
		$buttons_count = 0;
	...
	public function getCategories() {
		return DJMap::getUserCategories();
	}
