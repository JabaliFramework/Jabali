...
/**
 * Manage update messages and Plugins info for VC in default Jabali plugins list.
 */
class Vc_Updating_Manager {
	...
	/**
	 * Initialize a new instance of the Jabali Auto-Update class
	 *
	...
	public function addUpgradeMessageLink() {
		...
		if ( ! $is_activated ) {
			...
			echo sprintf( ' ' . __( 'To receive automatic updates license activation is required. Please visit %s to activate your Djenga Builder.', 'js_composer' ), $redirect ) . sprintf( ' <a href="http://go.mtaandao.co.ke/faq-update-in-theme" target="_blank">%s</a>', __( 'Got Djenga Builder in theme?', 'js_composer' ) );
		}
	}
}
