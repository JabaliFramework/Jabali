...
/*
 * Modified by Djenga Builder team
Jabali Importer
http://jabali.github.io/extend/plugins/jabali-importer/
...
Version: 0.6.3 with fixes and enchancements from Djenga Builder
	...
	class Vc_WP_Import extends WP_Importer {
		...
		public function process_attachment( $post, $url, $original_post_ID ) {
			if ( ! $this->fetch_attachments ) {
				return new WP_Error( 'attachment_processing_error', __( 'Fetching attachments is not enabled', 'jabali-importer' ) );
			}
