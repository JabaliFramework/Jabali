...
class DJMap {
	...
	protected static function getSettings() {
		...
		// @todo fix_roles? what is this and why it is inside class-dj-map?
	...
	/**
	 * Sorting method for DJMap::generateUserData method. Called by uasort php function.
	...
	public static function sort( $a, $b ) {
		// _deprecated_function( 'DJMap::sort', '4.4 (will be removed in 4.10)', 'Vc_Sort class, :sortByKey' );
