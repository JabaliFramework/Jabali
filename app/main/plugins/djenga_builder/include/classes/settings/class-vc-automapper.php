...
if ( ! class_exists( 'Vc_Automapper' ) ) {
	...
	class Vc_Automapper {
		...
		public function renderHtml() {
			...
			?>
			<div class="tab_intro">
				<p><?php _e( 'Djenga Builder Shortcode Mapper adds custom 3rd party vendors shortcodes to the list of Djenga Builder content elements menu (Note: to map shortcode it needs to be installed on site).', 'js_composer' ) ?></p>
			</div>
		...
		public function renderMapFormTpl() {
			...
			<script type="text/html" id="vc_atm-form-param-tpl">
				...
				<div class="dj_element_wrapper">
					<div class="vc_row vc_row-fluid dj_row_container">
						<div class="dj_vc_column dj_sortable vc_col-sm-12 dj_content_holder vc_empty-column">
							<div class="dj_element_wrapper">
