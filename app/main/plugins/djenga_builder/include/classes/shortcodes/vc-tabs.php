...
class DJengaShortCode_VC_Tabs extends DJengaShortCode {
	...
	public function contentAdmin( $atts, $content = null ) {
		...
		$elem = str_ireplace( '%dj_element_content%', $iner, $elem );
		$output = $elem;
	...
	public function getTabTemplate() {
		return '<div class="dj_template">' . do_shortcode( '[vc_tab title="Tab" tab_id=""][/vc_tab]' ) . '</div>';
	}
