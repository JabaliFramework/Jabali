...
class DJengaShortCode_Vc_Pie extends DJengaShortCode {
	...
	public function jsScripts() {
		...
		wp_register_script( 'progressCircle', vc_asset_url( 'lib/bower/progress-circle/ProgressCircle.min.js' ), array(), DJ_VC_VERSION, true );
