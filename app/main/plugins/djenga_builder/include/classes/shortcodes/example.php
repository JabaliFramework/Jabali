...
/**
 * An example of how to write Djenga Builder custom shortcode
 *
 * To create shortcodes for visual composer you need to complete 2 steps.
 *
 * 1. Create new class which extends DJengaShortCode.
 ...
 *
 * 2. Need to create configurations by using dj_map function.
 *
 * Shortcode class.
 * Shortcode class extends DJengaShortCode abstract class.
 * Correct name for shortcode class should look like DJengaShortCode_YOUR_SHORTCODE_HERE.
 ...
 * here[/my_hello_world]
 */
class DJengaShortCode_my_hello_world extends DJengaShortCode {
	...
	protected function content( $atts, $content = null ) {
		...
		$output .= '<h3>' . $foo . '</h3>';
		$output .= dj_js_remove_wpautop( $content, true );
