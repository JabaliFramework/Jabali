...
/**
 * Class DJengaShortCode_VC_Custom_heading
 * @since 4.3
 */
class DJengaShortCode_VC_Custom_heading extends DJengaShortCode {
	/**
	...
	protected function getParamData( $key ) {
		return DJMap::getParam( $this->shortcode, $this->getField( $key ) );
	}
