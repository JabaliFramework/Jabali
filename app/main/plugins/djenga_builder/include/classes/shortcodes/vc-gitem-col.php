...
class DJengaShortCode_VC_Gitem_Col extends DJengaShortCode_VC_Column {
	...
	public function mainHtmlBlockParams( $width, $i ) {
		...
		return 'data-element_type="' . $this->settings['base'] . '" data-vc-column-width="'
		       . dj_vc_get_column_width_indent( $width[ $i ] )
		       . '" class="dj_vc_column dj_' . $this->settings['base'] . $sortable
		       . $this->templateWidth() . ' dj_content_holder"'
