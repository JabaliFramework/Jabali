...
class DJengaShortCode_VC_Gitem extends DJengaShortCodesContainer {
	...
	public function mainHtmlBlockParams( $width, $i ) {
		...
		return 'data-element_type="' . $this->settings['base'] . '" class="' . $this->settings['base'] . '-shortcode ' . $sortable . ' dj_content_holder vc_shortcodes_container"' . $this->customAdminBlockParams();
	}
