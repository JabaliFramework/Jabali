...
VcShortcodeAutoloader::getInstance()->includeClass( 'DJengaShortCode_VC_Tta_Accordion' );

class DJengaShortCode_VC_Tta_Tabs extends DJengaShortCode_VC_Tta_Accordion {

	public $layout = 'tabs';

	public function enqueueTtaScript() {
		wp_register_script( 'vc_tabs_script', vc_asset_url( 'lib/vc_tabs/vc-tabs.min.js' ), array( 'vc_accordion_script' ), DJ_VC_VERSION, true );
