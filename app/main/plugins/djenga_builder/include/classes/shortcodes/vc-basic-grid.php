...
class DJengaShortCode_VC_Basic_Grid extends DJengaShortCode_Vc_Pageable {
	...
	public function getHash( $atts, $content ) {
		// _deprecated_function( 'DJengaShortCode_VC_Basic_Grid::getHash', '4.4.3 (will be removed in 4.10)', 'getId resave your grid' );
	...
	public function findPostShortcodeByHash( $page_id, $hash ) {
		// _deprecated_function( 'DJengaShortCode_VC_Basic_Grid::findPostShortcodeByHash', '4.4.3 (will be removed in 4.10)', 'findPostShortcodeById resave your grid to renew' );
	...
	public static function convertButton2ToButton3( $atts ) {
		if ( isset( $atts['button_style'] ) || isset( $atts['button_size'] ) || isset( $atts['button_color'] ) ) {
			...
			$atts['button_size'] = '';
			$atts['button_color'] = '';
			$newData = DJengaShortCode_VC_Btn::convertAttributesToButton3( $oldData );
