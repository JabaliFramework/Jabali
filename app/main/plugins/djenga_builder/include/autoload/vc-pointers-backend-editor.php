		...
		$pointers['vc_pointers_backend_editor'] = array(
			...
			'messages' => array(
				array(
					...
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s </p>',
							__( 'Welcome to Djenga Builder', 'js_composer' ),
				...
				array(
					...
					'closeEvent' => 'click #dj_visual_composer',
					'showEvent' => 'shortcodeView:ready',
				),
				array(
					'target' => '.dj_column_container:first .dj_content_element:first .vc_controls-cc',
					'options' => array(
						'content' => sprintf( '<h3> %s </h3> <p> %s <br/><br/> %s</p>',
							...
							sprintf( __( 'P.S. Learn more at our <a href="%s" target="_blank">Knowledge Base</a>.', 'js_composer' ), 'http://kb.mtaandao.co.ke' )
						),
						'position' => array(
							'edge' => 'left',
							'align' => 'center',
