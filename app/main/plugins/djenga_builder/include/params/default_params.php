...
/**
 * Djenga Builder shortcode default attributes functions for rendering.
 *
...
function vc_dropdown_form_field( $settings, $value ) {
	...
	$output .= '<select name="'
	           . $settings['param_name']
	           . '" class="dj_vc_param_value dj-input dj-select '
	           . $settings['param_name']
	           . ' ' . $settings['type']
	           . ' ' . $css_option
	...
	foreach ( $post_types as $post_type ) {
		...
		if ( 'attachment' !== $post_type ) {
			...
			$output .= ' <label class="vc_checkbox-label"><input id="'
			           ...
			           . $post_type . '" class="dj_vc_param_value '
			           . $settings['param_name']
			           . ' ' . $settings['type']
			           . '" type="checkbox" name="'
...
function vc_exploded_textarea_form_field( $settings, $value ) {
	...
	return '<textarea name="'
	       . $settings['param_name'] . '" class="dj_vc_param_value dj-textarea '
...
function vc_textarea_raw_html_form_field( $settings, $value ) {
	return '<textarea name="'
	       . $settings['param_name'] . '" class="dj_vc_param_value dj-textarea_raw_html '
...
function vc_attach_images_form_field( $settings, $value, $tag, $single = false ) {
	$output = '';
	$param_value = dj_removeNotExistingImgIDs( $value );
	$output .= '<input type="hidden" class="dj_vc_param_value gallery_widget_attached_images_ids '
	           . $settings['param_name'] . ' '
...
function vc_widgetised_sidebars_form_field( $settings, $value ) {
	...
	$output .= '<select name="' . $settings['param_name']
	           . '" class="dj_vc_param_value dropdown dj-input dj-select '
	           . $settings['param_name'] . ' '
	           . $settings['type'] . '">';
