...
class Vc_IconPicker {
	 ...
	 * main/plugins/js_composer/assets/js/params/composer-atts.js init
	 * method
	 ...
	 * main/plugins/js_composer/include/autoload/hook-vc-iconpicker-param.php
	 * folder
	 * @since 4.4
	...
	public function render() {
		...
		$output .= '<input name="' . esc_attr( $this->settings['param_name'] ) . '" class="dj_vc_param_value  ' . esc_attr( $this->settings['param_name'] ) . ' ' . esc_attr( $this->settings['type'] ) . '_field" type="hidden" value="' . esc_attr( $this->value ) . '" ' . ( ( isset( $this->settings['settings'] ) && ! empty( $this->settings['settings'] ) ) ? ' data-settings="' . esc_attr( json_encode( $this->settings['settings'] ) ) . '" ' : '' ) . ' />';
...
function vc_iconpicker_type_fontawesome( $icons ) {
	...
	$fontawesome_icons = array(
		'New in 4.6' => array(
			...
			array( 'fa fa-djeginner' => 'DJeginner' ),
		...
		'Brand Icons' => array(
			...
			array( 'fa fa-jabali' => 'Jabali Logo' ),
...
function vc_iconpicker_type_monosocial( $icons ) {
	$monosocial = array(
		...
		array( 'vc-mono vc-mono-jabali' => 'Jabali' ),
