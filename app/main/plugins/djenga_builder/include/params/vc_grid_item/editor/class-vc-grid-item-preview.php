...
class Vc_Grid_Item_Preview {
	...
	public function enqueue() {
		...
		VcShortcodeAutoloader::getInstance()->includeClass( 'DJengaShortCode_VC_Basic_Grid' );

		$grid = new DJengaShortCode_VC_Basic_Grid( array( 'base' => 'vc_basic_grid' ) );
	...
	public function mockingPost() {
		...
		$post->post_content = __( 'The Jabali Excerpt is an optional summary or description of a post; in short, a post summary.', 'js_composer' );
		$post->post_excerpt = __( 'The Jabali Excerpt is an optional summary or description of a post; in short, a post summary.', 'js_composer' );
