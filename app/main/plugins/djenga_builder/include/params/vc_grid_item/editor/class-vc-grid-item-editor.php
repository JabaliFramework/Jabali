...
class Vc_Grid_Item_Editor extends Vc_Backend_Editor {
	...
	public function addMetaBox() {
		add_meta_box( 'dj_visual_composer', __( 'Grid Builder', 'js_composer' ), array(
			&$this,
			'renderEditor',
	...
	public function renderEditor( $post = null ) {
		...
		add_filter( 'vc_djakery_shortcode_get_controls_list', array(
			$this,
			'shortcodesControls',
		) );
	...
	public function registerBackendJavascript() {
		...
		wp_register_script( 'vc_grid_item_editor', vc_asset_url( 'js/dist/grid-builder.min.js' ), array( 'vc-backend-min-js' ), DJ_VC_VERSION, true );
