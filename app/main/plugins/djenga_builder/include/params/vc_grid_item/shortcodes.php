...
VcShortcodeAutoloader::getInstance()->includeClass( 'DJengaShortCode_VC_Gitem_Animated_Block' );
	...
	'vc_gitem_animated_block' => array(
		...
		'params' => array(
			array(
				...
				'value' => DJengaShortCode_VC_Gitem_Animated_Block::animations(),
			),
		),
...
$shortcode_vc_column_text = DJMap::getShortCode( 'vc_column_text' );
...
$shortcode_vc_separator = DJMap::getShortCode( 'vc_separator' );
...
$shortcode_vc_text_separator = DJMap::getShortCode( 'vc_text_separator' );
...
$shortcode_vc_icon = DJMap::getShortCode( 'vc_icon' );
...
$shortcode_vc_button2 = DJMap::getShortCode( 'vc_button2' );
...
$shortcode_vc_btn = DJMap::getShortCode( 'vc_btn' );
...
$shortcode_vc_custom_heading = DJMap::getShortCode( 'vc_custom_heading' );
...
$shortcode_vc_empty_space = DJMap::getShortCode( 'vc_empty_space' );
