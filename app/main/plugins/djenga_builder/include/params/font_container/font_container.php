...
class Vc_Font_Container {
	...
	public function render( $settings, $value ) {
		...
		if ( ! empty( $fields ) ) {
			if ( isset( $fields['tag'] ) ) {
                ...
                <div class="vc_row-fluid vc_column">
                    <div class="dj_element_label">' . __( 'Element tag', 'js_composer' ) . '</div>
			...
			if ( isset( $fields['font_size'] ) ) {
				$data['font_size'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="dj_element_label">' . __( 'Font size', 'js_composer' ) . '</div>
			...
			if ( isset( $fields['text_align'] ) ) {
				$data['text_align'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="dj_element_label">' . __( 'Text align', 'js_composer' ) . '</div>
			...
			if ( isset( $fields['line_height'] ) ) {
				$data['line_height'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="dj_element_label">' . __( 'Line height', 'js_composer' ) . '</div>
			...
			if ( isset( $fields['color'] ) ) {
				$data['color'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="dj_element_label">' . __( 'Text color', 'js_composer' ) . '</div>
			...
			if ( isset( $fields['font_family'] ) ) {
				$data['font_family'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="dj_element_label">' . __( 'Font Family', 'js_composer' ) . '</div>
			...
			if ( isset( $fields['font_style'] ) ) {
				$data['font_style'] = '
                <div class="vc_row-fluid vc_column">
                    <div class="dj_element_label">' . __( 'Font style', 'js_composer' ) . '</div>
		...
		$output .= '<input name="' . $settings['param_name'] . '" class="dj_vc_param_value  ' . $settings['param_name'] . ' ' . $settings['type'] . '_field" type="hidden" value="' . $value . '" />';
