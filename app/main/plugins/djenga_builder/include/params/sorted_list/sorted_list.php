...
class Vc_Teaser_Box {
	...
	public function outputTeaser() {
		wp_enqueue_script( 'dj_jscomposer_teaser_js' );
		wp_localize_script( 'dj_jscomposer_teaser_js', 'i18nVcTeaser', array(
		...
		$output .= '<img src="' . get_site_url() . '/admin/images/wpspin_light.gif" /></div>';
