...
<div class="vc_row-fluid vc_column">
	<div class="dj_element_label"><?php _e( 'Font Family', 'js_composer' ); ?></div>
...
<?php if ( isset( $fields['no_font_style'] ) && false === $fields['no_font_style'] || ! isset( $fields['no_font_style'] ) ) : ?>
	<div class="vc_row-fluid vc_column">
		<div class="dj_element_label"><?php _e( 'Font style', 'js_composer' ); ?></div>
...
<div class="vc_row-fluid vc_column">
	<div class="dj_element_label"><?php _e( 'Google Fonts preview', 'js_composer' ); ?>:</div>
...
<input name="<?php echo $settings['param_name']; ?>"
	class="dj_vc_param_value  <?php echo $settings['param_name'] . ' ' . $settings['type']; ?>_field" type="hidden"
