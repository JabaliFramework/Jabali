...
if ( $vc_grid_item_editor ) {
	...
	add_filter( 'vc_djakery_shortcode_get_controls_list', array( $vc_grid_item_editor, 'shortcodesControls' ) );
}
...
?>
	...
	<div class="vc_ui-template-preview">
		...
		<div id="dj_visual_composer" class="postbox " style="display: block;">
			<div class="inside">
				<div class="metabox-composer-content">
					<div id="visual_composer_content"
					     class="dj_main_sortable main_wrapper ui-sortable ui-droppable"></div>
				...
				<input type="hidden" id="dj_vc_js_status" name="dj_vc_js_status" value="true">
				<input type="hidden" id="dj_vc_loading" name="dj_vc_loading" value="Loading, please wait...">
				<input type="hidden" id="dj_vc_loading_row" name="dj_vc_loading_row" value="Crunching...">
