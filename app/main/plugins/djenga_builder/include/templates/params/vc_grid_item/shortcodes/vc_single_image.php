...
/** @var $this DJengaShortCode_VC_Single_image */
...
$class_to_filter = 'dj_single_image dj_content_element vc_align_' . $alignment . ' ' . $this->getCSSAnimation( $css_animation );
$class_to_filter .= vc_shortcode_custom_css_class( $css, ' ' ) . $this->getExtraClass( $el_class );
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $class_to_filter, $this->settings['base'], $atts );

$output = '
	<div class="' . esc_attr( $css_class ) . '">
		' . dj_widget_title( array( 'title' => $title, 'extraclass' => 'dj_singleimage_heading' ) ) . '
