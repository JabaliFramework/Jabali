			...
			<div class="vc_ui-panel-content vc_properties-list vc_edit_form_elements" data-vc-ui-element="panel-content">
				<div class="vc_row vc_ui-flex-row">
					<div class="vc_col-sm-12 vc_column vc_layout-panel-switcher">
						<div class="dj_element_label"><?php _e( 'Row layout', 'js_composer' ) ?></div>
					...
					<div class="vc_col-sm-12 vc_column">
						<div class="dj_element_label"><?php _e( 'Enter custom layout for your row', 'js_composer' ) ?></div>
						<div class="edit_form_line">
							<input name="padding" class="dj-textinput vc_row_layout" type="text" value="" id="vc_row-layout">
