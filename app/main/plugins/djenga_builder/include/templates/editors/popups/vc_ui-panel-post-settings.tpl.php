			...
			<div class="vc_ui-panel-content vc_properties-list vc_edit_form_elements" data-vc-ui-element="panel-content">
				<div class="vc_row">
					<div class="vc_col-sm-12 vc_column" id="vc_settings-title-container">
						<div class="dj_element_label"><?php _e( 'Page title', 'js_composer' ) ?></div>
						<div class="edit_form_line">
							<input name="page_title" class="dj-textinput vc_title_name" type="text" value=""
					...
					<div class="vc_col-sm-12 vc_column">
						<div class="dj_element_label"><?php _e( 'Custom CSS settings', 'js_composer' ) ?></div>
						<div class="edit_form_line">
							<pre id="dj_csseditor" class="dj_content_element custom_css dj_frontend"></pre>
					<span
