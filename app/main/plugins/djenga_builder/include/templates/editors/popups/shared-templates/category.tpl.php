	...
	<div class="vc_ui-panel-template-content vc_ui-panel-popup-item vc_ui-hidden">
		...
		if ( ! vc_license()->isActivated() ) :
			...
			<div class="vc_ui-panel-message">
				<h3 class="vc_ui-panel-title"><?php _e( 'Activate Djenga Builder', 'js_composer' ); ?></h3>
				<p class="vc_description"><?php _e( 'Djenga Builder Template Library downloads are available for activated	versions only. Activate Djenga Builder direct license to access Template Library and receive other benefits.', 'js_composer' ); ?></p>
...
if ( vc_user_access()->part( 'templates' )->checkStateAny( true, null )->get() ) :
	...
	<div class="vc_column vc_col-sm-12 vc_access-library-col">
		...
		<p class="vc_description"><?php _e( 'Access Djenga Builder Template Library for unique layout
		templates. Download chosen templates and discover new layouts with regular template
		updates from Djenga Builder team.', 'js_composer' ); ?></p>
