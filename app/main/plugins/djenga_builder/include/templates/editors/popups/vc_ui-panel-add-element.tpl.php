	...
	<div class="vc_ui-panel-window-inner">
		...
		<div class="vc_ui-panel-content-container">
			<div class="vc_add-element-container">
				<div class="dj-elements-list vc_filter-all" data-vc-ui-filter="*"
					data-vc-ui-element="panel-add-element-list">
					<ul class="dj-content-layouts-container">
						<li class="vc_add-element-deprecated-warning">
							<div class="dj_element_wrapper">
								<?php echo vc_message_warning( __( 'Elements within this list are deprecated and are no longer supported in newer versions of Djenga Builder.', 'js_composer' ) ) ?>
							</div>
						</li>
						...
						<?php if ( $box->isShowEmptyMessage() && true !== $box->getPartState() ) : ?>
							<li class="vc_add-element-access-warning">
								<div class="dj_element_wrapper">
									<?php echo vc_message_warning( __( 'Your user role have restricted access to content elements. If required, contact your site administrator to change Djenga Builder Role Manager settings for your user role.', 'js_composer' ) ) ?>
								</div>
							</li>
						<?php endif; ?>
					</ul>
