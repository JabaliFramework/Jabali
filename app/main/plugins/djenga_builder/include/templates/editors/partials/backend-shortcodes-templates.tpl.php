...
<script type="text/javascript">
	var vc_user_mapper = <?php echo json_encode( DJMap::getUserShortCodes() ) ?>,
		vc_mapper = <?php echo json_encode( DJMap::getShortCodes() ) ?>,
...
<?php foreach ( DJMap::getShortCodes() as $sc_base => $el ) :  ?>
...
<script type="text/html" id="vc_settings-page-param-block">
	<div class="row-fluid dj_el_type_<%= type %>">
		<div class="dj_element_label"><%= heading %></div>
