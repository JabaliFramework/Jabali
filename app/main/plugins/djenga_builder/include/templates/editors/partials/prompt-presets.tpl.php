...
<form class="vc_ui-prompt vc_ui-prompt-presets">
	...
	<div class="vc_ui-prompt-title">
		<label for="prompt_title" class="dj_element_label"><?php _e( 'Preset Title', 'js_composer' ) ?></label>
	</div>
		...
		<div class="vc_ui-prompt-column">
			<div class="dj_el_type_textfield vc_wrapper-param-type-textfield vc_properties-list">
				<div class="edit_form_line">
					<input name="title" id="prompt_title" class="dj_vc_param_value dj-textinput h4 textfield"
