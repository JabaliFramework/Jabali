 ...
 * Shortcode class
 * @var $this DJengaShortCode_VC_Posts_Grid
 */
...
if ( ! empty( $args['post_type'] ) && is_array( $args['post_type'] ) ) {
	foreach ( $args['post_type'] as $post_type ) {
		$post_types_teasers .= 'dj_teaser_grid_' . $post_type . ' ';
	}
}
$li_span_class = $this->spanClass( $grid_columns_count );

$css_class = 'dj_row dj_teaser_grid dj_content_element ' .
...
?>
	<div class="<?php echo esc_attr( trim( $css_class ) ); ?>">
		<div class="dj_wrapper">
			<?php echo dj_widget_title( array( 'title' => $title, 'extraclass' => 'dj_teaser_grid_heading' ) ) ?>
			<div class="teaser_grid_container">
				...
				<?php endif ?>
				<ul class="dj_thumbnails dj_thumbnails-fluid vc_clearfix" data-layout-mode="<?php echo $grid_layout_mode ?>">
					<?php
					/**
					 * Enqueue js/css
					 * {{
