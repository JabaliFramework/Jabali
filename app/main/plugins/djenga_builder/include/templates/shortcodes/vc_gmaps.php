 ...
 * @var $css_animation
 * Shortcode class
 * @var $this DJengaShortCode_VC_Gmaps
 */
...
$class_to_filter = 'dj_gmaps_widget dj_content_element' . ( '' === $size ? ' vc_map_responsive' : '' );
$class_to_filter .= vc_shortcode_custom_css_class( $css, ' ' ) . $this->getExtraClass( $el_class ) . $this->getCSSAnimation( $css_animation );
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $class_to_filter, $this->settings['base'], $atts );

?>
<div class="<?php echo esc_attr( $css_class ); ?>">
	<?php echo dj_widget_title( array(
		'title' => $title,
		'extraclass' => 'dj_map_heading',
	) ); ?>
	<div class="dj_wrapper">
		<div class="dj_map_wraper">
			<?php
