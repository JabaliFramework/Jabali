...
<div<?php echo $inline_css; ?> class="<?php echo esc_attr( trim( $css_class ) ); ?>">
	...
	<?php if ( '' !== $h2 || '' !== $h4 ) :  ?>
		<hgroup>
			<?php if ( '' !== $h2 ) :  ?><h2 class="dj_heading"><?php echo $h2; ?></h2><?php endif ?>
			<?php if ( '' !== $h4 ) :  ?><h4 class="dj_heading"><?php echo $h4; ?></h4><?php endif ?>
		</hgroup>
	<?php endif ?>
	<?php echo dj_js_remove_wpautop( $content, true ); ?>
	<?php if ( '' !== $link && 'bottom' === $position ) {
