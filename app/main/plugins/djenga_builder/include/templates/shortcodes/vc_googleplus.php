 ...
 * @var $css_animation
 * Shortcode class
 * @var $this DJengaShortCode_VC_GooglePlus
 */
...
$class_to_filter = 'dj_googleplus dj_content_element dj_googleplus_type_' . $type . ' vc_googleplus-annotation-' . $annotation . $this->getCSSAnimation( $css_animation );
