...
function vc_custom_heading_element_params() {
	return array(
		...
		'icon' => 'icon-dj-ui-custom_heading',
		...
		'params' => array(
			...
			array(
				...
				'description' => __( 'Note: If you are using non-latin characters be sure to activate them under Settings/Djenga Builder/General Settings.', 'js_composer' ),
				'dependency' => array(
					'element' => 'source',
					'is_empty' => true,
				),
