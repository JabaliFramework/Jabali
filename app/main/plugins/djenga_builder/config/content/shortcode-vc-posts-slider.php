...
return array(
	...
	'params' => array(
		...
		array(
			...
			'description' => sprintf( __( 'Select how to sort retrieved posts. More at %s.', 'js_composer' ), '<a href="http://jabali.github.io/Docs/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">Jabali codex page</a>' ),
		),
		array(
			'type' => 'dropdown',
			...
			'description' => sprintf( __( 'Select ascending or descending order. More at %s.', 'js_composer' ), '<a href="http://jabali.github.io/Docs/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">Jabali codex page</a>' ),
		),
		array(
			'type' => 'textfield',
