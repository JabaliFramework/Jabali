...
/**
 * Djenga Builder Shortcodes settings Lazy mapping
 *
...
function vc_size_arr() {
	return array(
		__( 'Regular', 'js_composer' ) => 'dj_regularsize',
...
function vc_icons_arr() {
	return array(
		...
		__( 'Address book icon', 'js_composer' ) => 'dj_address_book',
		__( 'Alarm clock icon', 'js_composer' ) => 'dj_alarm_clock',
		__( 'Anchor icon', 'js_composer' ) => 'dj_anchor',
		__( 'Application Image icon', 'js_composer' ) => 'dj_application_image',
		__( 'Arrow icon', 'js_composer' ) => 'dj_arrow',
		__( 'Asterisk icon', 'js_composer' ) => 'dj_asterisk',
		__( 'Hammer icon', 'js_composer' ) => 'dj_hammer',
		__( 'Balloon icon', 'js_composer' ) => 'dj_balloon',
		__( 'Balloon Buzz icon', 'js_composer' ) => 'dj_balloon_buzz',
		__( 'Balloon Facebook icon', 'js_composer' ) => 'dj_balloon_facebook',
		__( 'Balloon Twitter icon', 'js_composer' ) => 'dj_balloon_twitter',
		__( 'Battery icon', 'js_composer' ) => 'dj_battery',
		__( 'Binocular icon', 'js_composer' ) => 'dj_binocular',
		__( 'Document Excel icon', 'js_composer' ) => 'dj_document_excel',
		__( 'Document Image icon', 'js_composer' ) => 'dj_document_image',
		__( 'Document Music icon', 'js_composer' ) => 'dj_document_music',
		__( 'Document Office icon', 'js_composer' ) => 'dj_document_office',
		__( 'Document PDF icon', 'js_composer' ) => 'dj_document_pdf',
		__( 'Document Powerpoint icon', 'js_composer' ) => 'dj_document_powerpoint',
		__( 'Document Word icon', 'js_composer' ) => 'dj_document_word',
		__( 'Bookmark icon', 'js_composer' ) => 'dj_bookmark',
		__( 'Camcorder icon', 'js_composer' ) => 'dj_camcorder',
		__( 'Camera icon', 'js_composer' ) => 'dj_camera',
		__( 'Chart icon', 'js_composer' ) => 'dj_chart',
		__( 'Chart pie icon', 'js_composer' ) => 'dj_chart_pie',
		__( 'Clock icon', 'js_composer' ) => 'dj_clock',
		__( 'Fire icon', 'js_composer' ) => 'dj_fire',
		__( 'Heart icon', 'js_composer' ) => 'dj_heart',
		__( 'Mail icon', 'js_composer' ) => 'dj_mail',
		__( 'Play icon', 'js_composer' ) => 'dj_play',
		__( 'Shield icon', 'js_composer' ) => 'dj_shield',
		__( 'Video icon', 'js_composer' ) => 'dj_video',
	);
}
