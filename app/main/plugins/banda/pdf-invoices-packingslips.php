...
if ( !class_exists( 'Banda_PDF_Invoices' ) ) {

	class Banda_PDF_Invoices {
		...
		public function translations() {
			 ...
			 *
			 * 		- WP_LANG_DIR/pdf-invoices-packing-slips/wpo_wcpdf-LOCALE.mo
			 * 	 	- WP_LANG_DIR/plugins/wpo_wcpdf-LOCALE.mo
			 * 	 	- pdf-invoices-packing-slips/languages/wpo_wcpdf-LOCALE.mo (which if not found falls back to:)
			 * 	 	- WP_LANG_DIR/plugins/wpo_wcpdf-LOCALE.mo
			 */
			load_textdomain( 'wpo_wcpdf', $dir . 'pdf-invoices-packing-slips/wpo_wcpdf-' . $locale . '.mo' );
		...
		public function get_payment_method() {
			...
			$payment_method = __( $this->export->order->payment_method_title, 'banda' );
			if ( !$payment_method && $parent_order_id = wp_get_post_parent_id( $this->export->order->id ) ) {
				...
				$payment_method = __( $payment_method, 'banda' );
			}
		...
		public function get_shipping_method() {
			...
			return apply_filters( 'wpo_wcpdf_shipping_method', __( $this->export->order->get_shipping_method(), 'banda' ) );
		}
		 ...
		 */
		public function get_banda_totals() {
			...
			return apply_filters( 'wpo_wcpdf_banda_totals', $totals, $this->export->order );
		}
...
$wpo_wcpdf = new Banda_PDF_Invoices();
