...
'layout3_settings'                       => array(
    'name' => __( 'Layout 3', 'yith-banda-product-slider-carousel' ),
    'type' => 'title',
    ...
    'name'    => __( 'Background color navigation arrow', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'    => __( 'Border color navigation arrow', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'  =>  __( 'Text color navigation arrow', 'yith-banda-product-slider-carousel' ),
    'type'  =>  'color',
    'desc'  =>  '',
