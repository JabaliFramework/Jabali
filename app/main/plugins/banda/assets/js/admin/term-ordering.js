/*global ajaxurl, banda_term_ordering_params */
...
jQuery( function( $ ) {
	...
	$( 'table.widefat.wp-list-table' ).sortable({
		...
		update: function( event, ui ) {
			...
			$.post( ajaxurl, { action: 'banda_term_ordering', id: termid, nextid: nexttermid, thetaxonomy: banda_term_ordering_params.taxonomy }, function(response){
