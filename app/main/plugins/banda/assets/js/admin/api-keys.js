/*global jQuery, Backbone, _, banda_admin_api_keys */
(function( $ ) {
	...
	var APIView = Backbone.View.extend({
			...
			$( document.body )
				.on( 'aftercopy', css_class, function( e ) {
					if ( true === e.success['text/plain'] ) {
						...
						$( '#copy-error' ).text( banda_admin_api_keys.clipboard_failed );
					}
				} )
		...
		saveKey: function( e ) {
			...
			Backbone.ajax({
				method:   'POST',
				dataType: 'json',
				url:      banda_admin_api_keys.ajax_url,
				data:     {
					action:      'banda_update_api_key',
					security:    banda_admin_api_keys.update_api_nonce,
