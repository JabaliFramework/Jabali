/*global ajaxurl, inlineEditPost, inlineEditL10n, banda_admin */
jQuery(function( $ ) {
	$( '#the-list' ).on( 'click', '.editinline', function() {
		...
		var $wc_inline_data = $( '#banda_inline_' + post_id );
		...
		var formatted_regular_price = regular_price.replace('.', banda_admin.mon_decimal_point ),
			formatted_sale_price	= sale_price.replace('.', banda_admin.mon_decimal_point );
