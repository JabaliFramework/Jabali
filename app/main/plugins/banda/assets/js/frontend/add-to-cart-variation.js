...
;(function ( $, window, document, undefined ) {
	...
	$.fn.wc_variation_form = function() {
		...
		.on( 'hide_variation', function( event ) {
			...
			$form.find( '.banda-variation-add-to-cart' ).removeClass( 'banda-variation-add-to-cart-enabled' ).addClass( 'banda-variation-add-to-cart-disabled' );
		} )
		...
		.on( 'show_variation', function( event, variation, purchasable ) {
			...
			if ( purchasable ) {
				...
				$form.find( '.banda-variation-add-to-cart' ).removeClass( 'banda-variation-add-to-cart-disabled' ).addClass( 'banda-variation-add-to-cart-enabled' );
			} else {
		...
		.on( 'change', '.variations select', function() {
			...
			if ( $use_ajax ) {
					...
					$xhr = $.ajax( {
						...
						success: function( variation ) {
							if ( variation ) {
								...
								$form.trigger( 'reset_data' );
								$form.find( '.single_variation' ).after( '<p class="wc-no-matching-variations banda-info">' + wc_add_to_cart_variation_params.i18n_no_matching_variations_text + '</p>' );
				...
				$form.trigger( 'banda_variation_select_change' );
			...
			$form.trigger( 'banda_variation_has_changed' );
		} )
		...
		.on( 'focusin touchstart', '.variations select', function() {
			...
			if ( ! $use_ajax ) {
				$form.trigger( 'banda_variation_select_focusin' );
		...
		.on( 'update_variation_values', function( event, variations ) {
			...
			$form.trigger( 'banda_update_variation_values' );
		});
