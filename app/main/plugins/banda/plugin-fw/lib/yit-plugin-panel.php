...
if ( ! class_exists( 'YIT_Plugin_Panel' ) ) {
    ...
    class YIT_Plugin_Panel {
         ...
         * Register Settings
         *
         * Generate admin settings pages by registering your settings and using a few callbacks to control the output
         *
         * @return void
         * @since    1.0
         * @author   Emanuela Castorina <emanuela.castorina@yithemes.it>
         ...
         * Add Setting SubPage
         *
         * add Setting SubPage to jabali administrator
         *
         * @return array validate input fields
         * @since    1.0
         * @author   Emanuela Castorina <emanuela.castorina@yithemes.it>
        ...
        /**
         * Show a box panel with specific content in two columns as a new banda type
         *
         *
         * @param array $args
         *
