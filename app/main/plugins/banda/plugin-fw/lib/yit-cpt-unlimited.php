...
class YIT_CPT_Unlimited {
    ...
    public function __construct( $args = array() ) {
        ...
        // add required post type for jabali importer
     ...
     * @param string|bool $src    Path to the stylesheet from the root directory of Jabali. Example: '/css/mystyle.css'.
     ...
     * @param string|bool $src       Path to the script from the root directory of Jabali. Example: '/js/myscript.js'.
