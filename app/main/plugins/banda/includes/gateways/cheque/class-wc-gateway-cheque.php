...
class WC_Gateway_Cheque extends WC_Payment_Gateway {
	...
	public function __construct() {
		$this->id                 = 'cheque';
		$this->icon               = apply_filters( 'banda_cheque_icon', '' );
		$this->has_fields         = false;
		$this->method_title       = _x( 'Check Payments', 'Check payment method', 'banda' );
		$this->method_description = __( 'Allows check payments. Why would you take checks in this day and age? Well you probably wouldn\'t but it does allow you to make test purchases for testing order emails and the \'success\' pages etc.', 'banda' );
		...
		add_action( 'banda_thankyou_cheque', array( $this, 'thankyou_page' ) );
	...
	public function init_form_fields() {
		...
		$this->form_fields = array(
			'enabled' => array(
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable Check Payments', 'banda' ),
				'default' => 'yes'
			),
			'title' => array(
				...
				'default'     => _x( 'Check Payments', 'Check payment method', 'banda' ),
				'desc_tip'    => true,
			),
			'description' => array(
				...
				'default'     => __( 'Please send a check to Store Name, Store Street, Store Town, Store State / County, Store Postcode.', 'banda' ),
				'desc_tip'    => true,
			),
			'instructions' => array(
	...
	public function process_payment( $order_id ) {
		...
		$order->update_status( 'on-hold', _x( 'Awaiting check payment', 'Check payment method', 'banda' ) );
