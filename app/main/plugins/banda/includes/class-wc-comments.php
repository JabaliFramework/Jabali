...
class WC_Comments {
	...
	public static function exclude_order_comments( $clauses ) {
		...
		if ( is_admin() && in_array( $typenow, wc_get_order_types() ) && current_user_can( 'manage_banda' ) ) {
	...
	public static function check_comment_rating( $comment_data ) {
		...
		if (
			...
			&& 'yes' === get_option( 'banda_enable_review_rating' )
			&& 'yes' === get_option( 'banda_review_rating_required' )
		) {
			wp_die( __( 'Please rate the product.', 'banda' ) );
			exit;
		}
