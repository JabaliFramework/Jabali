					...
					<tr>
						...
						<td>
							...
							<span class="description">
								...
								<strong><?php _e( 'Note:', 'banda-delivery-notes' ); ?></strong>
								<?php _e( 'Leave blank to use the default Website/Blog title defined in Jabali settings. The name will be ignored when a Logo is set.', 'banda-delivery-notes' ); ?>
							</span>
						</td>
					</tr>
					<tr>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<?php else : ?>
								<?php printf( __( 'Install and activate the free <a href="%s">Banda Sequential Order Numbers</a> Plugin.', 'banda-delivery-notes' ), 'http://jabali.github.io/extend/plugins/banda-sequential-order-numbers/' ); ?>
							<?php endif; ?>
							</p>
						</td>
					</tr>
