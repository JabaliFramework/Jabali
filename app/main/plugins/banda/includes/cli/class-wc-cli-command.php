 ...
 * Banda CLI Command.
 *
 * Base class that must be extended by any Banda sub commands.
 *
...
class WC_CLI_Command extends WP_CLI_Command {
	...
	protected function merge_wp_query_args( $base_args, $assoc_args ) {
		...
		$args = apply_filters( 'banda_cli_query_args', $args, $assoc_args );
	...
	protected function merge_wp_user_query_args( $base_args, $assoc_args ) {
		...
		$args = apply_filters( 'banda_cli_user_query_args', $args, $assoc_args );
