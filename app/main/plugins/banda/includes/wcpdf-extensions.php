...
<div class="wcpdf-extensions-ad">
	<?php $no_pro = !class_exists('Banda_PDF_IPS_Pro') && !class_exists('Banda_PDF_IPS_Dropbox') && !class_exists('Banda_PDF_IPS_Templates'); ?>
	<img src="<?php echo Banda_PDF_Invoices::$plugin_url . 'images/wpo-helper.png'; ?>" class="wpo-helper">
	...
	<ul class="extensions">
		<?php if ( $no_pro ): ?>
			...
			<li>
				...
				<h4><?php _e( 'Supercharge Banda PDF Invoices & Packing Slips with the all our premium extensions:', 'wpo_wcpdf' ); ?></h4>
				...
				<ul>
					...
					<li><?php _e( 'Attach <b>up to 3 static files</b> (for example a terms & conditions document) to the Banda emails of your choice.', 'wpo_wcpdf' ); ?></li>
				...
				<br>
				<a href="https://wpovernight.com/downloads/pdf-invoices-packing-slips-bundle/" target="_blank"><?php _e("Get Banda PDF Invoices & Packing Slips Bundle", 'wpo_wcpdf'); ?></a>
				</div>
			</li>
		<?php endif; ?>
		<?php
		// NO BUNDLE: separate ads
		if (!class_exists('Banda_PDF_IPS_Pro') && !$no_pro) {
			?>
			<li>
				<?php _e('Go Pro: Proforma invoices, credit notes (=refunds) & more!', 'wpo_wcpdf')?>
				<div class="more" style="display:none;">
				<?php _e( 'Supercharge Banda PDF Invoices & Packing Slips with the following features:', 'wpo_wcpdf' ); ?>
				<ul>
					<li><?php _e( 'Email/print/download <b>PDF Credit Notes & Proforma invoices</b>', 'wpo_wcpdf' ); ?></li>
					<li><?php _e( 'Send out a separate <b>notification email</b> with (or without) PDF invoices/packing slips, for example to a drop-shipper or a supplier.', 'wpo_wcpdf' ); ?></li>
					<li><?php _e( 'Attach <b>up to 3 static files</b> (for example a terms & conditions document) to the Banda emails of your choice.', 'wpo_wcpdf' ); ?></li>
				...
				<a href="https://wpovernight.com/downloads/pdf-invoices-packing-slips-professional/" target="_blank"><?php _e("Get Banda PDF Invoices & Packing Slips Professional!", 'wpo_wcpdf'); ?></a>
			</li>
		<?php } ?>
		...
		if (!class_exists('WPO_WC_Smart_Reminder_Emails')) {
			...
			<li>
				...
				<div class="more" style="display:none;">
				<?php _e('Banda Smart Reminder emails', 'wpo_wcpdf')?>
				<ul>
				...
				<a href="https://wpovernight.com/downloads/banda-reminder-emails-payment-reminders/" target="_blank"><?php _e("Get Banda Smart Reminder Emails", 'wpo_wcpdf'); ?></a>
				</div>
			</li>
		<?php } ?>

		<?php
		if (!class_exists('Banda_PDF_IPS_Dropbox') && !$no_pro) {
			?>
			<li>
				...
				<table>
					<tr>
						<td><img src="<?php echo Banda_PDF_Invoices::$plugin_url . 'images/dropbox_logo.png'; ?>" class="dropbox-logo"></td>
						<td>
						...
						<a href="https://wpovernight.com/downloads/pdf-invoices-packing-slips-dropbox/" target="_blank"><?php _e("Get Banda PDF Invoices & Packing Slips to dropbox!", 'wpo_wcpdf'); ?></a>
						</td>
					</tr>
				</table>
				</div>
		...
		<?php
		if (!class_exists('Banda_Ext_PrintOrders')) {
			?>
			<li>
				...
				<table>
					<tr>
						<td><img src="<?php echo Banda_PDF_Invoices::$plugin_url . 'images/cloud-print.png'; ?>" class="cloud-logo"></td>
						<td>
						<?php _e( 'Check out the Banda Automatic Order Printing extension from our partners at Simba Hosting', 'wpo_wcpdf' ); ?><br/>
						<a href="https://www.simbahosting.co.uk/s3/product/banda-automatic-order-printing/?affiliates=2" target="_blank"><?php _e("Banda Automatic Order Printing", 'wpo_wcpdf'); ?></a>
						</td>
					</tr>
				</table>
				</div>
		...
		<?php
		if (!class_exists('Banda_PDF_IPS_Templates') && !$no_pro) {
			$template_link = '<a href="https://wpovernight.com/downloads/pdf-invoices-packing-slips-premium-templates/" target="_blank">wpovernight.com</a>';
	...
	if ( class_exists('Banda_PDF_IPS_Pro') || class_exists('Banda_PDF_IPS_Dropbox') || class_exists('Banda_PDF_IPS_Templates') || class_exists('Banda_Ext_PrintOrders') || class_exists('WPO_WC_Smart_Reminder_Emails') ) {
