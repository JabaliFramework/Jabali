...
/**
 * Banda Credit Card Payment Token.
 *
...
class WC_Payment_Token_CC extends WC_Payment_Token {
	...
	public function get_display_name() {
		...
		$display .= '&nbsp;' . sprintf( __( 'ending in %s', 'banda' ), $this->get_last4() );
		$display .= ' ' . sprintf( __( '(expires %s)', 'banda' ), $this->get_expiry_month() . '/' . substr( $this->get_expiry_year(), 2 ) );
		return $display;
	}
