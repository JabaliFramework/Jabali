 ...
 * @param array $field
 */
function banda_wp_text_input( $field ) {
 ...
 * @param array $field
 */
function banda_wp_hidden_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function banda_wp_textarea_input( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function banda_wp_checkbox( $field ) {
	global $thepostid, $post;
 ...
 * @param array $field
 */
function banda_wp_select( $field ) {
	global $thepostid, $post;
