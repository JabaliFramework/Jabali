	...
	<?php
		...
		if ( $metadata = $order->has_meta( $item_id ) ) {
			...
			foreach ( $metadata as $meta ) {
				...
				if ( in_array( $meta['meta_key'], apply_filters( 'banda_hidden_order_itemmeta', array(
					'_qty',
					'_tax_class',
					'_product_id',
					'_variation_id',
...
<div class="edit" style="display: none;">
	<table class="meta" cellspacing="0">
		...
		<tfoot>
			<tr>
				<td colspan="4"><button class="add_order_item_meta button"><?php _e( 'Add&nbsp;meta', 'banda' ); ?></button></td>
			</tr>
		</tfoot>
	</table>
</div>
