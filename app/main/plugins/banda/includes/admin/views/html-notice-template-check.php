...
<div id="message" class="updated banda-message">
	...
	<p class="submit"><a class="button-primary" href="https://mtaandao.co.ke/docs/banda/document/template-structure/" target="_blank"><?php _e( 'Learn More About Templates', 'banda' ); ?></a></p>
</div>
