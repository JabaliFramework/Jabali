...
<table class="wc-shipping-zone-methods widefat">
	<thead>
		<tr>
			...
			<th class="wc-shipping-zone-method-description"><?php esc_html_e( 'Description', 'banda' ); ?></th>
		</tr>
	</thead>
	<tfoot>
		<tr>
			<td colspan="5">
				<input type="submit" name="save" class="button button-primary wc-shipping-zone-method-save" value="<?php esc_attr_e( 'Save changes', 'banda' ); ?>" disabled />
				<input type="submit" class="button button-secondary wc-shipping-zone-add-method" value="<?php esc_attr_e( 'Add shipping method', 'banda' ); ?>" />
			</td>
		</tr>
	</tfoot>
	...
	<tr data-id="{{ data.instance_id }}" data-enabled="{{ data.enabled }}">
		...
		<td class="wc-shipping-zone-method-title">
			...
			<div class="row-actions">
				<a class="wc-shipping-zone-method-settings" href="admin.php?page=wc-settings&amp;tab=shipping&amp;instance_id={{ data.instance_id }}"><?php _e( 'Settings', 'banda' ); ?></a> | <a href="#" class="wc-shipping-zone-method-delete"><?php _e( 'Remove', 'banda' ); ?></a>
			</div>
		</td>
		...
		<div class="wc-backbone-modal-content">
			<section class="wc-backbone-modal-main" role="main">
				<header class="wc-backbone-modal-header">
					<h1><?php echo esc_html( sprintf( _x( '%s Settings', 'Shipping Method Settings', 'banda' ), '{{{ data.method.method_title }}}' ) ); ?></h1>
				...
				<footer>
					<div class="inner">
						<button id="btn-ok" class="button button-primary button-large"><?php _e( 'Save changes', 'banda' ); ?></button>
					</div>
				</footer>
			</section>
		</div>
