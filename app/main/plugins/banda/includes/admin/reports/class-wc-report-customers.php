...
class WC_Report_Customers extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			'title' => sprintf( __( '%s signups in this period', 'banda' ), '<strong>' . sizeof( $this->customers ) . '</strong>' ),
	...
	public function customers_vs_guests() {
		...
		<div class="chart-container">
			...
			<ul class="pie-chart-legend">
				<li style="border-color: <?php echo $this->chart_colours['customers']; ?>"><?php _e( 'Customer Sales', 'banda' ); ?></li>
				<li style="border-color: <?php echo $this->chart_colours['guests']; ?>"><?php _e( 'Guest Sales', 'banda' ); ?></li>
			</ul>
		</div>
 				...
 				jQuery.plot(
					...
					],
					{
						...
						series: {
							...
							enable_tooltip: true,
							append_tooltip: "<?php echo ' ' . __( 'orders', 'banda' ); ?>",
						},
						legend: {
							show: false
						}
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
							{
								label: "<?php echo esc_js( __( 'Customer Orders', 'banda' ) ) ?>",
								...
								shadowSize: 0,
								enable_tooltip: true,
								append_tooltip: "<?php echo ' ' . __( 'customer orders', 'banda' ); ?>",
								stack: true,
							},
							{
								label: "<?php echo esc_js( __( 'Guest Orders', 'banda' ) ) ?>",
								...
								shadowSize: 0,
								enable_tooltip: true,
								append_tooltip: "<?php echo ' ' . __( 'guest orders', 'banda' ); ?>",
								stack: true,
							},
							{
								label: "<?php echo esc_js( __( 'Signups', 'banda' ) ) ?>",
								...
								shadowSize: 0,
								enable_tooltip: true,
								append_tooltip: "<?php echo ' ' . __( 'new users', 'banda' ); ?>",
								stack: false
							},
						];
