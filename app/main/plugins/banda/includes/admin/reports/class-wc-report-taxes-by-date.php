...
class WC_Report_Taxes_By_Date extends WC_Admin_Report {
	...
	public function get_main_chart() {
		...
		<table class="widefat">
			<thead>
				<tr>
					<th><?php _e( 'Period', 'banda' ); ?></th>
					<th class="total_row"><?php _e( 'Number of Orders', 'banda' ); ?></th>
					<th class="total_row"><?php _e( 'Total Sales', 'banda' ); ?> <?php echo wc_help_tip( __( "This is the sum of the 'Order Total' field within your orders.", 'banda' ) ); ?></th>
					<th class="total_row"><?php _e( 'Total Shipping', 'banda' ); ?> <?php echo wc_help_tip( __( "This is the sum of the 'Shipping Total' field within your orders.", 'banda' ) ); ?></th>
					...
					<th class="total_row"><?php _e( 'Net profit', 'banda' ); ?> <?php echo wc_help_tip( __( "Total sales minus shipping and tax.", 'banda' ) ); ?></th>
				</tr>
			</thead>
			<?php if ( ! empty( $tax_rows ) ) : ?>
				...
				<tfoot>
					...
					?>
					<tr>
						<th scope="row"><?php _e( 'Totals', 'banda' ); ?></th>
