	...
	public static function get_reports() {
		$reports = array(
			'orders'     => array(
				...
				'reports' => array(
					"sales_by_date" => array(
						'title'       => __( 'Sales by date', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					),
					"sales_by_product" => array(
						'title'       => __( 'Sales by product', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					),
					"sales_by_category" => array(
						'title'       => __( 'Sales by category', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					),
					"coupon_usage" => array(
						'title'       => __( 'Coupons by date', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					)
			...
			'customers' => array(
				'title'  => __( 'Customers', 'banda' ),
				'reports' => array(
					"customers" => array(
						'title'       => __( 'Customers vs. Guests', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					),
					"customer_list" => array(
						'title'       => __( 'Customer List', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					),
			...
			'stock'     => array(
				'title'  => __( 'Stock', 'banda' ),
				'reports' => array(
					"low_in_stock" => array(
						'title'       => __( 'Low in stock', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					),
					"out_of_stock" => array(
						'title'       => __( 'Out of stock', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					),
					"most_stocked" => array(
						'title'       => __( 'Most Stocked', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					),
		...
		if ( wc_tax_enabled() ) {
			$reports['taxes'] = array(
				'title'  => __( 'Taxes', 'banda' ),
				'reports' => array(
					"taxes_by_code" => array(
						'title'       => __( 'Taxes by code', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					),
					"taxes_by_date" => array(
						'title'       => __( 'Taxes by date', 'banda' ),
						'description' => '',
						'hide_title'  => true,
						'callback'    => array( __CLASS__, 'get_report' )
					),
		...
		$reports = apply_filters( 'banda_admin_reports', $reports );
		$reports = apply_filters( 'banda_reports_charts', $reports ); // Backwards compat
