...
$server_configs = array(
	...
	"WP Memory Limit" => array(
		"required" => 'Recommended: 128MB (more for plugin-heavy setups)<br/>See: <a href="http://jabali.github.io/Docs/Editing_wp-config.php#Increasing_memory_allocated_to_PHP">Increasing memory allocated to PHP</a>',
