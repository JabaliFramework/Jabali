...
$memory_limit = function_exists('wc_let_to_num')?wc_let_to_num( WP_MEMORY_LIMIT ):banda_let_to_num( WP_MEMORY_LIMIT );
...
$server_configs = array(
	...
	"WP Memory Limit" => array(
		"required" => 'Recommended: 128MB (more for plugin-heavy setups)<br/>See: <a href="http://codex.jabali.github.io/Editing_wp-config.php#Increasing_memory_allocated_to_PHP">Increasing memory allocated to PHP</a>',
...
By default, this folder is created in the Jabali uploads folder (<code><?php echo $upload_base; ?></code>),
...
files (from <code><?php echo Banda_PDF_Invoices::$plugin_path . "lib/dompdf/lib/fonts/"; ?></code>)
