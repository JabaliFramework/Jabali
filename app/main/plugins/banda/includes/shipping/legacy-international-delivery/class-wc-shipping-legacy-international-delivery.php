...
class WC_Shipping_Legacy_International_Delivery extends WC_Shipping_Legacy_Flat_Rate {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'International Flat Rate (Legacy)', 'banda' );
	...
	public function init_form_fields() {
		...
		$this->form_fields['availability'] = array(
			...
			'default'		=> 'including',
			'options'		=> array(
				'including' => __( 'Selected countries', 'banda' ),
				'excluding' => __( 'Excluding selected countries', 'banda' ),
			)
		);
	}
	...
	public function is_available( $package ) {
		...
		return apply_filters( 'banda_shipping_' . $this->id . '_is_available', true, $package );
	}
}
