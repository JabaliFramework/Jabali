...
class WC_Shipping_Legacy_Flat_Rate extends WC_Shipping_Method {
	...
	public function __construct() {
		...
		$this->method_title       = __( 'Flat Rate (Legacy)', 'banda' );
		...
		add_action( 'banda_flat_rate_shipping_add_rate', array( $this, 'calculate_extra_shipping' ), 10, 2 );
	}
	...
	public function calculate_shipping( $package = array() ) {
		 ...
		 * 		}.
		 */
		do_action( 'banda_flat_rate_shipping_add_rate', $this, $rate );
	}
