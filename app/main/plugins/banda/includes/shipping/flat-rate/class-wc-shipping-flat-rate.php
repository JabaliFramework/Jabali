...
class WC_Shipping_Flat_Rate extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_title          = __( 'Flat Rate', 'banda' );
		$this->method_description    = __( 'Lets you charge a fixed rate for shipping.', 'banda' );
		$this->supports              = array(
			'shipping-zones',
			'instance-settings',
	...
	protected function evaluate_cost( $sum, $args = array() ) {
		...
		$args           = apply_filters( 'banda_evaluate_shipping_cost_args', $args, $sum, $this );
		$locale         = localeconv();
	...
	public function calculate_shipping( $package = array() ) {
		 ...
		 *
		 * 		add_action( 'banda_flat_rate_shipping_add_rate', 'add_another_custom_flat_rate', 10, 2 );
		 *
		 ...
		 * 		}.
		 */
		do_action( 'banda_' . $this->id . '_shipping_add_rate', $this, $rate );
	}
