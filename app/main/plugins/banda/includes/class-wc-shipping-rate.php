...
class WC_Shipping_Rate {
	...
	public function get_shipping_tax() {
		return apply_filters( 'banda_get_shipping_tax', sizeof( $this->taxes ) > 0 && ! WC()->customer->is_vat_exempt() ? array_sum( $this->taxes ) : 0, $this );
	}
	...
	public function get_label() {
		return apply_filters( 'banda_shipping_rate_label', $this->label );
	}
