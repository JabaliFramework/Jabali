...
class WC_Order_Refund extends WC_Abstract_Order {
	...
	public function get_refund_amount() {
		return apply_filters( 'banda_refund_amount', (double) $this->refund_amount, $this );
	}
	...
	public function get_formatted_refund_amount() {
		return apply_filters( 'banda_formatted_refund_amount', wc_price( $this->refund_amount, array('currency' => $this->get_order_currency()) ), $this );
	}
	...
	public function get_refund_reason() {
		return apply_filters( 'banda_refund_reason', $this->reason, $this );
	}
}
