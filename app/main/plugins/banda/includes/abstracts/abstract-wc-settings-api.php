...
abstract class WC_Settings_API {
	...
	public function get_form_fields() {
		return apply_filters( 'banda_settings_api_form_fields_' . $this->id, array_map( array( $this, 'set_defaults' ), $this->form_fields ) );
	}
	...
	public function process_admin_options() {
		...
		return update_option( $this->get_option_key(), apply_filters( 'banda_settings_api_sanitized_fields_' . $this->id, $this->settings ) );
	}
			...
			<td class="forminp">
				<fieldset>
					...
					<?php if ( $data['select_buttons'] ) : ?>
						<br/><a class="select_all button" href="#"><?php _e( 'Select all', 'banda' ); ?></a> <a class="select_none button" href="#"><?php _e( 'Select none', 'banda' ); ?></a>
					<?php endif; ?>
				</fieldset>
			</td>
		</tr>
