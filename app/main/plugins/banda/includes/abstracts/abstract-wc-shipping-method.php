...
abstract class WC_Shipping_Method extends WC_Settings_API {
	...
	public function supports( $feature ) {
		return apply_filters( 'banda_shipping_method_supports', in_array( $feature, $this->supports ), $feature, $this );
	}
	...
	public function get_method_title() {
		return apply_filters( 'banda_shipping_method_title', $this->method_title, $this );
	}
	...
	public function get_method_description() {
		return apply_filters( 'banda_shipping_method_description', $this->method_description, $this );
	}
	...
	public function get_title() {
		return apply_filters( 'banda_shipping_method_title', $this->title, $this->id );
	}
	...
	public function add_rate( $args = array() ) {
		...
		if ( $args['package'] ) {
			...
			$rate->add_meta_data( __( 'Items', 'banda' ), implode( ', ', $items_in_package ) );
		}
	...
	public function is_available( $package ) {
		...
		return apply_filters( 'banda_shipping_' . $this->id . '_is_available', $available, $package );
	}
	...
	public function get_instance_form_fields() {
		return apply_filters( 'banda_shipping_instance_form_fields_' . $this->id, array_map( array( $this, 'set_defaults' ), $this->instance_form_fields ) );
	}
	...
	public function process_admin_options() {
		if ( $this->instance_id ) {
			...
			return update_option( $this->get_instance_option_key(), apply_filters( 'banda_shipping_' . $this->id . '_instance_settings_values', $this->instance_settings, $this ) );
		} else {
