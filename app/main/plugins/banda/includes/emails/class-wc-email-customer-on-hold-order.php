...
class WC_Email_Customer_On_Hold_Order extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = __( 'Order on-hold', 'banda' );
		$this->description      = __( 'This is an order notification sent to customers containing order details after an order is placed on-hold.', 'banda' );
