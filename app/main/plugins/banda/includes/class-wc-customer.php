 ...
 * Customer
 *
 * The Banda customer class handles storage of the current customer's data, such as location.
 *
 * @class    WC_Customer
 * @version  2.3.0
...
class WC_Customer {
	...
	public function get_taxable_address() {
		...
		if ( true === apply_filters( 'banda_apply_base_tax_for_local_pickup', true ) && sizeof( array_intersect( wc_get_chosen_shipping_method_ids(), apply_filters( 'banda_local_pickup_methods', array( 'legacy_local_pickup', 'local_pickup' ) ) ) ) > 0 ) {
			$tax_based_on = 'base';
		}
		...
		return apply_filters( 'banda_customer_taxable_address', array( $country, $state, $postcode, $city ) );
	}
	...
	public function get_downloadable_products() {
		...
		return apply_filters( 'banda_customer_get_downloadable_products', $downloads );
	}
}
