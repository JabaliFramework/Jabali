 ...
 *
 * From 2.5 this uses a custom table for session storage. Based on https://github.com/kloon/banda-large-sessions.
 *
...
class WC_Session_Handler extends WC_Session {
	...
	public function __construct() {
		...
		$this->_cookie = 'wp_banda_session_' . COOKIEHASH;
		$this->_table  = $wpdb->prefix . 'banda_sessions';
		...
		// Actions
		add_action( 'banda_set_cart_cookies', array( $this, 'set_customer_session_cookie' ), 10 );
		add_action( 'banda_cleanup_sessions', array( $this, 'cleanup_sessions' ), 10 );
	...
	public function generate_customer_id() {
		if ( is_user_logged_in() ) {
			...
			require_once( ABSPATH . 'reslib/class-phpass.php');
