...
class WC_API_Reports extends WC_API_Resource {
	...
	public function get_sales_report( $fields = null, $filter = array() ) {
		...
		return array( 'sales' => apply_filters( 'banda_api_report_response', $sales_data, $this->report, $fields, $this->server ) );
	}
	...
	public function get_top_sellers_report( $fields = null, $filter = array() ) {
		...
		return array( 'top_sellers' => apply_filters( 'banda_api_report_response', $top_sellers_data, $this->report, $fields, $this->server ) );
	}
	...
	protected function validate_request( $id = null, $type = null, $context = null ) {
		...
		if ( ! current_user_can( 'view_banda_reports' ) ) {

			return new WP_Error( 'banda_api_user_cannot_read_report', __( 'You do not have permission to read this report', 'banda' ), array( 'status' => 401 ) );
