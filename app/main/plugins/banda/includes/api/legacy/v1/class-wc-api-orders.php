...
class WC_API_Orders extends WC_API_Resource {
	...
	public function get_orders_count( $status = null, $filter = array() ) {
		...
		if ( ! current_user_can( 'read_private_shop_orders' ) )
			return new WP_Error( 'banda_api_user_cannot_read_orders_count', __( 'You do not have permission to read the orders count', 'banda' ), array( 'status' => 401 ) );
	...
	public function get_order_notes( $id, $fields = null ) {
		...
		return array( 'order_notes' => apply_filters( 'banda_api_order_notes_response', $order_notes, $id, $fields, $notes, $this->server ) );
	}
