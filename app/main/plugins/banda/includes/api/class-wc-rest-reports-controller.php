...
class WC_REST_Reports_Controller extends WC_REST_Controller {
	...
	public function get_items( $request ) {
		...
		$reports = array(
			array(
				'slug'        => 'sales',
				'description' => __( 'List of sales reports.', 'banda' ),
			),
			array(
				'slug'        => 'top_sellers',
				'description' => __( 'List of top sellers products.', 'banda' ),
			),
		);
	...
	public function prepare_item_for_response( $report, $request ) {
		 ...
		 */
		return apply_filters( 'banda_rest_prepare_report', $response, $report, $request );
	}
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				'slug' => array(
					'description' => __( 'An alphanumeric identifier for the resource.', 'banda' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'description' => array(
					'description' => __( 'A human-readable description of the resource.', 'banda' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
