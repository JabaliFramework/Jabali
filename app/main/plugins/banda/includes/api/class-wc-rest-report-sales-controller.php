...
class WC_REST_Report_Sales_Controller extends WC_REST_Controller {
	...
	public function prepare_item_for_response( $_, $request ) {
		 ...
		 */
		return apply_filters( 'banda_rest_prepare_report_sales', $response, (object) $sales_data, $request );
	}
	...
	public function get_item_schema() {
		$schema = array(
			...
			'properties' => array(
				'total_sales' => array(
					'description' => __( 'Gross sales in the period.', 'banda' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'net_sales' => array(
					'description' => __( 'Net sales in the period.', 'banda' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'average_sales' => array(
					'description' => __( 'Average net daily sales.', 'banda' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_orders' => array(
					'description' => __( 'Total of orders placed.', 'banda' ),
					'type'        => 'integer',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_items' => array(
					'description' => __( 'Total of items purchased.', 'banda' ),
					'type'        => 'integer',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_tax' => array(
					'description' => __( 'Total charged for taxes.', 'banda' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_shipping' => array(
					'description' => __( 'Total charged for shipping.', 'banda' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_refunds' => array(
					'description' => __( 'Total of refunded orders.', 'banda' ),
					'type'        => 'integer',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'total_discount' => array(
					'description' => __( 'Total of coupons used.', 'banda' ),
					'type'        => 'integer',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'totals_grouped_by' => array(
					'description' => __( 'Group type.', 'banda' ),
					'type'        => 'string',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
				'totals' => array(
					'description' => __( 'Totals.', 'banda' ),
					'type'        => 'array',
					'context'     => array( 'view' ),
					'readonly'    => true,
				),
	...
	public function get_collection_params() {
		return array(
			...
			'period' => array(
				'description'       => __( 'Report period.', 'banda' ),
				'type'              => 'string',
			...
			'date_min' => array(
				'description'       => sprintf( __( 'Return sales for a specific start date, the date need to be in the %s format.', 'banda' ), 'YYYY-MM-AA' ),
				'type'              => 'string',
				'format'            => 'date',
			...
			'date_max' => array(
				'description'       => sprintf( __( 'Return sales for a specific end date, the date need to be in the %s format.', 'banda' ), 'YYYY-MM-AA' ),
				'type'              => 'string',
				'format'            => 'date',
				'validate_callback' => 'wc_rest_validate_reports_request_arg',
				'sanitize_callback' => 'sanitize_text_field',
