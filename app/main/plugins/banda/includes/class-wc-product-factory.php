 ...
 *
 * The Banda product factory creating the right product object.
 *
...
class WC_Product_Factory {
	...
	private function get_product_class( $the_product, $args = array() ) {
		...
		return apply_filters( 'banda_product_class', $classname, $product_type, $post_type, $product_id );
	}
	...
	private function get_product_object( $the_product ) {
		...
		return apply_filters( 'banda_product_object', $the_product );
	}
}
