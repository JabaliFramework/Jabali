 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/cart/cart-shipping.php.
 *
...
<tr class="shipping">
	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
				...
				<?php foreach ( $available_methods as $method ) : ?>
					<li>
						<?php
							...
							do_action( 'banda_after_shipping_rate', $method, $index );
						?>
					</li>
				<?php endforeach; ?>
			</ul>
		...
		<?php if ( $show_package_details ) : ?>
			<?php echo '<p class="banda-shipping-contents"><small>' . esc_html( $package_details ) . '</small></p>'; ?>
		<?php endif; ?>

		<?php if ( is_cart() && ! $index ) : ?>
			<?php banda_shipping_calculator(); ?>
		<?php endif; ?>
	</td>
</tr>
