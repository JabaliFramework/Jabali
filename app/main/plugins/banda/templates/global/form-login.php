 ...
 * Login form
 *
 * This template can be overridden by copying it to yourtheme/banda/global/form-login.php.
 *
...
<form method="post" class="login" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
	...
	<p class="form-row form-row-first">
		<label for="username"><?php _e( 'Username or email', 'banda' ); ?> <span class="required">*</span></label>
	...
	<p class="form-row">
		...
		<input type="submit" class="button" name="login" value="<?php esc_attr_e( 'Login', 'banda' ); ?>" />
		<input type="hidden" name="redirect" value="<?php echo esc_url( $redirect ) ?>" />
		<label for="rememberme" class="inline">
			<input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php _e( 'Remember me', 'banda' ); ?>
		</label>
	</p>
