...
if ( '0' === $comment->comment_approved ) { ?>
	...
	<p class="meta"><em><?php esc_attr_e( 'Your comment is awaiting approval', 'banda' ); ?></em></p>
...
<?php } else { ?>
	...
	<p class="meta">
		...
		if ( 'yes' === get_option( 'banda_review_rating_verification_label' ) && $verified ) {
			echo '<em class="verified">(' . esc_attr__( 'verified owner', 'banda' ) . ')</em> ';
		}
