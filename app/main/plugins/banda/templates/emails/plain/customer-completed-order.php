 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/plain/customer-completed-order.php.
 *
...
echo sprintf( __( "Hi there. Your recent order on %s has been completed. Your order details are shown below for your reference:", 'banda' ), get_option( 'blogname' ) ) . "\n\n";
