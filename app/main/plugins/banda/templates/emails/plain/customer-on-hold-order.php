 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/plain/customer-processing-order.php.
 *
...
echo __( "Your order is on-hold until we confirm payment has been received. Your order details are shown below for your reference:", 'banda' ) . "\n\n";
