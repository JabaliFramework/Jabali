 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/plain/customer-invoice.php.
 *
...
if ( $order->has_status( 'pending' ) ) {
	echo sprintf( __( 'An order has been created for you on %s. To pay for this order please use the following link: %s', 'banda' ), get_bloginfo( 'name', 'display' ), $order->get_checkout_payment_url() ) . "\n\n";
}
