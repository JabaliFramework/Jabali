 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/plain/admin-new-order.php.
 *
...
echo sprintf( __( 'You have received an order from %s.', 'banda' ), $order->get_formatted_billing_full_name() ) . "\n\n";
