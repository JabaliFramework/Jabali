 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/plain/admin-failed-order.php
 *
...
echo sprintf( __( 'Payment for order #%d from %s has failed. The order was as follows:', 'banda' ), $order->id, $order->get_formatted_billing_full_name() ) . "\n\n";
