 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/plain/customer-refunded-order.php.
 *
...
echo sprintf( __( "Hi there. Your order on %s has been refunded. Your order details are shown below for your reference:", 'banda' ), get_option( 'blogname' ) ) . "\n\n";
