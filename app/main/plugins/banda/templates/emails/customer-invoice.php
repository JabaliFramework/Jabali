 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/customer-invoice.php.
 *
...
<?php if ( $order->has_status( 'pending' ) ) : ?>
	<p><?php printf( __( 'An order has been created for you on %s. To pay for this order please use the following link: %s', 'banda' ), get_bloginfo( 'name', 'display' ), '<a href="' . esc_url( $order->get_checkout_payment_url() ) . '">' . __( 'pay', 'banda' ) . '</a>' ); ?></p>
<?php endif; ?>
