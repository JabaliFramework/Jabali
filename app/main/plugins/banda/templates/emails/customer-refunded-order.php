 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/customer-refunded-order.php.
 *
...
<p><?php
	if ( $partial_refund ) {
		printf( __( 'Hi there. Your order on %s has been partially refunded.', 'banda' ), get_option( 'blogname' ) );
	}
	else {
		printf( __( 'Hi there. Your order on %s has been refunded.', 'banda' ), get_option( 'blogname' ) );
	}
?></p>
