 ...
 * Customer note email
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/customer-note.php.
 *
...
<p><?php _e( "Hello, a note has just been added to your order:", 'banda' ); ?></p>

<blockquote><?php echo wpautop( wptexturize( $customer_note ) ) ?></blockquote>

<p><?php _e( "For your reference, your order details are shown below.", 'banda' ); ?></p>
