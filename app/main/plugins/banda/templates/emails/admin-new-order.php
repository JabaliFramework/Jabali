 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/admin-new-order.php.
 *
 ...
 */
 ...
 <p><?php printf( __( 'You have received an order from %s. The order is as follows:', 'banda' ), $order->get_formatted_billing_full_name() ); ?></p>
