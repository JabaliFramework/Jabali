 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/customer-completed-order.php.
 *
...
<p><?php printf( __( "Hi there. Your recent order on %s has been completed. Your order details are shown below for your reference:", 'banda' ), get_option( 'blogname' ) ); ?></p>
