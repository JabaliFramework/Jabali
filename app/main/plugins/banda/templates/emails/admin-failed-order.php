 ...
 *
 * This template can be overridden by copying it to yourtheme/banda/emails/admin-failed-order.php
 *
 ...
 */
 ...
 <p><?php printf( __( 'Payment for order #%d from %s has failed. The order was as follows:', 'banda' ), $order->get_order_number(), $order->get_formatted_billing_full_name() ); ?></p>
