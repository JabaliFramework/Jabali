...
$my_orders_columns = apply_filters( 'banda_my_account_my_orders_columns', array(
...
$customer_orders = get_posts( apply_filters( 'banda_my_account_my_orders_query', array(
...
if ( $customer_orders ) : ?>
	...
	<h2><?php echo apply_filters( 'banda_my_account_my_orders_title', __( 'Recent Orders', 'banda' ) ); ?></h2>
