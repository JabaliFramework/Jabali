 ...
 * Order details
 *
 * This template can be overridden by copying it to yourtheme/banda/order/order-details.php.
 *
...
<table class="shop_table order_details">
	...
	<tbody>
		...
		?>
		<?php do_action( 'banda_order_items_table', $order ); ?>
	</tbody>
	<tfoot>
		<?php
...
<?php do_action( 'banda_order_details_after_order_table', $order ); ?>
