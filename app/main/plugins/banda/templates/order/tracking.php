 ...
 * Order tracking
 *
 * This template can be overridden by copying it to yourtheme/banda/order/tracking.php.
 *
...
<p class="order-info"><?php
	echo wp_kses_post( apply_filters( 'banda_order_tracking_status', sprintf(
		...
		<li class="comment note">
			<div class="comment_container">
				<div class="comment-text">
					<p class="meta"><?php echo date_i18n( __( 'l jS \o\f F Y, h:ia', 'banda' ), strtotime( $note->comment_date ) ); ?></p>
...
<?php do_action( 'banda_view_order', $order->id ); ?>
