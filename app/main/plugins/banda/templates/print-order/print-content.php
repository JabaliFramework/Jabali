 ...
 * directory /banda/print-order to customize it.
 *
 * @package Banda Print Invoice & Delivery Note/Templates
 */
...
?>
				...
				<div class="order-items">
					<table>
						<thead>
							<tr>
								<th class="head-name"><span><?php _e('Product', 'banda-delivery-notes'); ?></span></th>
								<th class="head-item-price"><span><?php _e('Price', 'banda-delivery-notes'); ?></span></th>
								<th class="head-quantity"><span><?php _e('Quantity', 'banda-delivery-notes'); ?></span></th>
								<th class="head-price"><span><?php _e('Total', 'banda-delivery-notes'); ?></span></th>
							</tr>
						</thead>
										...
										<td class="product-name">
											...
											<dl class="extras">
												<?php if( $product && $product->exists() && $product->is_downloadable() && $order->is_download_permitted() ) : ?>
													...
													<dt><?php _e( 'Download:', 'banda-delivery-notes' ); ?></dt>
													<dd><?php printf( __( '%s Files', 'banda-delivery-notes' ), count( $order->get_item_downloads( $item ) ) ); ?></dd>
				...
				<div class="order-notes">
					<?php if( wcdn_has_customer_notes( $order ) ) : ?>
						<h4><?php _e( 'Customer Note', 'banda-delivery-notes' ); ?></h4>
