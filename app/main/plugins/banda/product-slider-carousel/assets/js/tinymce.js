...
(function($) {
    ...
    var image_url='';
    tinymce.create('tinymce.plugins.YITH_Banda_Product_Slider', {
        ...
        getInfo : function() {
            return {
                longname : "YITH Banda Product Slider Carousel",
                author : 'YITHEMES',
    ...
    tinymce.PluginManager.add('ywcps_shortcode', tinymce.plugins.YITH_Banda_Product_Slider);
