...
$style  =   array(
    'layout2' => array(
        ...
        'layout2_settings'                       => array(
            'name' => __( 'Layout 2', 'yith-banda-product-slider-carousel' ),
            'type' => 'title',
            'id'   => 'ywcps_section_layout2'
        ),

        'layout2_settings_box_bg_color'          => array(
            'name'    => __( 'Box background color', 'yith-banda-product-slider-carousel' ),
            'type'    => 'color',
            'desc'    => '',
    ...
    'name'    => __( 'Box border color', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'    => __( 'Text color', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'    => __( 'Background color of navigation arrow', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'    => __( 'Border color of navigation arrow', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'  =>  __( 'Text color of navigation arrow', 'yith-banda-product-slider-carousel' ),
    'type'  =>  'color',
    'desc'  =>  '',
    ...
    'name'    => __( 'Button background color', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'    => __( 'Button background color on hover ', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'    => __( 'Button text color', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'    => __( 'Button text color on hover', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'    => __( 'Button border color', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
    ...
    'name'    => __( 'Button border color on hover', 'yith-banda-product-slider-carousel' ),
    'type'    => 'color',
    'desc'    => '',
