...
<head>
    ...
    <style type="text/css">
        ...
        .button:focus {
            border-color: #0e3950;
            -webkit-box-shadow: inset 0 1px 0 rgba(120, 200, 230, .6), 0 0 0 1px #006600, 0 0 2px 1px rgba(30, 140, 190, .8);
            box-shadow: inset 0 1px 0 rgba(120, 200, 230, .6), 0 0 0 1px #006600, 0 0 2px 1px rgba(30, 140, 190, .8);
        }
...
<div id="ywcps_lightbox_content">
    ...
    <p class="ywcps_select_field">
        <label for="ywcps_slider"><?php _e( 'Select a Slider', 'yith-banda-product-slider-carousel');?></label>
        <select id="ywcps_slider" class="widefat">
            <option value="" selected><?php _e( 'Select a Slider', 'yith-banda-product-slider-carousel' );?></option>
            <?php
    ...
    <p class="ywcps_z_index_content">
        <label for="ywcps_z_index"><?php _e( 'z-index', 'yith-banda-product-slider-carousel' );?></label>
        <input type="text" id="ywcps_z_index">
    </p>
</div>
<div class="widget-control-actions">
    <div class="alignright" style="margin-right: 10px;">
        <input type="submit" name="ywcps_shortcode_insert" id="ywcps_shortcode_insert" class="button" value="<?php _e( 'Insert', 'yith-banda-product-slider-carousel' ); ?>">
    </div>
    <br class="clear">
</div>
<script type="text/javascript">
