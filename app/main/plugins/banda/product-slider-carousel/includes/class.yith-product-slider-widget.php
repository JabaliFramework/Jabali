    ...
    class YITH_Product_Slider_Widget extends  WP_Widget {
        ...
        public function __construct() {
            parent::__construct(
                ...
                __('YITH Banda Product Slider Carousel', 'yith-banda-product-slider-carousel'),
                array( 'description' => __('Show your Product Slider in sidebar!', 'yith-banda-product-slider-carousel' ) )
            );
        }
        ...
        public function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'slider_id' ) );?>"><?php _e( 'Select a slider', 'yith-banda-product-slider-carousel' );?></label>
                <select id="<?php esc_attr( $this->get_field_id('slider_id') );?>" name="<?php echo esc_attr( $this->get_field_name( 'slider_id' ) );?>">
                    <option value="" <?php selected( '', $instance['slider_id'] );?>><?php _e('Select a slider', 'yith-banda-product-slider-carousel');?></option>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'anim_in' ) );?>"><?php _e( 'Animation In', 'yith-banda-product-slider-carousel' );?></label>
                <select id="<?php echo esc_attr( $this->get_field_id( 'anim_in' ) );?>" name="<?php echo esc_attr( $this->get_field_name( 'anim_in' ) );?>">
                    <option value="" <?php  selected( '',$instance['anim_in'] );?>><?php _e( 'Select an animation', 'yith-banda-product-slider-carousel' );?></option>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'anim_out' ) );?>"><?php _e( 'Animation Out', 'yith-banda-product-slider-carousel' );?></label>
                <select id="<?php echo esc_attr( $this->get_field_id( 'anim_out' ) );?>" name="<?php echo esc_attr( $this->get_field_name( 'anim_out' ) );?>">
                    <option value="" <?php  selected( '',$instance['anim_out'] );?>><?php _e( 'Select an animation', 'yith-banda-product-slider-carousel' );?></option>
                    <?php foreach( $animations as $animation=>$it ) :?>
                        <optgroup label="<?php echo $animation;?>">
                            <?php foreach( $animations[$animation] as $key ):?>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'hide_add_to_cart' ) );?>"><?php _e( 'Hide "Add to cart"','yith-banda-product-slider-carousel' );?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'hide_price' ) );?>"><?php _e( 'Hide product price','yith-banda-product-slider-carousel' );?></label>
...
<?php
    ...
    public function widget( $args, $instance ) {
        ...
        $extra_params    =   array(
            ...
            'categories'          =>   get_post_meta( $instance['slider_id'], '_ywcps_categories' ,true ),
...
// register widget
add_action( 'widgets_init', create_function( '', 'return register_widget("YITH_Product_Slider_Widget");' ) );