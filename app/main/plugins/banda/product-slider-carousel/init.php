<?php
/**
 * Plugin Name: YITH Banda Product Slider Carousel Premium
 * Plugin URI: http://yithemes.com/themes/plugins/yith-banda-product-slider-carousel/
 * Description: YITH Banda Product Slider allows you to create responsive product slider!
 * Version: 1.0.12
 * Author: YITHEMES
 * Author URI: http://yithemes.com/
 * Text Domain: yith-banda-product-slider-carousel
 * Domain Path: /languages/
 *
 * @author Your Inspiration Themes
 * @package YITH Banda Product Slider
 * @version 1.0.12
 */
