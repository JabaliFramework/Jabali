...
if ( ! class_exists( 'YIT_Upgrade' ) ) {
	...
	class YIT_Upgrade {
		 ...
		 *
		 * @since    1.0
		 * @see      admin/includes/class-wp-upgrader.php
		 * @access   public
		 * @author   Andrea Grillo <andrea.grillo@yithemes.com>
		 */
		public function upgrader_pre_download( $reply, $package, $upgrader ) {
			...
			/**
			 * It isn't YITH Premium plugins, please jabali update it for me!
			 */
			if ( ! $plugin ) {
				return $reply;
			}
			...
			/**
			 * False ? It isn't YITH Premium plugins, please jabali update it for me!
			 */
