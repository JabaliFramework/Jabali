...
if ( ! class_exists( 'SV_WC_Helper' ) ) :
	...
	class SV_WC_Helper {
							...
							ajax: {
								...
								data: function( term, page ) {
									return {
										...
										action:       $( this ).data( 'action' ) || 'banda_json_search_products_and_variations',
		...
		public static function f__( $text ) {
			...
			return __( $text, 'banda-plugin-framework' );
		}
		...
		public static function f_e( $text ) {
			...
			_e( $text, 'banda-plugin-framework' );
		}
		...
		public static function f_x( $text, $context ) {
			...
			return _x( $text, $context, 'banda-plugin-framework' );
		}
