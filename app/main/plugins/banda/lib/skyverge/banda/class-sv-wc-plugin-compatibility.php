...
class SV_WC_Plugin_Compatibility {
	 ...
	 *
	 * @link https://github.com/woothemes/banda/pull/9765
	 *
	 * @since 4.2.0
	 ...
	 *
	 * @link https://github.com/woothemes/banda/pull/9417
	 *
	 * @since 4.2.0
	...
	/**
	 * Helper method to get the version of the currently installed Banda
	 *
	 * @since 3.0.0
	 * @return string banda version number or null
	 */
	...
	/**
	 * Returns true if the installed version of Banda is 2.5 or greater
	 *
	 * @since 4.2.0
	 * @return boolean true if the installed version of Banda is 2.5 or greater
	 */
	...
	/**
	 * Returns true if the installed version of Banda is less than 2.5
	 *
	 * @since 4.2.0
	 * @return boolean true if the installed version of Banda is less than 2.5
	 */
	...
	/**
	 * Returns true if the installed version of Banda is 2.6 or greater
	 *
	 * @since 4.4.0
	 * @return boolean true if the installed version of Banda is 2.6 or greater
	 */
	...
	/**
	 * Returns true if the installed version of Banda is less than 2.6
	 *
	 * @since 4.4.0
	 * @return boolean true if the installed version of Banda is less than 2.6
	 */
	...
	/**
	 * Returns true if the installed version of Banda is greater than $version
	 *
	 * @since 2.0.0
	 * @param string $version the version to compare
	 * @return boolean true if the installed version of Banda is > $version
	 */
	...
	/**
	 * Returns true if the installed version of Banda Subscriptions is
	 * 2.0.0 or greater
	 *
	 * @since 4.1.0
	 * @return boolean
