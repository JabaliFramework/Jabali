...
return array(
	...
	'params' => array(
		...
		array(
			...
			'admin_label' => true,
			'description' => sprintf( __( 'Enter link to video (Note: read more about available formats at Jabali <a href="%s" target="_blank">codex page</a>).', 'js_composer' ), 'http://codex.jabali.github.io/Embeds#Okay.2C_So_What_Sites_Can_I_Embed_From.3F' ),
		),
		array(
			'type' => 'dropdown',
