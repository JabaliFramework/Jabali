	...
	public function addShortcodeSettings( $tag ) {
		...
		switch ( $tag ) {
			...
			case 'recent_products':
				 ...
				 * To learn more about the default ‘orderby’ parameters please reference the Jabali Codex: http://codex.jabali.github.io/Class_Reference/WP_Query
				 *
				...
				$settings = array(
					...
					'params' => array(
						...
						array(
							...
							'save_always' => true,
							'description' => sprintf( __( 'Select how to sort retrieved products. More at %s.', 'js_composer' ), '<a href="http://codex.jabali.github.io/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">Jabali codex page</a>' ),
						),
						array(
							'type' => 'dropdown',
							...
							'save_always' => true,
							'description' => sprintf( __( 'Designates the ascending or descending order. More at %s.', 'js_composer' ), '<a href="http://codex.jabali.github.io/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">Jabali codex page</a>' ),
						),
					),
				);
				break;
				...
				$settings = array(
					...
					'params' => array(
						...
						array(
							...
							'std' => 'title',
							'save_always' => true,
							'description' => sprintf( __( 'Select how to sort retrieved products. More at %s. Default by Title', 'js_composer' ), '<a href="http://codex.jabali.github.io/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">Jabali codex page</a>' ),
						),
						array(
							'type' => 'dropdown',
							'heading' => __( 'Sort order', 'js_composer' ),
							...
							'value' => $order_way_values,
							'save_always' => true,
							'description' => sprintf( __( 'Designates the ascending or descending order. More at %s. Default by ASC', 'js_composer' ), '<a href="http://codex.jabali.github.io/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">Jabali codex page</a>' ),
						),
						array(
							'type' => 'autocomplete',
