...
class DJengaShortCode_VC_Masonry_Grid extends DJengaShortCode_VC_Basic_Grid {
	...
	public function shortcodeScripts() {
		...
		wp_register_script( 'vc_masonry', vc_asset_url( 'lib/bower/masonry/dist/masonry.pkgd.min.js' ), array(), DJ_VC_VERSION, true );
	}
