 ...
 * Class Vc_Pageable
 */
abstract class DJengaShortCode_Vc_Pageable extends DJengaShortCode {
	/**
	 * @param $settings
	 */
	...
	public function shortcodeScripts() {
		...
		wp_register_style( 'vc_pageable_owl-carousel-css', vc_asset_url( 'lib/owl-carousel2-dist/assets/owl.min.css' ), array(), DJ_VC_VERSION, false );
	}
	...
	protected function contentLoadMore( $grid_style, $settings, $content ) {
		if ( ! isset( $settings['btn_data'] ) && isset( $settings['button_style'] ) && isset( $settings['button_size'] ) && isset( $settings['button_color'] ) ) {
			...
			$button3 = new DJengaShortCode_VC_Btn( array( 'base' => 'vc_btn' ) );
