...
class Vc_Frontend_Editor implements Vc_Editor_Interface {
	 ...
	 * @var string
	 */
	protected static $brand_url = 'http://vc.mtaandao.co.ke/?utm_campaign=VCplugin&utm_source=vc_user&utm_medium=frontend_editor';
	...
	function loadIFrameJsCss() {
		...
		wp_enqueue_script( 'wpb_scrollTo_js', vc_asset_url( 'lib/bower/scrollTo/jquery.scrollTo.min.js' ), array( 'jquery' ), DJ_VC_VERSION, true );
		wp_enqueue_style( 'js_composer_custom_css' );

		wp_enqueue_script( 'wpb_php_js', vc_asset_url( 'lib/php.default/php.default.min.js' ), array( 'jquery' ), DJ_VC_VERSION, true );
	...
	public function registerJs() {
		...
		wp_register_script( 'wpb_php_js', vc_asset_url( 'lib/php.default/php.default.min.js' ), array( 'jquery' ), DJ_VC_VERSION, true );
		// used as polyfill for JSON.stringify and etc
		wp_register_script( 'wpb_json-js', vc_asset_url( 'lib/bower/json-js/json2.min.js' ), array(), DJ_VC_VERSION, true );
		...
		wp_register_script( 'wpb_scrollTo_js', vc_asset_url( 'lib/bower/scrollTo/jquery.scrollTo.min.js' ), array( 'jquery' ), DJ_VC_VERSION, true );
		wp_register_script( 'vc_accordion_script', vc_asset_url( 'lib/vc_accordion/vc-accordion.min.js' ), array( 'jquery' ), DJ_VC_VERSION, true );
