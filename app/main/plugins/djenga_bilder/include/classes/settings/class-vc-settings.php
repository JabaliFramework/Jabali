 ...
 *
 * @link http://codex.jabali.github.io/Settings_API Wordpress settings API
 * @since 3.4
 */
class Vc_Settings {
	public $tabs;
	...
	function adminLoad() {
		wp_register_script( 'wpb_js_composer_settings', vc_asset_url( 'js/dist/settings.min.js' ), array(), DJ_VC_VERSION, true );
				...
				if ( ( isset( $params['capabilities']['edit_posts'] ) && true === $params['capabilities']['edit_posts'] ) || ( isset( $params['capabilities']['edit_pages'] ) && true === $params['capabilities']['edit_pages'] ) ) :
					...
					<div id="wpb-settings-group-<?php echo $key ?>" class="accordion-body">
						<div class="visibility settings-block">
							<label
								for="wpb_composer_access_<?php echo $key ?>"><b><?php _e( 'Djenga Builder access', 'js_composer' ) ?></b></label>
