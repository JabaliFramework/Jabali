...
// @see Vc_Backend_Editor::printScriptsMessages (main/plugins/js_composer/include/classes/editors/class-vc-backend-editor.php),
...
// @see Vc_Frontend_Editor::enqueueAdmin (main/plugins/js_composer/include/classes/editors/class-vc-frontend-editor.php),
...
function vc_iconpicker_base_register_css() {
	...
	wp_register_style( 'vc_typicons', vc_asset_url( 'css/lib/typicons/src/font/typicons.min.css' ), false, DJ_VC_VERSION );
	wp_register_style( 'vc_openiconic', vc_asset_url( 'css/lib/vc-open-iconic/vc_openiconic.min.css' ), false, DJ_VC_VERSION );
	wp_register_style( 'vc_linecons', vc_asset_url( 'css/lib/vc-linecons/vc_linecons_icons.min.css' ), false, DJ_VC_VERSION );
	wp_register_style( 'vc_entypo', vc_asset_url( 'css/lib/vc-entypo/vc_entypo.min.css' ), false, DJ_VC_VERSION );
	wp_register_style( 'vc_monosocialiconsfont', vc_asset_url( 'css/lib/monosocialiconsfont/monosocialiconsfont.min.css' ), false, DJ_VC_VERSION );
	wp_register_style( 'vc_material', vc_asset_url( 'css/lib/vc-material/vc_material.min.css' ), false, DJ_VC_VERSION );
	// Theme
	wp_register_style( 'vc-icon-picker-main-css', vc_asset_url( 'lib/bower/vcIconPicker/css/jquery.fonticonpicker.min.css' ), false, DJ_VC_VERSION );
	wp_register_style( 'vc-icon-picker-main-css-theme', vc_asset_url( 'lib/bower/vcIconPicker/themes/grey-theme/jquery.fonticonpicker.vcgrey.min.css' ), false, DJ_VC_VERSION );
}
...
function vc_iconpicker_base_register_js() {
	wp_register_script( 'vc-icon-picker', vc_asset_url( 'lib/bower/vcIconPicker/jquery.fonticonpicker.min.js' ), array( 'jquery' ), DJ_VC_VERSION );
}
