...
/**
 * @var $vc_btn DJengaShortCode_VC_Btn
 * @var $post WP_Post
 * @var $atts
 *
 * @var $style
...
VcShortcodeAutoloader::getInstance()->includeClass( 'DJengaShortCode_VC_Btn' );
$vc_btn = new DJengaShortCode_VC_Btn( array( 'base' => 'vc_btn' ) );
