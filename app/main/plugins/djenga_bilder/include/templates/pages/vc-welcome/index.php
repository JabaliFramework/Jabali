...
preg_match( '/^(\d+)(\.\d+)?/', DJ_VC_VERSION, $matches );
?>
<div class="wrap vc-page-welcome about-wrap">
	<h1><?php echo sprintf( __( 'Welcome to Djenga Builder %s', 'js_composer' ), isset( $matches[0] ) ? $matches[0] : DJ_VC_VERSION ) ?></h1>

	<div class="about-text">
		<?php _e( 'Congratulations! You are about to use most powerful time saver for Jabali ever - page builder plugin with Frontend and Backend editors by DJenga.', 'js_composer' ) ?>
	</div>
	<div class="wp-badge vc-page-logo">
		<?php echo sprintf( __( 'Version %s', 'js_composer' ), DJ_VC_VERSION ) ?>
	</div>
	<p class="vc-page-actions">
		...
		<a href="https://twitter.com/share" class="twitter-share-button"
			data-via="wpbakery"
			data-text="Take full control over your #Jabali site with Djenga Builder page builder"
